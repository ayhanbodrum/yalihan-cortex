    ...
    private function createConsultantUsers(): void
    {
        ...
        $consultantUsers = [
            [
                ...
                'phone_number' => '+905342036964',
                'status' => true,
                'email_verified_at' => now(),
                'role_id' => 3, // Danışman
                'title' => 'Gayrimenkul Danışmanı',
                'bio' => 'Emlak sektöründe uzun yıllar deneyime sahip profesyonel danışman.',
                'whatsapp_number' => '+905342036964',
                'instagram_profile' => 'yunusemregok',
                'expertise_summary' => 'Konut, Arsa, İşyeri',
                'is_verified' => true,
                'office_address' => 'Kadıköy, İstanbul',
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                ...
                'password' => Hash::make('password123'),
                'phone_number' => '+905532897039',
                'status' => true,
                'email_verified_at' => now(),
                'role_id' => 3, // Danışman
                'title' => 'Kıdemli Gayrimenkul Danışmanı',
                'bio' => 'Kadıköy bölgesinde uzmanlaşmış, 10 yıllık tecrübeye sahip gayrimenkul danışmanı.',
                'whatsapp_number' => '+905532897039',
                'instagram_profile' => 'atilayonen',
                'expertise_summary' => 'Lüks Konut, Rezidans, Turistik Tesis',
                'is_verified' => true,
                'office_address' => 'Kadıköy, İstanbul',
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                ...
                'password' => Hash::make('password123'),
                'phone_number' => '+905399553343',
                'status' => true,
                'email_verified_at' => now(),
                'role_id' => 4, // Editör
                'title' => 'Gayrimenkul Asistanı',
                'bio' => 'Emlak ofisimizde asistan olarak görev yapmaktayım.',
                'whatsapp_number' => '+905399553343',
                'instagram_profile' => 'yeliztankucuk',
                'expertise_summary' => 'Ofis Yönetimi, Müşteri İlişkileri',
                'is_verified' => true,
                'office_address' => 'Kadıköy, İstanbul',
                'created_at' => now(),
                'updated_at' => now(),
