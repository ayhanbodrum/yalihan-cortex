...
class PersonController extends Controller
{
    ...
    public function search(Request $request): JsonResponse
    {
        try {
            ...
            // Type filter
            if ($type !== 'all') {
                $personsQuery->where('kisi_tipi', $type);
            }
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            $validator = Validator::make($request->all(), [
                ...
                'kisi_tipi' => 'nullable|in:Müşteri,Ev Sahibi,Alıcı,Kiracı,Satıcı',
            ...
            $person = Kisi::create([
                ...
                'kisi_tipi' => $request->kisi_tipi ?? 'Müşteri',
                'adres' => $request->adres,
    ...
    public function stats(): JsonResponse
    {
        try {
            $stats = [
                ...
                'musteri' => Kisi::where('status', 'Aktif')->where('kisi_tipi', 'Müşteri')->count(),
                'ev_sahibi' => Kisi::where('status', 'Aktif')->where('kisi_tipi', 'Ev Sahibi')->count(),
                'alici' => Kisi::where('status', 'Aktif')->where('kisi_tipi', 'Alıcı')->count(),
                'kiraci' => Kisi::where('status', 'Aktif')->where('kisi_tipi', 'Kiracı')->count(),
                'satici' => Kisi::where('status', 'Aktif')->where('kisi_tipi', 'Satıcı')->count(),
