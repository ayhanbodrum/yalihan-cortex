        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('frontend.portfolio.index') }}">Portföy</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('ilanlar.index') }}">İlanlar</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('advisors') }}">Danışmanlar</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="d-flex gap-2">
                    @auth
                        <a href="{{ route('admin.dashboard.index') }}" class="btn btn-outline-primary">
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2"><a href="{{ route('home') }}">Ana Sayfa</a></li>
                        <li class="mb-2"><a href="{{ route('frontend.portfolio.index') }}">Portföy</a></li>
                        <li class="mb-2"><a href="{{ route('ilanlar.index') }}">İlanlar</a></li>
                        <li class="mb-2"><a href="{{ route('advisors') }}">Danışmanlar</a></li>
