        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex space-x-3">
                <a href="{{ route('admin.takim-yonetimi.gorevler.create') }}"
                    class="neo-button neo-button-primary neo-button-md inline-flex items-center px-4 py-2 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
        ...
        <div
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="flex items-end">
                    <button class="neo-button neo-button-secondary neo-button-md w-full">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <a href="{{ route('admin.takim-yonetimi.gorevler.show', $gorev) }}"
                                            class="neo-button neo-button-sm neo-button-secondary">
                                        ...
                                        <a href="{{ route('admin.takim-yonetimi.gorevler.edit', $gorev) }}"
                                            class="neo-button neo-button-sm neo-button-primary">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        ...
                                        <form action="{{ route('admin.takim-yonetimi.gorevler.destroy', $gorev) }}"
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="neo-button neo-button-sm neo-button-danger">
