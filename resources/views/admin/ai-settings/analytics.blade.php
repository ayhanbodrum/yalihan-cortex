        ...
        <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-3xl font-bold mt-2">{{ number_format($analytics['total_requests'] ?? 0) }}</h3>
                </div>
        ...
        <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-lg shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-3xl font-bold mt-2">{{ number_format($analytics['success_rate'] ?? 0, 1) }}%</h3>
                </div>
                <div class="bg-white/20 p-3 rounded-lg">
                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-3xl font-bold mt-2">{{ number_format($analytics['avg_response_time'] ?? 0) }}ms</h3>
                </div>
                <div class="bg-white/20 p-3 rounded-lg">
                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-gradient-to-br from-orange-500 to-orange-600 rounded-lg shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-3xl font-bold mt-2">${{ number_format($analytics['total_cost'] ?? 0, 2) }}</h3>
                </div>
                <div class="bg-white/20 p-3 rounded-lg">
                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
                <div class="flex items-center justify-between mb-2">
                    <div class="flex items-center space-x-3">
                        <span class="text-sm font-medium text-gray-900 dark:text-white">{{ ucfirst($provider) }}</span>
                        <span class="text-xs text-gray-500 dark:text-gray-400">{{ $data['requests'] ?? 0 }} istek</span>
                    </div>
                ...
                <div class="grid grid-cols-3 gap-4 mt-3 text-xs">
                    <div>
                        ...
                        <span class="font-semibold text-green-600 dark:text-green-400">{{ number_format($data['success_rate'] ?? 0, 1) }}%</span>
                    </div>
                    <div>
                        <span class="text-gray-500 dark:text-gray-400">Yanıt Süresi:</span>
                        <span class="font-semibold text-blue-600 dark:text-blue-400">{{ number_format($data['avg_time'] ?? 0) }}ms</span>
                    </div>
                    <div>
                        <span class="text-gray-500 dark:text-gray-400">Maliyet:</span>
                        <span class="font-semibold text-orange-600 dark:text-orange-400">${{ number_format($data['cost'] ?? 0, 2) }}</span>
                    </div>
                </div>
            </div>
            @endforeach
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    @forelse(($analytics['recent_logs'] ?? []) as $log)
                    <tr>
