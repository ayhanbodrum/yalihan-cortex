...
<div class="container mx-auto px-4 py-6" x-data="yayinTipiYoneticisi()">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">Yayın Tipi Yöneticisi</h1>
    ...
    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/30 rounded-xl p-4 mb-6">
        <div class="flex items-start">
            ...
            <div>
                ...
                <p class="text-sm text-blue-800 dark:text-blue-400">Tek sayfada kategori, yayın tipleri ve ilişkileri yönetin. Ayrı sayfalara gerek yok, her şey bir arada!</p>
            </div>
        </div>
    </div>
    ...
    <div x-show="showAddModal"
        ...
        <div class="flex min-h-screen items-center justify-center p-4">
            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-md p-6" @click.stop>
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Yayın Tipi Ekle</h3>
