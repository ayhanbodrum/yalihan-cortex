...
@section('content_header')
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex items-center space-x-3">
            ...
            <button onclick="deleteKisi({{ $kisi->id }})" class="inline-flex items-center px-6 py-3 bg-red-600 text-white font-semibold rounded-lg hover:bg-red-700 hover:scale-105 active:scale-95 transition-all duration-200">
        ...
        <form action="{{ route('admin.kisiler.update', $kisi) }}" method="POST" x-data="kisiEditFormData({{ $kisi->id }})" class="space-y-8">
            ...
            <div class="bg-gray-50 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Ad -->
                        <div class="mb-6">
                            <label for="ad" class="block text-sm font-medium text-gray-900 dark:text-white">
                                <span class="block text-sm font-medium text-gray-900 dark:text-white-text">Ad *</span>
                            </label>
                        ...
                        <!-- Soyad -->
                        <div class="mb-6">
                            <label for="soyad" class="block text-sm font-medium text-gray-900 dark:text-white">
                                <span class="block text-sm font-medium text-gray-900 dark:text-white-text">Soyad *</span>
                            </label>
                        ...
                        <!-- Telefon -->
                        <div class="mb-6">
                            <label for="telefon" class="block text-sm font-medium text-gray-900 dark:text-white">
                                <span class="block text-sm font-medium text-gray-900 dark:text-white-text">Telefon *</span>
                            </label>
                        ...
                        <div class="mb-6">
                            <label for="email" class="block text-sm font-medium text-gray-900 dark:text-white">
                                <span class="block text-sm font-medium text-gray-900 dark:text-white-text">E-posta</span>
                            </label>
                        ...
                        <div class="mb-6">
                            <label for="status" class="block text-sm font-medium text-gray-900 dark:text-white">
                                <span class="block text-sm font-medium text-gray-900 dark:text-white-text">Durum *</span>
                            </label>
                            <select style="color-scheme: light dark;" id="status" name="status" required class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-black dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200" x-model="formData.status">
                        ...
                        <!-- Kişi Tipi -->
                        <div class="mb-6">
                            <label for="kisi_tipi" class="block text-sm font-medium text-gray-900 dark:text-white">
                                <span class="block text-sm font-medium text-gray-900 dark:text-white-text">Kişi Tipi</span>
                            </label>
                            <select style="color-scheme: light dark;" id="kisi_tipi" name="kisi_tipi" class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-black dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200" x-model="formData.kisi_tipi">
                        ...
                        <!-- Danışman -->
                        <div class="mb-6">
                            <label for="danisman_id" class="block text-sm font-medium text-gray-900 dark:text-white">
                                <span class="block text-sm font-medium text-gray-900 dark:text-white-text">Danışman *</span>
                            </label>
                        ...
                        <div class="mb-6">
                            <label for="etiketler_ids" class="block text-sm font-medium text-gray-900 dark:text-white">
                                <span class="block text-sm font-medium text-gray-900 dark:text-white-text">Etiketler</span>
                            </label>
                            <select id="etiketler_ids" name="etiketler_ids[]" multiple class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-black dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200" style="min-height: 120px; color-scheme: light dark;">
            ...
            <div class="bg-gray-50 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <!-- İlçe -->
                        <div class="mb-6">
                            <label for="ilce_id" class="block text-sm font-medium text-gray-900 dark:text-white">
                                <span class="block text-sm font-medium text-gray-900 dark:text-white-text">İlçe</span>
                            </label>
                        ...
                        <div class="mb-6">
                            <label for="mahalle_id" class="block text-sm font-medium text-gray-900 dark:text-white">
                                <span class="block text-sm font-medium text-gray-900 dark:text-white-text">Mahalle</span>
                            </label>
                    ...
                    <!-- Adres Detayı -->
                    <div class="mb-6 mt-6">
                        <label for="adres_detay" class="block text-sm font-medium text-gray-900 dark:text-white">
                            <span class="block text-sm font-medium text-gray-900 dark:text-white-text">Adres Detayı</span>
                        </label>
                        <textarea name="adres_detay" rows="3"
                            class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200 py-2.5 text-base"
            ...
            <div class="bg-gray-50 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
                <div class="p-6">
                    ...
                    <div class="mb-6">
                        <label for="notlar" class="block text-sm font-medium text-gray-900 dark:text-white">
                            <span class="block text-sm font-medium text-gray-900 dark:text-white-text">Müşteri Notları</span>
                        </label>
                        <textarea id="notlar" name="notlar" rows="4" class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-black dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200"
            ...
            <div class="flex justify-end space-x-4">
                <a href="{{ route('admin.kisiler.index') }}" class="inline-flex items-center px-6 py-3 bg-gray-600 text-white font-semibold rounded-lg shadow-md hover:bg-gray-700 hover:scale-105 hover:shadow-lg active:scale-95 focus:ring-2 focus:ring-blue-500 focus:outline-none transition-all duration-200">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
