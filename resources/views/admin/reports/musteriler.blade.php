        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6 mb-8">
            ...
            <form method="GET" action="{{ route('admin.reports.musteriler') }}"
                ...
                <div>
                    ...
                    <select style="color-scheme: light dark;" name="musteri_tipi" class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 w-full transition-all duration-200">
