        ...
        <div class="modal fade" id="aiAnalizModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-xl">
                <div class="modal-content bg-white dark:bg-gray-800 border-0 shadow-lg rounded-lg overflow-hidden">
                    ...
                    <div
                        class="modal-footer p-4 bg-gray-50 dark:bg-gray-900/50 border-t border-gray-200 dark:border-gray-700">
                        <button type="button"
                            class="inline-flex items-center px-4 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 shadow-sm"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content bg-white dark:bg-gray-800 border-0 shadow-lg rounded-lg overflow-hidden">
                    ...
                    <div class="modal-body p-6">
                        ...
                        <div class="grid grid-cols-3 gap-4 mb-6">
                            <div
                                ...
                                <div class="text-xl font-bold text-gray-900 dark:text-white" id="selectedCount">0</div>
                    ...
                    <div
                        ...
                        <button type="button"
                            class="inline-flex items-center px-4 py-2.5 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200"
...
<div class="modal fade" id="onerilerModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content bg-gray-50 dark:bg-gray-800 border-0 shadow-2xl rounded-2xl overflow-hidden">
            ...
            <div class="modal-header bg-blue-600 text-white border-0 p-4 relative isolate"
                ...
                <div class="flex items-center justify-between w-full relative z-10">
                    ...
                    <button type="button"
                        class="text-white hover:bg-white/20 rounded-lg p-2 transition-colors flex-shrink-0 ml-4"
                        data-bs-dismiss="modal" aria-label="Close">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M6 18L18 6M6 6l12 12" />
            ...
            <div class="modal-footer p-4 bg-gray-50 dark:bg-gray-900/50 border-t border-gray-200 dark:border-gray-700">
                <div class="flex flex-row items-center justify-between w-full gap-4">
                    ...
                    <div class="flex items-center gap-3 flex-shrink-0">
                        <button type="button"
                            class="inline-flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 shadow-sm whitespace-nowrap"
