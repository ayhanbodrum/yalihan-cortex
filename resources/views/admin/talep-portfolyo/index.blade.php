...
@section('content')
    <div x-data="{
        ...
        <div
            class="mb-8 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow duration-200 p-6">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                ...
                <div class="flex flex-wrap gap-3">
                    <button type="button"
                        class="inline-flex items-center px-4 py-2.5 text-sm font-medium text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 shadow-sm dark:shadow-gray-800"
        ...
        <!-- ✅ Context7: Content Wrapper - Tailwind CSS -->
        <div class="space-y-8">
            ...
            <div
                ...
                <div
                    class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-3">
                    <div class="flex items-center gap-2 px-4 py-2.5 bg-gray-100 dark:bg-gray-800 rounded-lg">
                        <input type="checkbox" id="selectAll"
                            class="w-5 h-5 text-blue-600 bg-gray-50 dark:bg-gray-800 border-gray-300 dark:border-gray-600 rounded focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 transition-all duration-200 cursor-pointer"
                            onchange="toggleSelectAll()">
                        <label for="selectAll"
                            class="text-sm font-medium text-gray-900 dark:text-white cursor-pointer">Tümünü
                            Seç</label>
                    </div>
                ...
                <!-- ✅ Context7: Card Body - Tailwind CSS -->
                <div class="p-0">
            ...
            <div x-show="showAiAnalizModal" x-transition:enter="transition ease-out duration-300"
                ...
                <div class="flex items-center justify-center min-h-screen px-4 py-8">
                    <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-5xl w-full border border-gray-200 dark:border-gray-700"
                        ...
                        <!-- Footer -->
                        <div
                            class="p-4 bg-gray-50 dark:bg-gray-900/50 border-t border-gray-200 dark:border-gray-700 rounded-b-xl">
                            <button type="button" @click="showAiAnalizModal = false"
                                class="inline-flex items-center px-4 py-2.5 text-sm font-medium text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 shadow-sm dark:shadow-gray-800">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-2xl w-full border border-gray-200 dark:border-gray-700"
                        ...
                        <div class="p-6">
                            <div class="text-center mb-6">
                                ...
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Toplu Analiz Onayı
                                </h3>
                            ...
                            <div class="grid grid-cols-3 gap-4 mb-6">
                                <div
                                    ...
                                    <div class="text-xl font-bold text-gray-900 dark:text-white" id="selectedCount">0
                                    </div>
                                    <div class="text-sm text-gray-600 dark:text-gray-400">Seçili Talep</div>
                                </div>
                                <div
                                    class="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                                    <div class="text-xl font-bold text-gray-900 dark:text-white">~2-5</div>
                                    <div class="text-sm text-gray-600 dark:text-gray-400">Dakika Süre</div>
                                </div>
                                <div
                                    class="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                                    <div class="text-xl font-bold text-gray-900 dark:text-white">99%</div>
        ...
        @push('scripts')
            <script>
                ...
                function topluAnalizBaslat() {
                    ...
                    <div class="text-center mt-4"><button class="inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 hover:scale-105 active:scale-95 focus:ring-2 focus:ring-blue-500 transition-all duration-200 shadow-md hover:shadow-lg" onclick="location.reload()">Sayfayı Yenile</button></div>`;
                                } else {
                                    alpineData.aiAnalizContent =
        ...
        <div x-show="showOnerilerModal" x-transition:enter="transition ease-out duration-300"
            ...
            <!-- Modal -->
            <div class="flex items-center justify-center min-h-screen px-4 py-8">
                <div class="relative bg-gray-50 dark:bg-gray-800 rounded-2xl shadow-2xl max-w-7xl w-full border border-gray-200 dark:border-gray-700"
                        ...
                        <div class="p-6 bg-gray-50 dark:bg-gray-900/50 border-b border-gray-200 dark:border-gray-700">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                                ...
                                <div
                                    ...
                                    <div class="p-3">
                                        <label for="minScore"
                                            class="flex items-center gap-1 text-sm font-medium mb-2 text-gray-900 dark:text-white">
                                ...
                                <div
                                    ...
                                    <div class="p-3">
                                        <label
                                            class="flex items-center gap-1 text-sm font-medium mb-3 text-gray-900 dark:text-white">
                                        ...
                                        <button type="button"
                                            class="inline-flex items-center justify-center w-full px-4 py-2.5 text-sm font-medium text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 shadow-sm dark:shadow-gray-800"
                    ...
                    <div
                        class="p-4 bg-gray-50 dark:bg-gray-900/50 border-t border-gray-200 dark:border-gray-700 rounded-b-2xl">
                        <div class="flex flex-row items-center justify-between w-full gap-4">
                            ...
                            <div class="flex items-center gap-3 flex-shrink-0">
                                <button type="button" @click="showOnerilerModal = false"
                                    class="inline-flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 shadow-sm dark:shadow-gray-800 whitespace-nowrap"
                                    aria-label="Kapat">
                                    <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
