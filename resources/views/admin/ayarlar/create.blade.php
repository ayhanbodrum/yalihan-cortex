    ...
    <div x-show="activeTab === 'single'" x-cloak>
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
            <div class="border-b border-gray-200 dark:border-gray-700 px-6 py-4">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white">📝 Manuel Ayar Ekle</h2>
        ...
        async createBulkGroup(groupKey) {
            const groups = {
                ...
                ai_complete: {
                    ...
                    settings: [
                        { key: 'ai_enabled', value: 'true', type: 'boolean', group: 'ai', description: 'AI özellikleri aktif' },
