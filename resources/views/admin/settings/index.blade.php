        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400 mt-1">Sistem genelinde tüm ayarları yönetin ve yapılandırın</p>
                </div>
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('admin.ai-settings.index') }}" 
                        class="inline-flex items-center px-4 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg hover:from-purple-700 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-all duration-200 shadow-md hover:shadow-lg active:scale-95">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="p-6">
                    ...
                    <div id="genel" class="tab-content">
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-2">
                                    <label for="site_title" class="block text-sm font-medium text-gray-900 dark:text-white">
                                ...
                                <div class="space-y-2">
                                    <label for="default_currency" class="block text-sm font-medium text-gray-900 dark:text-white">
                                    ...
                                    <select style="color-scheme: light dark;" 
                                        ...
                                        <option value="TRY" {{ ($settings['default_currency'] ?? 'TRY') == 'TRY' ? 'selected' : '' }}>₺ Türk Lirası (TRY)</option>
                                        <option value="USD" {{ ($settings['default_currency'] ?? '') == 'USD' ? 'selected' : '' }}>$ Dolar (USD)</option>
                                        <option value="EUR" {{ ($settings['default_currency'] ?? '') == 'EUR' ? 'selected' : '' }}>€ Euro (EUR)</option>
                                    </select>
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Sistem genelinde kullanılacak para birimi</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="space-y-6">
                                <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600 hover:shadow-md transition-all duration-200">
                                    <div class="flex-1">
                                        <label for="email_notifications" class="text-sm font-medium text-gray-900 dark:text-white block mb-1">
                                            E-posta Bildirimleri
                                        </label>
                                        <p class="text-xs text-gray-500 dark:text-gray-400">Önemli sistem olayları için e-posta bildirimleri gönder</p>
                                    </div>
                                ...
                                <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600 hover:shadow-md transition-all duration-200">
                                    <div class="flex-1">
                                        <label for="sms_notifications" class="text-sm font-medium text-gray-900 dark:text-white block mb-1">
                                            SMS Bildirimleri
                                        </label>
                                        <p class="text-xs text-gray-500 dark:text-gray-400">Acil durumlar için SMS bildirimleri gönder</p>
                                    </div>
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" 
                    ...
                    <div id="portal" class="tab-content hidden">
                        <div class="space-y-6">
                            ...
                            <div class="space-y-6">
                                <div class="space-y-2">
                                    <label for="sahibinden_api_key" class="block text-sm font-medium text-gray-900 dark:text-white">
                                        Sahibinden.com API Anahtarı
                                    </label>
                                    <div class="relative">
                                        <input type="password" 
                                               id="sahibinden_api_key"
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Sahibinden.com API anahtarınız</p>
                                </div>

                                <div class="space-y-2">
                                    <label for="hepsiemlak_api_key" class="block text-sm font-medium text-gray-900 dark:text-white">
                                        Hepsiemlak API Anahtarı
                                    </label>
                                    <div class="relative">
                                        <input type="password" 
                                               id="hepsiemlak_api_key"
                    ...
                    <div id="fiyat" class="tab-content hidden">
                        <div class="space-y-6">
                            ...
                            <div class="space-y-6">
                                <div class="space-y-2">
                                    <label for="price_rounding" class="block text-sm font-medium text-gray-900 dark:text-white">
                                        Fiyat Yuvarlama
                                    </label>
                                    <select style="color-scheme: light dark;" 
                                            id="price_rounding"
                                            name="price_rounding" 
                                            class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 shadow-sm hover:shadow-md">
                                        <option value="none" {{ ($settings['price_rounding'] ?? 'none') == 'none' ? 'selected' : '' }}>Yuvarlama Yok</option>
                                        <option value="nearest_1000" {{ ($settings['price_rounding'] ?? '') == 'nearest_1000' ? 'selected' : '' }}>En Yakın 1.000</option>
                                        <option value="nearest_10000" {{ ($settings['price_rounding'] ?? '') == 'nearest_10000' ? 'selected' : '' }}>En Yakın 10.000</option>
                                    </select>
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Fiyatların nasıl yuvarlanacağını seçin</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-6">
                            <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800 p-4">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h3 class="text-sm font-semibold text-blue-900 dark:text-blue-100 mb-1">QR Kod Özellikleri</h3>
                                        <p class="text-sm text-blue-700 dark:text-blue-300">İlanlar için QR kod oluşturma ve yönetim ayarları. QR kodlar mobil cihazlarla hızlı erişim sağlar.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-6">
                                <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600 hover:shadow-md transition-all duration-200">
                                    <div class="flex-1">
                                        <label for="qrcode_enabled" class="text-sm font-medium text-gray-900 dark:text-white block mb-1">
                                            QR Kod Özelliğini Aktif Et
                                        </label>
                                        <p class="text-xs text-gray-500 dark:text-gray-400">QR kod özelliğini tüm sistemde aktif/pasif yapar</p>
                                    </div>
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" 
                                               id="qrcode_enabled"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="space-y-2">
                                        <label for="qrcode_default_size" class="block text-sm font-medium text-gray-900 dark:text-white">
                                            Varsayılan QR Kod Boyutu (Piksel)
                                        </label>
                                        <input type="number" 
                                               id="qrcode_default_size"
                                        ...
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Önerilen: 200 (küçük), 300 (orta), 400 (büyük)</p>
                                    </div>
                                </div>

                                <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600 hover:shadow-md transition-all duration-200">
                                    <div class="flex-1">
                                        <label for="qrcode_show_on_cards" class="text-sm font-medium text-gray-900 dark:text-white block mb-1">
                                            İlan Kartlarında QR Kod Göster
                                        </label>
                                        <p class="text-xs text-gray-500 dark:text-gray-400">İlan listesi kartlarında QR kod butonu gösterilir</p>
                                    </div>
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" 
                                               id="qrcode_show_on_cards"
                                ...
                                <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600 hover:shadow-md transition-all duration-200">
                                    <div class="flex-1">
                                        <label for="qrcode_show_on_detail" class="text-sm font-medium text-gray-900 dark:text-white block mb-1">
                                            İlan Detay Sayfasında QR Kod Göster
                                        </label>
                                        <p class="text-xs text-gray-500 dark:text-gray-400">İlan detay sayfalarında QR kod widget'ı gösterilir</p>
                                    </div>
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" 
                                               id="qrcode_show_on_detail"
                        ...
                        <div class="space-y-6">
                            <div class="bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800 p-4">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h3 class="text-sm font-semibold text-green-900 dark:text-green-100 mb-1">İlan Navigasyon Özellikleri</h3>
                                        <p class="text-sm text-green-700 dark:text-green-300">İlanlar arasında gezinme, önceki/sonraki ilan ve benzer ilanlar özellikleri.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-6">
                                <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600 hover:shadow-md transition-all duration-200">
                                    <div class="flex-1">
                                        <label for="navigation_enabled" class="text-sm font-medium text-gray-900 dark:text-white block mb-1">
                                            Navigasyon Özelliğini Aktif Et
                                        </label>
                                        <p class="text-xs text-gray-500 dark:text-gray-400">İlan navigasyon özelliğini tüm sistemde aktif/pasif yapar</p>
                                    </div>
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" 
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="space-y-2">
                                        <label for="navigation_default_mode" class="block text-sm font-medium text-gray-900 dark:text-white">
                                            Varsayılan Navigasyon Modu
                                        </label>
                                        <select style="color-scheme: light dark;" 
                                                id="navigation_default_mode"
                                                name="navigation_default_mode" 
                                                class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 shadow-sm hover:shadow-md">
                                            <option value="default" {{ ($settings['navigation_default_mode'] ?? 'default') == 'default' ? 'selected' : '' }}>Varsayılan (Tüm ilanlar)</option>
                                            <option value="category" {{ ($settings['navigation_default_mode'] ?? '') == 'category' ? 'selected' : '' }}>Kategori Bazlı</option>
                                            <option value="location" {{ ($settings['navigation_default_mode'] ?? '') == 'location' ? 'selected' : '' }}>Konum Bazlı</option>
                                        </select>
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Önceki/sonraki ilan gösterim yöntemi</p>
                                    </div>

                                    <div class="space-y-2">
                                        <label for="navigation_similar_limit" class="block text-sm font-medium text-gray-900 dark:text-white">
                                            Benzer İlanlar Gösterim Sayısı
                                        </label>
                                        <input type="number" 
                                               id="navigation_similar_limit"
                                               ...
                                               class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 shadow-sm hover:shadow-md">
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Benzer ilanlar bölümünde gösterilecek ilan sayısı (1-12 arası)</p>
                                    </div>
                                </div>

                                <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600 hover:shadow-md transition-all duration-200">
                                    <div class="flex-1">
                                        <label for="navigation_show_similar" class="text-sm font-medium text-gray-900 dark:text-white block mb-1">
                                            Benzer İlanlar Bölümünü Göster
                                        </label>
                                        <p class="text-xs text-gray-500 dark:text-gray-400">İlan detay sayfalarında benzer ilanlar bölümü gösterilir</p>
                                    </div>
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" 
                                               id="navigation_show_similar"
                    ...
                    <div id="kullanici" class="tab-content hidden">
                        <div class="space-y-6">
                            ...
                            <div class="space-y-6">
                                <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600 hover:shadow-md transition-all duration-200">
                                    <div class="flex-1">
                                        <label for="user_registration" class="text-sm font-medium text-gray-900 dark:text-white block mb-1">
                                            Yeni Kullanıcı Kaydı
                                        </label>
                                        <p class="text-xs text-gray-500 dark:text-gray-400">Yeni kullanıcıların kendi başlarına kayıt olmasına izin ver</p>
                                    </div>
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" 
                                               ...
                                               value="1"
                                               {{ ($settings['user_registration'] ?? false) ? 'checked' : '' }}
                                               class="sr-only peer">
                                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                                    </label>
                                </div>
                                ...
                                <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600 hover:shadow-md transition-all duration-200">
                                    <div class="flex-1">
                                        <label for="password_strength" class="text-sm font-medium text-gray-900 dark:text-white block mb-1">
                                            Şifre Güçlülük Zorunluluğu
                                        </label>
                                        <p class="text-xs text-gray-500 dark:text-gray-400">Kullanıcıların güçlü şifre kullanmasını zorunlu kıl</p>
                                    </div>
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" 
                                               ...
                                               value="1"
                                               {{ ($settings['password_strength'] ?? false) ? 'checked' : '' }}
                                               class="sr-only peer">
                                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                                    </label>
                                </div>
