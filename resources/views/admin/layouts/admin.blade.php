                    ...
                    <div class="h-14 flex items-center gap-3 px-3 sm:px-4">
                        <div class="ml-auto flex items-center gap-2">
                            ...
                            <div class="relative" x-data="{ o: false }">
                                <button @click="o=!o"
                                    class="inline-flex items-center gap-2 px-2 py-1 rounded-md border border-gray-200 bg-white hover:bg-gray-50 transition-colors dark:bg-gray-800 dark:border-gray-800 dark:hover:bg-gray-700">
                                    <div
                                ...
                                <div x-show="o" @click.away="o=false" x-transition
                                    ...
                                    <form method="POST" action="{{ route('logout') }}">@csrf
                                        <button type="submit"
                                            class="block px-4 py-2 text-sm hover:bg-gray-50 dark:hover:bg-gray-800 w-full text-left">Çıkış</button>
                                    </form>
                                </div>
                            </div>
                        </div>
