        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="p-6">
                        <form @submit.prevent="searchPlaces" class="space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span
                                            class="text-sm font-mono text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 px-3 py-2 rounded-lg min-w-[80px] text-center"
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <label
                                        class="block text-sm font-medium text-gray-900 dark:text-white mb-2">Latitude</label>
                ...
                <div x-show="showSitesModal && filteredResults.length > 0" x-cloak
                    ...
                    <div class="flex min-h-screen items-center justify-center p-4 relative z-[9999]">
                        <div @click.stop
                            ...
                            <div class="p-6 overflow-y-auto max-h-[60vh] relative" style="z-index: 10001;">
                                <div class="space-y-3 relative" style="z-index: 10001;">
                                    <template x-for="(place, index) in filteredResults" :key="place.id">
                                        <div class="group bg-gradient-to-r from-white to-gray-50 dark:from-gray-800 dark:to-gray-800 rounded-xl border-2 border-gray-200 dark:border-gray-700 hover:border-purple-500 dark:hover:border-purple-400 transition-all duration-200 overflow-hidden relative"
                                            style="z-index: 10002;">
                                            <div class="p-4">
                                                <div class="flex items-start justify-between gap-4">
                                                    <div class="flex-1">
                                                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors"
                            ...
                            <div
                                class="border-t border-gray-200 dark:border-gray-700 px-6 py-4 bg-gray-50 dark:bg-gray-800 flex items-center justify-end gap-3">
                                <button @click="showSitesModal = false"
                ...
                <div x-show="results.length > 0 && !showSitesModal" x-cloak
                    ...
                    <div class="p-6 space-y-4">
                        <template x-for="(place, index) in results" :key="place.id">
                            <div
                                class="group bg-gradient-to-r from-white to-gray-50 dark:from-gray-800 dark:to-gray-800 rounded-xl border-2 border-gray-200 dark:border-gray-700 hover:border-purple-500 dark:hover:border-purple-400 transition-all duration-200 overflow-hidden">
                                <div class="p-6">
                                    <div class="flex items-start justify-between gap-4">
                                        <div class="flex-1">
                                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors"
                ...
                <div x-show="!searching && results.length === 0"
                    class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-12 text-center">
            ...
            <div class="flex min-h-screen items-center justify-center p-4">
                <div @click.stop
                    ...
                    <div
                        class="border-b border-gray-200 dark:border-gray-700 px-6 py-4 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20">
                        <div class="flex items-center justify-between">
                            <h3 class="text-xl font-semibold text-gray-900 dark:text-white" x-text="selectedPlace?.title">
                            </h3>
                    ...
                    <div class="p-6 max-h-[60vh] overflow-y-auto">
                        <div class="space-y-4">
                            ...
                            <div x-show="selectedPlace?.description">
                                ...
                                <p class="text-gray-700 dark:text-gray-300 text-sm" x-text="selectedPlace?.description">
                                </p>
                            </div>
                ...
                return {
                    ...
                    initMap() {
                        ...
                        this.map.on('click', (e) => {
                            ...
                            // ✅ Context7: TurkiyeAPI'den lokasyon bilgisi getir
                        ...
                        try {
                            ...
                            if (data.success && data.data) {
                                ...
                                if (this.marker && locationInfo.mahalle) {
                                    const popupContent = `
                            <div class="p-2">
                                <h3 class="font-semibold text-gray-900 mb-2">📍 Lokasyon Bilgisi</h3>
                                ${locationInfo.mahalle ? `<p class="text-sm text-gray-700"><strong>Mahalle:</strong> ${locationInfo.mahalle.name}</p>` : ''}
                                ${locationInfo.ilce ? `<p class="text-sm text-gray-700"><strong>İlçe:</strong> ${locationInfo.ilce.name}</p>` : ''}
                                ${locationInfo.il ? `<p class="text-sm text-gray-700"><strong>İl:</strong> ${locationInfo.il.name}</p>` : ''}
