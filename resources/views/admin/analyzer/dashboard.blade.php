        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6">
            ...
            @if (isset($cssCompliance) || isset($innovationStats))
                <div class="mt-6 pt-6 border-t border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-800 mb-4">📊 Detaylı İstatistikler</h3>
                 ...
                 <div class="mt-8 pt-6 border-t border-gray-200">
                     ...
                     <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                         <div class="px-6 py-4 border-b border-gray-200">
                             <h4 class="text-lg font-semibold text-gray-800">Emlak Sayfaları Detayları</h4>
                         </div>
                     ...
                     @if(isset($emlakResults['category_breakdown']) && count($emlakResults['category_breakdown']) > 0)
                         <div class="mt-6 bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                             <h4 class="text-lg font-semibold text-gray-800 mb-4">Kategori Bazında Analiz</h4>
                             <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
