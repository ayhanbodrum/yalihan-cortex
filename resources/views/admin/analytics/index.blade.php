...
<div class="space-y-6">
        ...
        <div class="bg-gray-50 dark:bg-gray-800 rounded-xl shadow-lg p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $metrics['total_ilanlar'] ?? 0 }}</p>
                </div>
        ...
        <div class="bg-gray-50 dark:bg-gray-800 rounded-xl shadow-lg p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $metrics['total_kategoriler'] ?? 0 }}</p>
                </div>
        ...
        <div class="bg-gray-50 dark:bg-gray-800 rounded-xl shadow-lg p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $metrics['total_kullanicilar'] ?? 0 }}</p>
                </div>
        ...
        <div class="bg-gray-50 dark:bg-gray-800 rounded-xl shadow-lg p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $metrics['new_ilanlar_this_month'] ?? 0 }}</p>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <!-- İlan Trendi Chart -->
        <div class="bg-gray-50 dark:bg-gray-800 rounded-xl shadow-lg p-6">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">📈 İlan Trendi (Son 7 Gün)</h3>
            <canvas id="ilanTrendiChart" width="400" height="200"></canvas>
        </div>

        <!-- Kategori Dağılımı Chart -->
        <div class="bg-gray-50 dark:bg-gray-800 rounded-xl shadow-lg p-6">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">🥧 Kategori Dağılımı</h3>
    ...
    <!-- Top Kategori -->
    <div class="bg-gray-50 dark:bg-gray-800 rounded-xl shadow-lg p-6">
        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">🏆 En Popüler Kategori</h3>
        <div class="flex items-center justify-between">
            <div>
                <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $metrics['top_kategori'] ?? 'Veri yok' }}</p>
