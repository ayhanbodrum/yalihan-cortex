...
@section('content')
                        ...
                        <div class="p-6">
                            ...
                            @else
                                <div class="text-center py-8">
                                    ...
                                    <p class="text-gray-500 text-lg">Şu anda status talebiniz bulunmuyor</p>
                        ...
                        <div class="p-6 space-y-3">
                            <button onclick="getAIContext('yeni_talep')"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <p class="font-medium text-gray-800">Yeni Talep Önerileri</p>
                            ...
                            <button onclick="getAIContext('ilan_eşleştirme')"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <p class="font-medium text-gray-800">Eşleştirme Önerileri</p>
                            ...
                            <button onclick="getAIContext('müşteri_takip')"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <p class="font-medium text-gray-800">Müşteri Takip</p>
    ...
    <div id="loadingModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden items-center justify-center">
        <div class="bg-white rounded-2xl p-8 text-center">
            ...
            <p class="text-lg font-semibold text-gray-800">AI Analizi Yapılıyor...</p>
...
@push('scripts')
    <script>
        ...
        async function startBatchAnalysis() {
            ...
            'Tüm status taleplerin AI analizi yapılsın mı? Bu işlem birkaç dakika sürebilir.');
            if (!confirmed) return;
        ...
        function displaySearchResults(results) {
            ...
            let html = '<h4 class="font-semibold text-gray-800 mb-4">Bulunan İlanlar (' + results.length + ' adet)</h4>';
