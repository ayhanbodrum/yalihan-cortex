...
@section('content')
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form action="{{ route('admin.ozellikler.update', $ozellik) }}" method="POST" x-data="{
            ...
            <!-- Temel Bilgiler -->
            <div class="bg-gray-50 dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 mb-8 overflow-hidden hover:shadow-xl transition-shadow duration-300">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <select style="color-scheme: light dark;" id="feature_category_id" name="feature_category_id" required
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-4">
                            ...
                            <p class="text-gray-600 dark:text-gray-400">{{ $ozellik->created_at->format('d.m.Y H:i') }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Modern Form Actions -->
            <div class="bg-gray-50 dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 sticky bottom-6">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        <a href="{{ route('admin.ozellikler.index') }}"
                            class="px-6 py-3 border-2 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200 text-center font-medium">
                            İptal
                        </a>
