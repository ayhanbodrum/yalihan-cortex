        ...
        <div class="container-fluid">
            <div class="flex justify-between items-center">
                ...
                <div class="flex space-x-2">
                    <!-- Geri Dön -->
                    <a href="{{ route('admin.ilan-kategorileri.index') }}" class="neo-btn neo-btn-secondary touch-target-optimized touch-target-optimized">
                    ...
                    <!-- Export -->
                    <a href="{{ route('admin.ilan-kategorileri.export') }}" class="neo-btn neo-btn-secondary touch-target-optimized touch-target-optimized">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <!-- Yenile -->
                    <button onclick="window.location.reload()" class="neo-btn neo-btn-primary touch-target-optimized touch-target-optimized">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
