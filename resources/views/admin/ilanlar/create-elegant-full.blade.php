...
@section('title', 'Yeni İlan Ekle - Modern')
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600 dark:text-gray-400 text-lg">
                Modern, hızlı ve AI destekli ilan oluşturma deneyimi
            </p>
        </div>
...
console.log('✅ Modern İlan Ekleme Formu Yüklendi');
</script>
@endpush
@endsection
