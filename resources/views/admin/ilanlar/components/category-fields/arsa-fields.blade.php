...
<div x-show="selectedKategoriSlug && (selectedKategoriSlug.includes('arsa') || selectedKategoriSlug.includes('land'))"
    ...
    <div x-data="{
        ...
        if (!adaNo || !parselNo || !alanM2 || !ilce) { alert('Lütfen Ada No, Parsel No, Alan (m²) ve İlçe bilgilerini
        giriniz.'); return; } this.analyzing=true; this.aiAnalysisResult=null; // API çağrısı
                ...
                <div x-show="aiAnalysisResult" x-transition:enter="transition ease-out duration-300"
                    ...
                    <div class="space-y-3 text-sm">
                        ...
                        <template x-if="aiAnalysisResult.gabari">
                            <div
                                class="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                                <span class="font-semibold text-gray-700 dark:text-gray-300">Gabari (Yükseklik):</span>
                                <span class="text-gray-900 dark:text-white font-bold"
                        ...
                        <template x-if="aiAnalysisResult.toplam_insaat_alani">
                            <div
                                class="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                                <span class="font-semibold text-gray-700 dark:text-gray-300">Toplam İnşaat Alanı:</span>
                                <span class="text-gray-900 dark:text-white font-bold"
                        ...
                        <template x-if="aiAnalysisResult.cekme_mesafeleri">
                            <div class="py-2">
                                <span class="font-semibold text-gray-700 dark:text-gray-300 block mb-2">Çekme
                                    Mesafeleri:</span>
