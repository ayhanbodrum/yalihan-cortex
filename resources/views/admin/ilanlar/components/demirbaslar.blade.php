{{-- ✅ Context7: Demirbaşlar Component (Hiyerarşik Yapı) --}}
<div
    ...
    (function() {
        ...
        const DemirbasManager = {
            ...
            init() {
                ...
                // ✅ Context7: Listen for category-changed event
                window.addEventListener('category-changed', (e) => {
                    ...
                    // ✅ Context7: Ana kategori ID'sini al
            ...
            renderDemirbaslar() {
                ...
                // ✅ Context7: Hiyerarşik yapıyı render et
