        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 mb-8 p-8">
            <div class="flex items-center justify-between">
                ...
                <div class="flex gap-4">
                    <a href="{{ url('/profile') }}" class="neo-btn neo-btn neo-btn-primary touch-target-optimized touch-target-optimized">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-4">
                        <div class="flex justify-between items-center p-4 bg-gray-50 rounded-lg">
                            ...
                            <span class="text-gray-900">{{ auth()->user()->name ?? 'Belirtilmemiş' }}</span>
                        </div>
                        <div class="flex justify-between items-center p-4 bg-gray-50 rounded-lg">
                    ...
                    <div class="space-y-4">
                        <div class="flex justify-between items-center p-4 bg-gray-50 rounded-lg">
                            ...
                            <span class="text-gray-900">{{ auth()->user()->phone_number ?? 'Belirtilmemiş' }}</span>
                        </div>
                        <div class="flex justify-between items-center p-4 bg-gray-50 rounded-lg">
                            <span class="font-medium text-gray-700">Unvan:</span>
                            <span class="text-gray-900">{{ auth()->user()->title ?? 'Belirtilmemiş' }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <a href="{{ route('logout') }}"
                        ...
                        <div>
                            <h3 class="font-medium text-gray-900">Çıkış Yap</h3>
