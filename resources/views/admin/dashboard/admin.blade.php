...
@section('content')
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        <!-- Header -->
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 mb-8 p-8">
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <div class="flex gap-4">
                    <button class="inline-flex items-center px-4 py-2.5 rounded-lg bg-blue-600 text-white hover:bg-blue-700 hover:scale-105 active:scale-95 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-md hover:shadow-lg" onclick="generatePerformanceReport()">
                    ...
                    <button class="inline-flex items-center px-4 py-2.5 rounded-lg border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 hover:scale-105 active:scale-95 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-gray-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-700" onclick="optimizeSystem()">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="space-y-8">
                ...
                <div class="stat-card">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="stat-card-value">{{ $quickStats['total_ilanlar'] ?? 0 }}</p>
                        </div>
                ...
                <div class="stat-card">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-green-600 dark:text-green-400">{{ $quickStats['active_ilanlar'] ?? 0 }}</p>
                        </div>
                ...
                <div class="stat-card">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-purple-600 dark:text-purple-400">{{ $quickStats['total_users'] ?? 0 }}</p>
                        </div>
                ...
                <div class="stat-card">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-orange-600 dark:text-orange-400">{{ $quickStats['total_danismanlar'] ?? 0 }}</p>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    @foreach ($quickStats['system_status'] ?? [] as $service => $status)
                        <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                            <span class="font-medium text-gray-700 dark:text-gray-300 capitalize">{{ $service }}</span>
                            <span
                                class="flex items-center text-sm {{ $status === 'online' ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}">
                                <div
            ...
            <div class="stat-card">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="{{ route('admin.ilanlar.index') }}" class="inline-flex items-center px-4 py-2.5 rounded-lg bg-blue-600 text-white hover:bg-blue-700 active:scale-95 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        Tümünü Gör
                    </a>
                </div>
                <div class="space-y-4">
                    @forelse($quickStats['recent_ilanlar'] ?? [] as $ilan)
                        <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors duration-200">
                            <div>
                                <h3 class="font-medium text-gray-900 dark:text-white">{{ $ilan->ilan_basligi }}</h3>
                                <p class="text-sm text-gray-600 dark:text-gray-400">{{ number_format($ilan->fiyat) }} TL</p>
                            </div>
                            <div class="text-right">
                                <p class="text-sm text-gray-500 dark:text-gray-400">{{ $ilan->created_at->diffForHumans() }}</p>
                    ...
                    @empty
                        <div class="text-center py-8 text-gray-500 dark:text-gray-400">
                            ...
                            @if (Route::has('admin.ilanlar.create'))
                                <a href="{{ route('admin.ilanlar.create') }}" class="mt-3 inline-flex items-center gap-2 px-3 py-1.5 rounded-lg border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 active:scale-95 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-gray-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-700 text-xs">
                                    Yeni İlan Oluştur
                                </a>
                            @endif
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    @if (Route::has('admin.ilanlar.create'))
                        <a href="{{ route('admin.ilanlar.create') }}"
                            ...
                            <div>
                                <h3 class="font-medium text-gray-900 dark:text-white">Yeni İlan</h3>
                    ...
                    <a href="{{ route('admin.kullanicilar.index') }}"
                        ...
                        <div>
                            <h3 class="font-medium text-gray-900 dark:text-white">Kullanıcılar</h3>
                    ...
                    <a href="{{ route('admin.danisman.index') }}"
                        ...
                        <div>
                            <h3 class="font-medium text-gray-900 dark:text-white">Danışmanlar</h3>
                    ...
                    <a href="{{ route('admin.reports.index') }}"
                        ...
                        <svg class="w-8 h-8 text-purple-600 dark:text-purple-400 mr-3" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002 2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z">
                            </path>
                        ...
                        <div>
                            <h3 class="font-medium text-gray-900 dark:text-white">Raporlar</h3>
                    ...
                    <a href="{{ route('admin.ayarlar.index') }}"
                        ...
                        <div>
                            <h3 class="font-medium text-gray-900 dark:text-white">Ayarlar</h3>
            ...
            <div class="stat-card">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    @if (Route::has('admin.ozellikler.kategoriler.index'))
                        <a href="{{ route('admin.ozellikler.kategoriler.index') }}" class="flex items-center p-4 bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-lg hover:shadow-md transition-colors duration-200">
                            ...
                            <div>
                                <h3 class="font-medium text-gray-900 dark:text-white">Özellik Kategorileri</h3>
                                <p class="text-sm text-gray-600 dark:text-gray-400">Liste ve düzenleme</p>
                            </div>
                        </a>
                    @endif
                    @if (Route::has('admin.property_types.show'))
                        <a href="{{ route('admin.property_types.show', 1) }}" class="flex items-center p-4 bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 rounded-lg hover:shadow-md transition-colors duration-200">
                            ...
                            <div>
                                <h3 class="font-medium text-gray-900 dark:text-white">Property Type Manager</h3>
                                <p class="text-sm text-gray-600 dark:text-gray-400">Kategori 1</p>
                            </div>
                        </a>
                    @endif
                    @if (Route::has('admin.property_types.field_dependencies'))
                        <a href="{{ route('admin.property_types.field_dependencies', 1) }}" class="flex items-center p-4 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-lg hover:shadow-md transition-colors duration-200">
                            ...
                            <div>
                                <h3 class="font-medium text-gray-900 dark:text-white">Alan İlişkileri</h3>
                                <p class="text-sm text-gray-600 dark:text-gray-400">Kategori 1</p>
                            </div>
                        </a>
                    @endif
                    @if (Route::has('admin.ozellikler.kategoriler.show'))
                        <a href="{{ route('admin.ozellikler.kategoriler.show', 5) }}" class="flex items-center p-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-lg hover:shadow-md transition-colors duration-200">
                            ...
                            <div>
                                <h3 class="font-medium text-gray-900 dark:text-white">Kategori Detayı</h3>
