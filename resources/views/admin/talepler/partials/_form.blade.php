...
<div class="space-y-8">
        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="form-field">
                    ...
                    <select style="color-scheme: light dark;" id="kisi_id" name="kisi_id" class="admin-input transition-all duration-200" required>
                ...
                <div class="form-field">
                    ...
                    <select style="color-scheme: light dark;" id="talep_tipi" name="talep_tipi" class="admin-input transition-all duration-200" required>
                ...
                <div class="form-field">
                    ...
                    <select style="color-scheme: light dark;" id="category_id" name="category_id" class="admin-input transition-all duration-200" required>
        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="form-field">
                    ...
                    <select style="color-scheme: light dark;" name="para_birimi" id="para_birimi" class="admin-input transition-all duration-200">
    ...
    <div class="flex justify-end gap-4 pt-6">
        <a href="{{ route('admin.talepler.index') }}" class="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg transition-all duration-200 focus:ring-2 focus:ring-offset-2 inline-flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-300 bg-white text-gray-700 rounded-lg hover:bg-gray-50 hover:scale-105 active:scale-95 focus:ring-2 focus:ring-gray-500 transition-all duration-200 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-700 touch-target-optimized">
