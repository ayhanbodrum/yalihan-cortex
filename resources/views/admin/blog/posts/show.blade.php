        ...
        <div class="neo-card mb-8 p-8">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
                ...
                <div class="flex items-center space-x-3">
                    <a href="{{ route('admin.blog.posts.edit', $post) }}" class="neo-btn neo-btn-primary touch-target-optimized touch-target-optimized">
                    ...
                    <a href="{{ route('blog.show', $post->slug) }}" target="_blank" class="neo-btn neo-btn-secondary touch-target-optimized touch-target-optimized">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="neo-card overflow-hidden">
                        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-800">
                            <div class="flex items-center justify-between">
                                <h3 class="text-xl font-bold text-gray-800">Yorumlar ({{ $post->comments->count() }})</h3>
                                    ...
                                    <div class="border border-gray-200 rounded-lg p-4">
                                        <div class="flex items-start justify-between">
                                            ...
                                            <div class="flex items-center space-x-2 ml-4">
                                                ...
                                                @endif
                                                <button class="neo-btn neo-btn-secondary touch-target-optimized touch-target-optimized" title="Reddet">
                                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                        <path fill-rule="evenodd"
                    ...
                    <div class="p-6 space-y-3">
                        ...
                        @if ($post->status === 'published')
                            <form method="POST" action="{{ route('admin.blog.posts.unpublish', $post) }}"
                                class="w-full">
                                @csrf
                                <button type="submit" class="neo-btn neo-btn-secondary w-full touch-target-optimized touch-target-optimized">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <form method="POST" action="{{ route('admin.blog.posts.feature', $post) }}" class="w-full">
                            @csrf
                            <button type="submit" class="neo-btn-danger w-full touch-target-optimized touch-target-optimized">
                        ...
                        <form method="POST" action="{{ route('admin.blog.posts.stick', $post) }}" class="w-full">
                            @csrf
                            <button type="submit" class="neo-btn neo-btn neo-btn-secondary w-full touch-target-optimized touch-target-optimized">
                                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
