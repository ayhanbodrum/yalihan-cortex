...
<div
    ...
    x-init="fetchRates(); setInterval(() => fetchRates(), 300000)" {{-- 5 dakika --}}
...
>
    ...
    {{-- Rates List --}}
    <div x-show="!loading || rates.length > 0" class="grid gap-3" :class="{ 'grid-cols-2': {{ $compact ? 'true' : 'false' }}, 'grid-cols-1': !{{ $compact ? 'true' : 'false' }} }">
