    ...
    <div class="mt-8">
        ...
        <div class="mt-6 p-5 rounded-xl 
            ...
            <div class="flex items-center gap-3 mb-3">
                ...
                <span class="font-semibold text-gray-900 dark:text-white">TKGM Otomatik Veri Çekme</span>
            </div>
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-3">
                💡 Ada/Parsel numarası girdiğinizde, TKGM'den otomatik olarak imar durumu ve koordinatlar çekilecektir.
            </p>
