    ...
    <div x-show="!collapsed" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="space-y-3">
            ...
            <div class="bg-gray-50 dark:bg-gray-700/50 p-3 rounded-lg">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300">💡 Ideas Progress</span>
        ...
        <div
            ...
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-sm font-medium text-gray-700 dark:text-gray-300">💰 Monthly Value</div>
