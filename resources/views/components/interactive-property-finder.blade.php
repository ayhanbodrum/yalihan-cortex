...
<div class="bg-white rounded-3xl shadow-2xl p-8 max-w-6xl mx-auto" x-data="{
    ...
    subcategories: {
        'satilik': [
            ...
            { id: 'isyeri', name: 'İşyeri', icon: 'fas fa-store', color: 'purple' }
        ],
        'kiralik': [
            { id: 'daire', name: 'Daire', icon: 'fas fa-building', color: 'blue' },
            { id: 'villa', name: 'Villa', icon: 'fas fa-home', color: 'green' },
            { id: 'ofis', name: 'Ofis', icon: 'fas fa-briefcase', color: 'gray' },
            { id: 'dukkkan', name: 'Dükkan', icon: 'fas fa-store', color: 'orange' }
        ],
        'yazlik': [
            { id: 'villa', name: 'Yazlık Villa', icon: 'fas fa-umbrella-beach', color: 'cyan', fields: ['havuz', 'deniz_mesafe', 'klima', 'wifi'] },
            { id: 'apart', name: 'Apart Daire', icon: 'fas fa-building', color: 'blue', fields: ['klima', 'wifi', 'otopark'] },
            { id: 'bungalov', name: 'Bungalov', icon: 'fas fa-home', color: 'green', fields: ['bahce', 'barbekü', 'wifi'] },
    ...
    categoryFields: {
        ...
        'bungalov': {
            'bahce': { name: 'Bahçe', icon: 'fas fa-leaf', type: 'checkbox' },
            'barbekü': { name: 'Barbekü', icon: 'fas fa-fire', type: 'checkbox' },
            'wifi': { name: 'WiFi', icon: 'fas fa-wifi', type: 'checkbox' }
        },
        'studio': {
            'klima': { name: 'Klima', icon: 'fas fa-snowflake', type: 'checkbox' },
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <!-- Price Range Filter -->
        <div class="space-y-2">
            <label class="block text-sm font-semibold text-gray-700">Fiyat Aralığı</label>
        ...
        <div class="space-y-2" x-show="propertyType === 'konut'">
            <label class="block text-sm font-semibold text-gray-700">Oda Sayısı</label>
        ...
        <div class="space-y-2" x-show="propertyType === 'arsa'">
            <label class="block text-sm font-semibold text-gray-700">Arsa Büyüklüğü</label>
            <select
                class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
