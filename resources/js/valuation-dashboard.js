        ...
        if (!data.success || !data.data || data.data.length === 0) {
            container.innerHTML = `
                <div class="text-center py-8">
                    ...
                    <p class="text-gray-500 dark:text-gray-400">Henüz değerleme yapılmamış</p>
                </div>
            `;
            return;
        }
        ...
        if (!data.success || !data.data || data.data.length === 0) {
            container.innerHTML = `
                <div class="text-center py-8">
                    ...
                    <p class="text-gray-500 dark:text-gray-400">Market trend verisi bulunamadı</p>
                </div>
            `;
            return;
        }
        ...
        container.innerHTML = `
            <div class="space-y-4">
                <div class="flex items-center justify-between">
                    <span class="text-sm font-medium text-gray-900 dark:text-white">6 Aylık Trend</span>
