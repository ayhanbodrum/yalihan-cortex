...
class Context7FixCommand extends Command
{
    protected $signature = 'context7:fix
                            {--path= : Specific path to check}
                            {--fix : Auto-fix violations}
                            {--report : Generate detailed report}';

    protected $description = 'Fix Context7 violations automatically';

    public function handle()
    {
        $this->info('🚀 Running context7:fix...');
