...
class Context7ReportCommand extends Command
{
    protected $signature = 'context7:report
                            {--path= : Specific path to check}
                            {--fix : Auto-fix violations}
                            {--report : Generate detailed report}';

    protected $description = 'Generate detailed Context7 compliance report';

    public function handle()
    {
        $this->info('🚀 Running context7:report...');
