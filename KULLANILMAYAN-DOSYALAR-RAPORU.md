...
✅ layouts/admin.blade.php:
   asset('css/neo-unified.css') → KALDIRILDI
...
```yaml
Mevcut (resources/views/ root):
  📄 yaliihan-home-clean.blade.php (19 KB)
...
Yeni Yer (resources/views/frontend/pages/):
  → Tüm dosyalar buraya taşınmalı
