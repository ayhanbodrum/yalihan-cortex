    ...
    generateRecommendations(results) {
        ...
        if (results.migrations.errors.length > 0) {
            ...
            if (moduleErrors.length > 0) {
                recommendations +=
                    "- **Modül Yapısı**: Migration dosyalarının doğru modül dizinlerinde olduğundan ve namespace'lerin doğru olduğundan emin olun.\n";
            }
            ...
            if (syntaxErrors.length > 0) {
                recommendations +=
                    '- **Sözdizimi**: PHP sözdizimi hatalarını düzeltin. Eksik parantezler, noktalı virgüller veya diğer sözdizimi hataları olabilir.\n';
            }
            ...
            if (versionErrors.length > 0) {
                recommendations +=
                    '- **Versiyon Formatı**: Migration dosya adlarının YYYY_MM_DD_HHMMSS formatına uygun olduğundan emin olun.\n';
            }
        ...
        if (results.seeders.errors.length > 0) {
            ...
            if (moduleErrors.length > 0) {
                recommendations +=
                    "- **Modül Yapısı**: Seeder dosyalarının doğru modül dizinlerinde olduğundan ve namespace'lerin doğru olduğundan emin olun.\n";
            }
            ...
            if (dependencyErrors.length > 0) {
                recommendations +=
                    "- **Bağımlılıklar**: Seeder'ların bağımlı olduğu diğer seeder'ların varlığını kontrol edin.\n";
            }
            ...
            if (afterLastBatchWarnings.length > 0) {
                recommendations +=
                    "- **afterLastBatch**: Migration sonrası otomatik çalıştırma için seeder'lara afterLastBatch metodu ekleyin.\n";
            }
