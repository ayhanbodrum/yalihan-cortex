                            ...
                            <div class="p-4">
                                <div class="mb-4">
                                    <div class="flex items-center justify-between">
                                        <div class="text-sm font-medium text-gray-700 dark:text-gray-300">Son Eşleşme
                                            Tarihi:</div>
                                        <div class="text-sm text-gray-900 dark:text-white">{{ now()->format('d.m.Y H:i') }}
                                        </div>
                                    </div>
                                    <div class="flex items-center justify-between mt-2">
                                        <div class="text-sm font-medium text-gray-700 dark:text-gray-300">Toplam Eşleşme
                                            Sayısı:</div>
                            ...
                            <div class="p-4">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                                        <h5 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Talepler</h5>
                                        <div class="admin-h1">0</div>
                                        <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">Toplam Talep</div>
                                    </div>

                                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                                        <h5 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">İlanlar</h5>
                                        <div class="admin-h1">0</div>
                                        <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">Toplam İlan</div>
                                    </div>

                                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                                        <h5 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Eşleşme Oranı
                                        </h5>
                                        <div class="admin-h1">0%</div>
                                    ...
                                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                                        <h5 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Başarılı
                                            Eşleşmeler</h5>
                                        <div class="admin-h1">0</div>
                                ...
                                <div class="mt-6">
                                    <h5 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Eşleşme
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="number" name="match_threshold" id="match_threshold" min="0"
                                            max="100" value="70" class="neo-input">
                                    ...
                                    <div>
                                        <label for="auto_match"
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Otomatik
                                            Eşleştirme</label>
                                        <div class="mt-2">
                                            <label class="inline-flex items-center">
                                                <input type="checkbox" name="auto_match" id="auto_match"
                                                    class="rounded border-gray-300 text-primary-600 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 dark:border-gray-600 dark:bg-gray-700 dark:focus:ring-primary-600 dark:focus:ring-opacity-25">
                                                <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">Yeni talep ve
                                    ...
                                    <div>
                                        <label for="notification_enabled"
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Bildirimler</label>
                                        <div class="mt-2">
                                            <label class="inline-flex items-center">
                                                <input type="checkbox" name="notification_enabled"
                                                    ...
                                                    class="rounded border-gray-300 text-primary-600 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 dark:border-gray-600 dark:bg-gray-700 dark:focus:ring-primary-600 dark:focus:ring-opacity-25"
                                                    checked>
                                                <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">Eşleşme
                                    ...
                                    <div>
                                        <label for="match_frequency"
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Eşleştirme
                                            Sıklığı</label>
                                        <select name="match_frequency" id="match_frequency" class="neo-input">
