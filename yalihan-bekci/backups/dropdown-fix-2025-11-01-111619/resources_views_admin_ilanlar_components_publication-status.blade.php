...
<div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
    ...
    <div x-data="publicationManager()" class="space-y-6">
        ...
        <div class="bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-lg p-4 mb-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <p class="text-sm font-medium text-gray-700 dark:text-gray-300">Mevcut Durum</p>
        ...
        <div class="neo-form-group">
            <label for="oncelik" class="neo-label">
                <span class="neo-label-text">Öncelik Seviyesi</span>
                <span class="text-xs text-gray-500 ml-2">(İlan sıralamasında öncelik)</span>
            </label>
            <select name="oncelik" id="oncelik" class="neo-select">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div class="neo-form-group">
                <label for="yayin_baslangic" class="neo-label">
                    <span class="neo-label-text">Yayın Başlangıç Tarihi</span>
            ...
            <div class="neo-form-group">
                <label for="yayin_bitis" class="neo-label">
                    <span class="neo-label-text">Yayın Bitiş Tarihi</span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white dark:bg-gray-700 rounded-lg p-4">
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            <label for="auto_enabled" class="text-sm font-medium text-gray-900 dark:text-gray-100 cursor-pointer">
                                Otomatik Aktif Etme
                            </label>
                ...
                <div class="bg-white dark:bg-gray-700 rounded-lg p-4">
                    <div class="flex items-start space-x-3">
                        <input type="checkbox" name="auto_disabled" id="auto_disabled"
                            ...
                            class="mt-1 rounded focus:ring-cyan-500 text-cyan-600">
                        <div>
                            <label for="auto_disabled" class="text-sm font-medium text-gray-900 dark:text-gray-100 cursor-pointer">
                                Otomatik Pasif Etme
                            </label>
                            <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">
