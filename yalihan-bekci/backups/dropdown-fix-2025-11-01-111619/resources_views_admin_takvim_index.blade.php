...
@section('content')
    ...
    @section('styles')
        ...
        <style>
            ...
            .takvim-gun.giris {
                background: linear-gradient(135deg, #dcfce7 50%, #fecaca 50%);
                border-color: #ef4444;
            }

            .takvim-gun.cikis {
                background: linear-gradient(135deg, #fecaca 50%, #dcfce7 50%);
                border-color: #22c55e;
            }
                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <select id="topluDurum" class="admin-input w-full">
        ...
        <script>
            ...
            function renderCalendar() {
                ...
                for (let i = 1; i < firstDayOfWeek; i++) {
                    ...
                    emptyDay.className = 'takvim-gun bg-gray-100 dark:bg-gray-700';
