            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
                ...
                <div class="flex items-center space-x-3">
                    <form method="GET" action="{{ route('admin.blog.analytics') }}" class="flex items-center space-x-3">
                        <select name="days" onchange="this.form.submit()" class="admin-input">
                    ...
                    <a href="{{ route('admin.blog.clear-cache') }}" class="neo-btn neo-btn neo-btn-secondary touch-target-optimized touch-target-optimized">
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-gray-700">Onaylı Yorum</span>
                            <span
                        ...
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-gray-700">Yorum Oranı</span>
