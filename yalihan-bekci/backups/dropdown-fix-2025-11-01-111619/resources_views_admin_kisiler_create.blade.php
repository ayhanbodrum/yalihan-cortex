        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <div class="flex items-center justify-between mb-6 border-b pb-4">
                ...
                <a href="{{ route('admin.kisiler.index') }}"
                    class="inline-flex items-center px-4 py-2 text-sm font-medium bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 focus:ring-2 focus:ring-blue-500 transition-all duration-200 flex items-center space-x-2">
                    <span>← Geri Dön</span>
                </a>
            </div>
            ...
            <form action="{{ route('admin.kisiler.store') }}" method="POST" @submit="loading = true">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="ad" x-model="formData.ad" required
                                class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200 @error('ad') border-red-500 @enderror" placeholder="Adını girin...">
                            @error('ad')
                        ...
                        <div>
                            ...
                            <input type="text" name="soyad" x-model="formData.soyad" required
                                class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200 @error('soyad') border-red-500 @enderror" placeholder="Soyadını girin...">
                            @error('soyad')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="tel" name="telefon" x-model="formData.telefon" @blur="validateTelefon()"
                                class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200 @error('telefon') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <input type="email" name="email" x-model="formData.email" @blur="validateEmail()"
                                class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200 @error('email') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <input type="text" name="tc_kimlik" x-model="formData.tc_kimlik" maxlength="11"
                                ...
                                class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200 @error('tc_kimlik') border-red-500 @enderror"
                        ...
                        {{-- Kişi Tipi --}}
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Kişi Tipi</label>
                            <select name="kisi_tipi" x-model="formData.kisi_tipi"
                                class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200 @error('kisi_tipi') border-red-500 @enderror">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="status" x-model="formData.status" required
                                class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200 @error('status') border-red-500 @enderror">
                                <option value="">Seçin...</option>
                        ...
                        <div>
                            ...
                            <select name="danisman_id" x-model="formData.danisman_id"
                                class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200 @error('danisman_id') border-red-500 @enderror">
                                <option value="">Seçin...</option>
                ...
                <div class="bg-white rounded-xl border p-6 mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <select name="il_id" x-model="formData.il_id" @change="loadIlceler()"
                                class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200 @error('il_id') border-red-500 @enderror">
                                <option value="">Seçin...</option>
                                @foreach ($iller as $il)
                        ...
                        <div>
                            ...
                            <select name="ilce_id" x-model="formData.ilce_id" @change="loadMahalleler()"
                                class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200 @error('ilce_id') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <select name="mahalle_id" x-model="formData.mahalle_id"
                                class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200 @error('mahalle_id') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <textarea name="adres" x-model="formData.adres" rows="2"
                            class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200 @error('adres') border-red-500 @enderror"
                ...
                <div class="bg-white rounded-xl border p-6 mb-6">
                    ...
                    <div>
                        ...
                        <textarea name="notlar" x-model="formData.notlar" rows="4"
                            class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200 @error('notlar') border-red-500 @enderror"
                ...
                <div class="flex justify-between items-center pt-6 border-t">
                    <button type="button" @click="resetForm()"
                        class="neo-btn neo-btn-ghost text-gray-600 hover:text-gray-800">
                        🔄 Formu Temizle
                    </button>
                    ...
                    <div class="flex space-x-3">
                        ...
                        <button type="submit" class="neo-btn bg-gradient-to-r from-blue-600 to-purple-600 text-white hover:from-blue-700 hover:to-purple-700 shadow-lg hover:shadow-xl" :disabled="loading">
