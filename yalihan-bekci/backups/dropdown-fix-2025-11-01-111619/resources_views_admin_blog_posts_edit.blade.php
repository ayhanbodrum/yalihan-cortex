...
@push('styles')
    ...
    <style>
        ...
        .admin-input,
        .admin-input {
            @apply w-full px-4 py-3 border border-gray-300 rounded-lg focus:border-blue-500 focus:ring-blue-500 focus:outline-none transition-all duration-200;
        }
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div class="form-field">
                                ...
                                <input type="text" name="title" value="{{ old('title', $post->title) }}"
                                    class="neo-input @error('title') admin-input-error @enderror" required>
                                @error('title')
                            ...
                            <div class="form-field">
                                ...
                                <input type="text" name="slug" value="{{ old('slug', $post->slug) }}"
                                    class="neo-input @error('slug') admin-input-error @enderror"
                            ...
                            <div class="form-field">
                                ...
                                <textarea name="excerpt" rows="3" class="neo-input @error('excerpt') admin-input-error @enderror"
                            ...
                            <div class="form-field">
                                ...
                                <textarea name="content" id="content" class="neo-input @error('content') admin-input-error @enderror" rows="15"
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div class="form-field">
                                ...
                                <input type="file" name="featured_image" accept="image/*"
                                    class="neo-input @error('featured_image') neo-input-error @enderror">
                            ...
                            <div class="form-field">
                                ...
                                <input type="text" name="featured_image_alt"
                                    value="{{ old('featured_image_alt', $post->featured_image_alt) }}" class="neo-input"
                        ...
                        <div class="p-6 space-y-4">
                            <div class="form-field">
                                ...
                                <input type="text" name="meta_title"
                                    value="{{ old('meta_title', $post->meta_title) }}" class="neo-input" maxlength="60"
                            ...
                            <div class="form-field">
                                ...
                                <textarea name="meta_description" rows="3" maxlength="160" class="neo-input"
                            ...
                            <div class="form-field">
                                ...
                                <input type="text" name="meta_keywords"
                                    value="{{ old('meta_keywords', $post->meta_keywords) }}" class="neo-input"
                    ...
                    <div class="neo-card overflow-hidden">
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div class="form-field">
                                ...
                                <select name="status" x-model="status" class="neo-input">
                            ...
                            @if (auth()->user()->hasRole('admin'))
                                <div class="form-field">
                                    ...
                                    <select name="user_id" class="neo-input">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div class="form-field">
                                ...
                                <select name="blog_category_id" class="neo-input">
                            ...
                            <div class="form-field">
                                ...
                                <select name="tags[]" id="tags" multiple class="neo-input" style="width: 100%;">
                                    @foreach ($tags as $tag)
                                        <option value="{{ $tag->id }}"
