...
@section('content_header')
    <div class="flex justify-between items-center">
        ...
        <a href="{{ route('admin.ozellikler.kategoriler.index') }}"
            class="px-4 py-2 neo-btn-outline  rounded-md shadow-sm transition-colors duration-200 touch-target-optimized touch-target-optimized">
        ...
        <div class="p-6">
            <form action="{{ route('admin.ozellikler.kategoriler.update', $kategori->id) }}" method="POST"
                ...
                <div class="flex justify-end space-x-3 mt-6">
                    <a href="{{ route('admin.ozellikler.kategoriler.index') }}"
                        class="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-md shadow-sm text-sm">İptal</a>
                    <button type="submit"
                        class="px-5 py-2 neo-btn neo-btn-primary rounded-md text-sm font-medium touch-target-optimized touch-target-optimized">Güncelle</button>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="p-6">
            ...
            <div class="mt-4">
                <a href="{{ route('admin.ozellikler.kategoriler.ozellikler', $kategori->id) }}"
                    class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 dark:text-indigo-100 dark:bg-indigo-900 dark:hover:bg-indigo-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
