                ...
                <template x-for="(person, index) in bulkPersons" :key="index">
                    <div class="border border-gray-200 rounded-lg p-4">
                        <div class="flex justify-between items-center mb-4">
                            <h4 class="font-medium text-gray-800">Kişi <span x-text="index + 1"></span></h4>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input x-model="person.ad" type="text" class="neo-input w-full" required>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Soyad *</label>
                                <input x-model="person.soyad" type="text" class="neo-input w-full" required>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                                <input x-model="person.email" type="email" class="neo-input w-full">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Telefon</label>
                                <input x-model="person.telefon" type="tel" class="neo-input w-full">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Tip *</label>
                                <select x-model="person.tip" class="neo-select w-full" required>
                            ...
                            <div>
                                ...
                                <select x-model="person.status" class="neo-select w-full">
