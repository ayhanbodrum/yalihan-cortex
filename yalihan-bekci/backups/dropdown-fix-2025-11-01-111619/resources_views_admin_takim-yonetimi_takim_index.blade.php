...
@section('content')
    ...
    <div class="bg-gradient-to-r from-gray-50 to-slate-50 rounded-xl border border-gray-200 shadow-sm p-6 mb-8">
        ...
        <form method="GET" action="{{ route('admin.takim-yonetimi.takim.index') }}"
            ...
            <div class="form-field">
                <select class="admin-input" name="rol">
            ...
            <div class="form-field">
                <select class="admin-input" name="lokasyon">
        ...
        <div class="p-6 border-b border-gray-200">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center space-x-3">
                    <button type="button" class="neo-btn neo-btn-secondary touch-target-optimized touch-target-optimized" onclick="selectAll()">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <button type="button" class="neo-btn neo-btn-secondary touch-target-optimized touch-target-optimized" onclick="clearSelection()">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="p-6">
            ...
            @if ($takimUyeleri->count() == 0)
                <div class="text-center py-12">
                    ...
                    <div class="mt-6">
                        <button type="button" class="neo-btn neo-btn-primary touch-target-optimized touch-target-optimized" onclick="uyeEkleModal()">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <form id="uyeEkleForm" method="POST" action="{{ route('admin.takim-yonetimi.takim.uye-ekle') }}">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="form-field">
                            ...
                            <select name="rol" class="admin-input" required>
                    ...
                    <div class="flex justify-end space-x-3 mt-6">
                        <button type="button" class="neo-btn neo-btn-secondary touch-target-optimized touch-target-optimized" onclick="closeUyeEkleModal()">İptal</button>
                        <button type="submit" class="neo-btn neo-btn-primary touch-target-optimized touch-target-optimized">Üye Ekle</button>
                    </div>
                </form>
            </div>
        </div>
