    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm mb-8 p-8">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-3 items-center">
                <a href="{{ route('admin.kisiler.index', array_merge(request()->except('page'), ['status' => 'Aktif'])) }}"
                ...
                <a href="{{ route('admin.kisiler.index', array_merge(request()->except('page'), ['status' => 'Pasif'])) }}"
    ...
    <div class="container-fluid">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-2xl font-bold text-green-800">{{ $stats['active'] ?? 0 }}</h3>
            ...
            <div class="bg-gradient-to-r from-yellow-50 to-amber-50 rounded-xl border border-yellow-200 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-2xl font-bold text-yellow-800">{{ $stats['potential'] ?? 0 }}</h3>
                        <p class="text-sm text-yellow-600 font-medium">Potansiyel Müşteri</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-r from-purple-50 to-violet-50 rounded-xl border border-purple-200 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-2xl font-bold text-purple-800">{{ $stats['this_month'] ?? 0 }}</h3>
                        <p class="text-sm text-purple-600 font-medium">Bu Ay Eklenen</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm mb-8 p-6">
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="neo-form-group relative md:col-span-2">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 text-lg font-semibold mb-3">
                        ...
                        <div class="context7-live-search" data-search-type="kisiler"
                            ...
                            <input type="text" id="kisi_search" class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200 text-lg py-4"
                    ...
                    <div class="neo-form-group">
                        ...
                        <select name="status" id="status" class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent cursor-pointer transition-colors duration-200">
                    ...
                    <div class="neo-form-group">
                        <label for="musteri_tipi" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Müşteri Tipi</label>
                        <select name="musteri_tipi" id="musteri_tipi" class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent cursor-pointer transition-colors duration-200">
                            <option value="">Tüm Tipler</option>
                            <option value="Müşteri" {{ request('musteri_tipi') == 'Müşteri' ? 'selected' : '' }}>
                                Müşteri</option>
                            <option value="Potansiyel" {{ request('musteri_tipi') == 'Potansiyel' ? 'selected' : '' }}>
                                Potansiyel</option>
                            <option value="Danışman" {{ request('musteri_tipi') == 'Danışman' ? 'selected' : '' }}>
                                Danışman</option>
                            <option value="Ev Sahibi" {{ request('musteri_tipi') == 'Ev Sahibi' ? 'selected' : '' }}>
                                Ev Sahibi</option>
                            <option value="Alıcı" {{ request('musteri_tipi') == 'Alıcı' ? 'selected' : '' }}>
                                Alıcı</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    <div class="neo-form-group">
                        <label for="danisman_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Danışman</label>
                        <select name="danisman_id" id="danisman_id" class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent cursor-pointer transition-colors duration-200">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm mb-6 p-6 bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <div
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-blue-800">🤖 AI Önerileri</h3>
                            <p class="text-sm text-blue-600">Context7 Intelligence ile akıllı müşteri analizi</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-2">
                        <span class="px-3 py-1 bg-green-100 text-green-800 text-xs font-medium rounded-full">✓ Context7
                            Uyumlu</span>
            ...
            <!-- Müşteri Listesi -->
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm" x-data="{ selectedItems: [], showFilters: false, filterStatus: '', filterTag: '', filterStart: '', filterEnd: '' }">
                <div class="p-6">
                    ...
                    <x-admin.modal bind="showFilters" title="Hızlı Filtre" size="md">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200" x-model="filterStatus">
                            ...
                            <div>
                                <label class="admin-label">Etiket</label>
                                <input type="text" class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200" x-model="filterTag" placeholder="Etiket adı">
                            </div>
                            <div>
                                <label class="admin-label">Başlangıç Tarihi</label>
                                <input type="date" class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200" x-model="filterStart">
                            </div>
                            <div>
                                <label class="admin-label">Bitiş Tarihi</label>
                                <input type="date" class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200" x-model="filterEnd">
                            </div>
                        </div>
                        <x-slot:footer>
                            ...
                            <tbody class="c7-tbody divide-y divide-gray-200 dark:divide-gray-700">
                                @forelse ($kisiler as $kisi)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900 dark:text-gray-100">{{ $kisi->telefon }}
                                            </div>
                                            @if ($kisi->email)
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center gap-2">
                                                <x-neo.status-badge :value="$kisi->status ?? 'Belirtilmemiş'" />
                                ...
                                @empty
                                    <tr>
                                        <td colspan="8"
                                            ...
                                            <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-gray-100">Müşteri
                                                bulunamadı</h3>
        ...
        @push('styles')
            <style>
                ...
                .admin-input {
                    @apply w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:border-blue-500 focus:outline-none transition-all duration-200 placeholder-gray-400;
                }

                /* Context7 Button Standartları - Unified */
                .neo-btn {
                    @apply inline-flex items-center px-6 py-3 font-semibold rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 transition-all duration-200 transform hover:scale-105 active:scale-95;
                }
                        ...
                        <div id="advancedSearchSection" class="mt-6 p-4 bg-gray-50 rounded-lg border">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="tc_kimlik" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="TC Kimlik No">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">İl</label>
                                    <input type="text" name="il" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="İl">
                                </div>
                            </div>
                        </div>
                    `;
