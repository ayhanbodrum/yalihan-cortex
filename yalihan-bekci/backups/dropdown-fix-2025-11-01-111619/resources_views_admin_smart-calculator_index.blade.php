...
@section('content')
    ...
    <div class="container-fluid" x-data="smartCalculator()">
        ...
        <div class="container mx-auto">
            <div
                class="sv-card-padding sv-shadow-md rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 mb-8">
                <div class="flex items-center mb-6">
                    ...
                    <h2 class="text-xl font-semibold text-gray-800">Hesaplama Türü Seçin</h2>
                </div>
                ...
                <div x-show="selectedType === 'vat_calculation'" class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select x-model="inputs.kdv_orani" class="admin-input">
                ...
                <div x-show="selectedType === 'sales_commission'" class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select x-model="inputs.komisyon_orani" class="admin-input">
