            ...
            <div class="neo-card p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="kisi_id" required class="neo-select">
                    ...
                    <div>
                        ...
                        <select name="kategori" required class="neo-select">
                ...
                <div class="mt-6">
                    ...
                    <input type="text" name="baslik" required maxlength="200" class="neo-input"
                        placeholder="Not başlığını girin...">
                </div>

                <div class="mt-6">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Not İçeriği *</label>
                    <textarea name="icerik" required maxlength="5000" rows="8" class="neo-input"
            ...
            <div class="neo-card p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="onem_derecesi" required class="neo-select">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    <div>
                        ...
                        <input type="datetime-local" name="reminder_date" class="neo-input">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">İlan Bağlantısı</label>
                        <select name="related_ilan_id" class="neo-select">
            ...
            <div class="neo-card p-6 mb-6">
                ...
                <div class="space-y-4">
                    <label class="flex items-center">
                        <input type="checkbox" name="is_private" class="neo-checkbox mr-3">
                        <span class="text-sm font-medium text-gray-700">Özel not (sadece ben görebilirim)</span>
                    </label>

                    <label class="flex items-center">
                        <input type="checkbox" name="is_completed" class="neo-checkbox mr-3">
