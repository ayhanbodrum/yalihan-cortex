    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-4xl font-bold text-gray-900 dark:text-gray-100 flex items-center">
                        <div
        ...
        <form action="{{ route('admin.takim-yonetimi.gorevler.update', $gorev) }}" method="POST" id="gorevEditForm"
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <select class="admin-input @error('oncelik') border-red-300 @enderror" id="oncelik"
                        ...
                        <div>
                            ...
                            <select class="admin-input @error('tip') border-red-300 @enderror" id="tip"
                                name="tip" required>
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <select class="admin-input @error('danisman_id') border-red-300 @enderror" id="danisman_id"
                                name="danisman_id">
                        ...
                        <div>
                            ...
                            <select class="admin-input @error('musteri_id') border-red-300 @enderror" id="musteri_id"
                                name="musteri_id">
                        ...
                        <div>
                            ...
                            <select class="admin-input @error('proje_id') border-red-300 @enderror" id="proje_id"
                                name="proje_id">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="bg-white rounded-lg p-4 border border-green-200">
                                ...
                                <div class="mt-2">
                                    <button type="button" class="neo-btn neo-btn-outline-success btn-sm touch-target-optimized touch-target-optimized"
            ...
            <div class="flex justify-end gap-4 pt-6 border-t border-gray-200">
                <a href="{{ route('admin.takim-yonetimi.gorevler.show', $gorev) }}" class="neo-btn neo-btn neo-btn-secondary touch-target-optimized touch-target-optimized">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                    </svg>
                    İptal
                </a>
                <button type="button" class="neo-btn neo-btn-warning touch-target-optimized touch-target-optimized" onclick="formuSifirla()">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
