                    ...
                    <div class="card-body">
                        <form id="takimUyesiForm" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="user_name" class="neo-input neo-input"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="rol" id="rol" class="admin-input" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="lokasyon" id="lokasyon" class="neo-input neo-input"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="uzmanlik_alani" id="uzmanlik_alani" class="neo-input neo-input" rows="3"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="calisma_saati" id="calisma_saati" class="neo-input neo-input" rows="3"
