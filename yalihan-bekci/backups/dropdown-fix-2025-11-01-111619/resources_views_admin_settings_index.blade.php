            ...
            <form method="POST" action="{{ route('admin.settings.update') }}">
                ...
                <div id="genel" class="tab-content">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="default_currency" class="admin-input w-full">
                ...
                <div id="ai" class="tab-content hidden">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="ai_provider" class="admin-input w-full">
                ...
                <div id="fiyat" class="tab-content hidden">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="price_rounding" class="admin-input w-full">
