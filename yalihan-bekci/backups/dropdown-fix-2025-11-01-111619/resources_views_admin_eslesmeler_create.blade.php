                        ...
                        <div class="neo-card-body space-y-4">
                            ...
                            <div class="neo-form-group">
                                ...
                                <div class="context7-live-search"
                                     ...
                                     data-min-chars="2">
                                    <input type="text" class="neo-input" placeholder="Müşteri ara...">
                            ...
                            <div class="neo-form-group">
                                ...
                                <select name="danisman_id" id="danisman_id" class="neo-select" x-model="form.danisman_id">
                        ...
                        <div class="neo-card-body">
                            ...
                            <div class="neo-form-group">
                                ...
                                <div class="context7-live-search"
                                     ...
                                     data-min-chars="2">
                                    <input type="text" class="neo-input" placeholder="Talep ara...">
                        ...
                        <div class="neo-card-body">
                            ...
                            <div class="neo-form-group">
                                ...
                                <div class="context7-live-search"
                                     ...
                                     data-min-chars="2">
                                    <input type="text" class="neo-input" placeholder="İlan ara...">
                    ...
                    <div class="neo-card">
                        ...
                        <div class="neo-card-body space-y-4">
                            <div class="neo-form-group">
                                ...
                                <select name="status" id="status" class="neo-select" required x-model="form.status">
                            ...
                            <div class="neo-form-group">
                                <label class="neo-checkbox-wrapper">
                                    <input type="checkbox" name="one_cikan" value="1" class="neo-checkbox" x-model="form.one_cikan">
                                    <span class="neo-checkbox-label">Öne Çıkan Eşleştirme</span>
                                </label>
                            </div>

                            <div class="neo-form-group">
                                <label for="eslesme_tarihi" class="neo-label">Eşleştirme Tarihi</label>
                                <input type="datetime-local" name="eslesme_tarihi" id="eslesme_tarihi" class="neo-input"
            ...
            <div class="neo-card">
                ...
                <div class="neo-card-body">
                    <div class="neo-form-group">
                        ...
                        <textarea name="notlar" id="notlar" rows="4" class="neo-textarea" x-model="form.notlar"
