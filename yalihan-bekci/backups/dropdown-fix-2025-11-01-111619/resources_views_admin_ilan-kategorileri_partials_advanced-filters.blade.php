...
<div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 mb-6" id="advanced-filters">
    ...
    <div class="px-6 py-4 space-y-4" id="filter-content">
        <form id="category-filters" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <input type="text"
                               id="search"
                               name="search"
                               class="w-full px-4 py-2 pr-10 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                ...
                {{-- Seviye Filtresi --}}
                <div class="space-y-2">
                    <label for="level_filter" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                        📊 Seviye
                    </label>
                    <select id="level_filter" name="level" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                ...
                {{-- Aktiflik Durumu --}}
                <div class="space-y-2">
                    <label for="status_filter" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                        ⚡ Durum
                    </label>
                    <select id="status_filter" name="status" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                ...
                {{-- İlan Sayısı Aralığı --}}
                <div class="space-y-2">
                    <label for="listing_count_filter" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                        📈 İlan Sayısı
                    </label>
                    <select id="listing_count_filter" name="listing_count" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                ...
                <div class="flex items-center space-x-4">
                    <div class="space-y-2">
                        ...
                        <select id="sort_by" name="sort_by" class="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            <option value="order">🎯 Manuel Sıra</option>
