        ...
        <form action="{{ route('admin.danisman.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" value="{{ old('email') }}" required
                            class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 @error('email') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <input type="text" name="telefon" id="telefon" value="{{ old('telefon') }}" required
                            class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 @error('telefon') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <input type="password" name="password" id="password" required
                            class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 @error('password') border-red-500 @enderror"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {{-- Lisans No --}}
                    <div>
                        <label for="lisans_no" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                            Lisans Numarası
                        </label>
                    ...
                    {{-- Komisyon Oranı --}}
                    <div>
                        <label for="komisyon_orani" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                            Komisyon Oranı (%)
                        </label>
                    ...
                    {{-- Uzmanlık Alanı --}}
                    <div class="md:col-span-2">
                        <label for="uzmanlik_alani" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                            Uzmanlık Alanı
                        </label>
                    ...
                    {{-- Adres --}}
                    <div class="md:col-span-2">
                        <label for="adres" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                            Adres
                        </label>
            ...
            {{-- Form Aksiyonları --}}
            <div class="flex items-center justify-end space-x-4 bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 p-6">
                <a href="{{ route('admin.danisman.index') }}" class="neo-btn neo-btn neo-btn-secondary touch-target-optimized touch-target-optimized">
                    İptal
                </a>
