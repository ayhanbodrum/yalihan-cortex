        ...
        <div class="mb-8">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                <div class="flex-1">
                    ...
                    <nav class="flex items-center text-sm text-gray-500 dark:text-gray-400 mt-2">
                        ...
                        <a href="{{ route('admin.talep-portfolyo.index') }}"
                            ...
                            Eşleştirme</a>
                        <span class="px-2">/</span>
                        <span class="text-gray-700 dark:text-gray-300">Talep Detayı</span>
                    </nav>
                </div>
                <div class="flex flex-wrap gap-3">
                    ...
                    <!-- Geri Butonu -->
                    <a href="{{ route('admin.talep-portfolyo.index') }}"
                        class="group inline-flex items-center gap-2 px-4 py-3 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 font-medium rounded-xl border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-gray-300 dark:hover:border-gray-600 transform hover:-translate-y-0.5 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600 shadow-sm hover:shadow-md">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-6">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-4">
                                <p class="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">{{ $talep->aciklama }}
                                </p>
                            </div>
                        </div>
            ...
            <div class="p-6">
                <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100">Eşleşen Portföyler</h3>
                ...
                <div>
                                ...
                                <div class="neo-card hover:shadow-xl transition-all duration-300">
                                    <div class="p-6">
                                        <div class="flex justify-between items-center mb-4">
                                            <h6 class="text-lg font-bold text-gray-900 dark:text-gray-100">Portföy #{{ $eslesme['ilan']->id }}</h6>
                                        ...
                                        <div>
                                            ...
                                            <h6 class="text-md font-semibold text-gray-900 dark:text-gray-100 mb-4">
                                            ...
                                            <div class="bg-gray-50 dark:bg-gray-900/50 rounded-xl p-4 mt-4">
                                                <div class="grid grid-cols-3 gap-4 text-center">
                                                    <div>
                                                        ...
                                                        <div class="text-sm font-bold text-gray-900 dark:text-gray-100">{{ $eslesme['uygunluk_derecesi'] }}</div>
                                                    </div>
                                                    <div>
                                                        <div class="text-xs text-gray-500 dark:text-gray-400 mb-1">Öncelik</div>
                                                        <div class="text-sm font-bold text-gray-900 dark:text-gray-100">{{ $eslesme['oncelik_sirasi'] }}</div>
                                                    </div>
                                                    <div>
                                                        <div class="text-xs text-gray-500 dark:text-gray-400 mb-1">Öneri</div>
                                                        <div class="text-sm font-bold text-gray-900 dark:text-gray-100">{{ $eslesme['oneri_derecesi'] }}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <h5 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Eşleşen portföy bulunamadı</h5>
                ...
                <div class="modal-body">
                    <form id="portfolyoOnerForm">
                        <div class="mb-3">
                            ...
                            <select class="admin-input" id="ilan_id" name="ilan_id" required>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="admin-input" id="oneri_derecesi" name="oneri_derecesi" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="neo-input neo-input" id="notlar" name="notlar" rows="3"
