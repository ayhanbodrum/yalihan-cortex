        ...
        <div class="neo-card p-6 mb-8">
            ...
            <form method="GET" action="{{ route('admin.takim-yonetimi.gorevler.index') }}"
                ...
                <div class="form-field">
                    <input type="text" class="neo-input" name="search" placeholder="Görev ara..."
                        value="{{ request('search') }}">
                </div>
                <div class="form-field">
                    <select class="neo-input" name="status">
                ...
                <div class="form-field">
                    <select class="neo-input" name="oncelik">
                ...
                <div class="form-field">
                    <select class="neo-input" name="tip">
                ...
                <div class="form-field">
                    <select class="neo-input" name="danisman_id">
                ...
                <div class="form-field">
                    <button type="submit" class="neo-btn neo-btn neo-btn-primary w-full touch-target-optimized touch-target-optimized">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="neo-card">
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-800">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center space-x-3">
                        <button type="button" class="neo-btn neo-btn neo-btn-secondary touch-target-optimized touch-target-optimized" onclick="topluGorevAta()">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="overflow-x-auto" x-data="{ contentLoaded: true }" x-init="setTimeout(() => contentLoaded = true, 100)">
                ...
                <!-- Actual Content -->
                <div x-show="contentLoaded" x-transition class="neo-content-loaded">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50 dark:bg-gray-900/50">
                            <tr>
                                <th class="neo-table-th">
                                    <input type="checkbox" class="neo-checkbox" id="select-all">
                                </th>
                                <th class="neo-table-th">
                                    Görev
                                </th>
                            ...
                            @forelse ($gorevler as $gorev)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors duration-150">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <input type="checkbox" class="neo-checkbox gorev-checkbox"
                                            value="{{ $gorev->id }}">
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
