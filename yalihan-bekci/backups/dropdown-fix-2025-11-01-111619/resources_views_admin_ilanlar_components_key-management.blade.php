    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div class="neo-form-group">
                <label for="anahtar_durumu" class="neo-label">
                    <span class="neo-label-text">Anahtar Durumu *</span>
                </label>
                <select name="anahtar_durumu" id="anahtar_durumu" required class="neo-select">
                ...
                @error('anahtar_durumu')
                    <div class="neo-validation-error">{{ $message }}</div>
                @enderror
            </div>
