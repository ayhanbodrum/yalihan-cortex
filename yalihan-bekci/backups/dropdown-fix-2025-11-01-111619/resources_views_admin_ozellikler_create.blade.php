                ...
                <form method="POST" action="{{ route('admin.ozellikler.store') }}" @submit="loading = true">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="neo-form-group">
                            ...
                            <select id="type" name="type" class="neo-select" required>
                        ...
                        <div class="neo-form-group">
                            ...
                            <select id="feature_category_id" name="feature_category_id" class="neo-select">
                        ...
                        <div class="neo-form-group">
                            ...
                            <input type="number" id="order" name="order" class="neo-input"
                    ...
                    <div class="neo-form-group">
                        ...
                        <div class="flex items-center space-x-4">
                            <label class="flex items-center">
                                <input type="radio" name="status" value="1" class="neo-radio"
                                    {{ old('status', 1) == 1 ? 'checked' : '' }}>
                                <span class="ml-2">Aktif</span>
                            </label>
                            <label class="flex items-center">
                                <input type="radio" name="status" value="0" class="neo-radio"
