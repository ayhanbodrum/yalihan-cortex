    ...
    <div class="content-header mb-8">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-3">
                <a href="{{ route('admin.etiket.create') }}" class="neo-btn neo-btn neo-btn-primary">
                    <i class="fas fa-plus mr-2"></i>
                    New Etiket
                </a>
                <a href="{{ route('admin.etiket.export') }}" class="neo-btn neo-btn neo-btn-secondary">
        ...
        <div class="neo-card p-6">
            ...
            <form action="{{ route('admin.etiket.index') }}" method="GET" class="mb-6">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <select name="status" class="neo- neo-select  neo-select form-select" onchange="this.form.submit()">
                        <option value="">All Status</option>
                        <option value="active" {{ request('status') == 'active' ? 'selected' : '' }}>Active</option>
                        <option value="inactive" {{ request('status') == 'inactive' ? 'selected' : '' }}>Inactive</option>
                    </select>
                    <button type="submit" class="neo-btn neo-btn neo-btn-primary col-span-1 md:col-span-1">
            ...
            <form id="bulkForm" action="{{ route('admin.etiket.bulk-action') }}" method="POST" class="mb-6">
                ...
                <div class="flex items-center gap-4">
                    <select name="action" class="neo- neo-select  neo-select form-select">
                        <option value="">Bulk Actions</option>
                        <option value="activate">Activate</option>
                        <option value="deactivate">Deactivate</option>
                        <option value="delete">Delete</option>
                    </select>
                    <button type="submit" class="neo-btn neo-btn-warning" onclick="return confirmBulkAction()">
