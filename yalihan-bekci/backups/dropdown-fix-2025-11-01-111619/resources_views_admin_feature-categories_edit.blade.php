...
@section('title', 'Edit Feature Category - Yalıhan Emlak Pro')
    ...
    <div class="content-header mb-8">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-lg text-gray-600 mt-2">Update category information</p>
            </div>
            <a href="{{ route('admin.feature-categories.index') }}" class="neo-btn neo-btn neo-btn-secondary">
            ...
            <form action="{{ route('admin.feature-categories.update', $featureCategory) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <textarea id="description"
                              ...
                              placeholder="Enter category description">{{ old('description', $featureCategory->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="number"
                           id="display_order"
                           name="display_order"
                           value="{{ old('display_order', $featureCategory->display_order) }}"
                           min="0"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('display_order') border-red-500 @enderror"
                           placeholder="0">
                    @error('display_order')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-6">
                    ...
                    <select id="status"
                        ...
                        <option value="active" {{ old('status', $featureCategory->status) === 'active' ? 'selected' : '' }}>Active</option>
                        <option value="inactive" {{ old('status', $featureCategory->status) === 'inactive' ? 'selected' : '' }}>Inactive</option>
                    </select>
                    @error('status')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-6">
                    ...
                    <input type="text"
                           id="applies_to"
                           name="applies_to"
                           value="{{ old('applies_to', $featureCategory->applies_to) }}"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('applies_to') border-red-500 @enderror"
                ...
                <div class="border-t border-gray-200 pt-6 mb-6">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text"
                               id="meta_title"
                               name="meta_title"
                               value="{{ old('meta_title', $featureCategory->meta_title) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="meta_description"
                                  ...
                                  placeholder="SEO description for this category">{{ old('meta_description', $featureCategory->meta_description) }}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text"
                               id="seo_keywords"
                               name="seo_keywords"
                               value="{{ old('seo_keywords', $featureCategory->seo_keywords) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('seo_keywords') border-red-500 @enderror"
