        ...
        <div class="neo-card p-6 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div>
                    ...
                    <select x-model="filters.location" @change="applyFilters()" class="neo-select w-full">
                ...
                <div>
                    ...
                    <select x-model="filters.status" @change="applyFilters()" class="neo-select w-full">
                ...
                <div>
                    ...
                    <select x-model="filters.price_range" @change="applyFilters()" class="neo-select w-full">
                ...
                <div>
                    ...
                    <select x-model="filters.season" @change="applyFilters()" class="neo-select w-full">
