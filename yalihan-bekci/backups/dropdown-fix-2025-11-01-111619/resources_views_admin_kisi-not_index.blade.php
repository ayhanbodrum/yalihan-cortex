            ...
            <form method="GET" action="{{ route('admin.kisi-not.index') }}" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div>
                    ...
                    <input type="text" name="search" value="{{ request('search') }}"
                           class="neo-input" placeholder="Not başlığı veya içerik...">
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Kategori</label>
                    <select name="kategori" class="neo-select">
                ...
                <div>
                    ...
                    <select name="onem_derecesi" class="neo-select">
                    ...
                    <thead>
                        <tr>
                            <th class="neo-table-th">
                                <input type="checkbox" class="neo-checkbox" onchange="toggleAllCheckboxes(this)">
                            </th>
                        ...
                        @forelse($notlar ?? [] as $not)
                            <tr class="neo-table-tr hover:bg-gray-50">
                                <td class="neo-table-td">
                                    <input type="checkbox" class="neo-checkbox note-checkbox" value="{{ $not['id'] }}">
                                </td>
                                <td class="neo-table-td">
                                    <div class="flex items-center">
