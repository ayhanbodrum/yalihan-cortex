    ...
    <div x-show="hasRequiredFields || hasRecommendedFields"
        ...
        <div class="flex items-start gap-2">
            ...
            <div class="text-sm">
                ...
                <p class="text-gray-700 dark:text-gray-300 mt-1" x-text="fieldInfo"></p>
            </div>
        </div>
    </div>
            ...
            document.addEventListener('alpine:init', () => {
                ...
                `;
                    ...
                    generateInputHtml(name, config) {
                        const baseClass =
                            "w-full px-4 py-3 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent";
                        ...
                        <div class="flex items-center">
                            ...
                            <label for="${name}" class="ml-2 text-sm text-gray-700 dark:text-gray-300">Evet</label>
                        </div>
                    `;
                            ...
                            case 'select':
                                ...
                                return `<select name="${name}" id="${name}" class="${baseClass}">${selectOptions}</select>`;
