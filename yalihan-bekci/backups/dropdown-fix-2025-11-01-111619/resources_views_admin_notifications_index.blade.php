    ...
    <div class="content-header mb-8">
        ...
        <div class="flex items-center space-x-3 mt-4">
            ...
            @can('create', App\Models\Notification::class)
                <a href="{{ route('admin.notifications.create') }}" class="neo-btn neo-btn neo-btn-primary touch-target-optimized touch-target-optimized">
        ...
        <div class="neo-card p-6 mb-8">
            ...
            <form method="GET"
                ...
                <div>
                    ...
                    <select name="type" class="neo-input">
                ...
                <div>
                    ...
                    <select name="priority" class="neo-input">
                        <option value="">Tümü</option>
                ...
                <div class="flex items-end">
                    <button type="submit"
                            :disabled="loading"
                            class="neo-btn neo-btn neo-btn-primary w-full touch-target-optimized touch-target-optimized">
