        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse($sezonlar as $sezon)
                    <div
                        class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden sezon-card sezon-{{ $sezon->sezon_tipi }}">
                        <div class="p-6">
                            <div class="flex justify-between items-start mb-4">
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                                        {{ \Carbon\Carbon::parse($sezon->baslangic_tarihi)->format('d.m.Y') }} -
                                        {{ \Carbon\Carbon::parse($sezon->bitis_tarihi)->format('d.m.Y') }}
                                    </p>
                                </div>

                                <span class="sezon-badge {{ $sezon->sezon_tipi }}">
                                    {{ ucfirst($sezon->sezon_tipi) }} Sezon
                                </span>
                            </div>
                            ...
                            <div class="space-y-3 mb-4">
                                <div class="flex justify-between items-center">
                                    <span class="text-sm text-gray-600 dark:text-gray-400">Fiyat Çarpanı:</span>
                                    <span class="font-semibold text-gray-800 dark:text-gray-200">
                                        {{ number_format($sezon->fiyat_carpani, 2) }}x
                                    </span>
                                </div>
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="font-semibold text-gray-800 dark:text-gray-200">
                                        {{ $sezon->minimum_konaklama_gun }} gece
                                    </span>
                                </div>
                            ...
                            <div
                                ...
                                <span class="text-sm {{ $sezon->status ? 'text-green-600' : 'text-red-600' }}">
                                    <i class="fas {{ $sezon->status ? 'fa-check-circle' : 'fa-times-circle' }} mr-1"></i>
                                    {{ $sezon->status ? 'Aktif' : 'Pasif' }}
                                </span>
                                ...
                                <div class="flex space-x-2">
                                    ...
                                    <button onclick="sezonSil({{ $sezon->id }}, '{{ $sezon->sezon_adi }}')"
                ...
                <div class="p-6">
                    ...
                    <form id="sezonForm" class="space-y-4">
                        ...
                        <div>
                            ...
                            <select id="sezonTipi" name="sezon_tipi" class="admin-input w-full" required>
                ...
                <div class="p-6">
                    ...
                    <form id="sezonDuzenleForm" class="space-y-4">
                        ...
                        <div>
                            ...
                            <select id="duzenleSezonTipi" name="sezon_tipi" class="admin-input w-full" required>
                                <option value="yuksek">Yüksek Sezon</option>
                                <option value="orta">Orta Sezon</option>
                                <option value="dusuk">Düşük Sezon</option>
                            </select>
