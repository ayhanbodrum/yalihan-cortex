...
<div class="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-8 hover:shadow-2xl transition-shadow duration-300">
    ...
    <div x-data="advancedPriceManager()" class="space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {{-- Döviz Çevirici --}}
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Otomatik
                ...
                <div
                    ...
                    <div class="flex justify-between items-center text-sm" x-show="mainCurrency !== 'TRY'">
                        ...
                        <span class="font-bold text-gray-900 dark:text-gray-100" x-text="convertedPrices.TRY"></span>
                    </div>
                    <div class="flex justify-between items-center text-sm" x-show="mainCurrency !== 'USD'">
                        ...
                        <span class="font-bold text-gray-900 dark:text-gray-100" x-text="convertedPrices.USD"></span>
                    </div>
                    <div class="flex justify-between items-center text-sm" x-show="mainCurrency !== 'EUR'">
                        ...
                        <span class="font-bold text-gray-900 dark:text-gray-100" x-text="convertedPrices.EUR"></span>
                    </div>
                    <div class="flex justify-between items-center text-sm" x-show="mainCurrency !== 'GBP'">
                        ...
                        <span class="font-bold text-gray-900 dark:text-gray-100" x-text="convertedPrices.GBP"></span>
                    </div>
                    <div
        ...
        <div x-show="aiSuggestions.length > 0"
            ...
            <div class="space-y-2">
                <template x-for="(suggestion, index) in aiSuggestions" :key="index">
                    <div
                        class="flex justify-between items-center p-3 bg-white dark:bg-gray-700 rounded-lg hover:shadow-md transition-shadow">
                        <div>
                            <div class="text-sm font-medium text-gray-900 dark:text-gray-100" x-text="suggestion.label">
                            </div>
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <button type="button" @click="applySuggestion(suggestion)"
                                class="px-3 py-1 bg-gradient-to-r from-blue-500 to-blue-600 text-white text-xs rounded-md hover:from-blue-600 hover:to-blue-700 transition-all">
                                Uygula
                            </button>
                        </div>
                    </div>
        ...
        <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4"
            ...
            <div class="flex items-center justify-between">
                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">📐 M² Başı Fiyat:</span>
        ...
        <div class="mt-4">
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Ek
                Fiyatlandırma</label>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="flex items-center mb-2 cursor-pointer">
                        <input type="checkbox" x-model="showStartingPrice" class="mr-2 rounded focus:ring-blue-500">
                        <span class="text-sm text-gray-700 dark:text-gray-300">Başlangıç Fiyatı
                            (Pazarlık)</span>
                    </label>
                ...
                <div>
                    <label class="flex items-center mb-2 cursor-pointer">
                        ...
                        <span class="text-sm text-gray-700 dark:text-gray-300">Günlük Fiyat (Yazlık)</span>
                    </label>
                    <div x-show="showDailyPrice" x-collapse class="mt-2">
                        <input type="text" x-model="dailyPriceFormatted" @input="formatDailyPrice()"
                            name="gunluk_fiyat"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md"
