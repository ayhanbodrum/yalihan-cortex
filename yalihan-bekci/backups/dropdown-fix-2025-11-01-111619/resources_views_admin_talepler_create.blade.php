                    ...
                    <div class="bg-white dark:bg-gray-800 
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                <!-- Talep Tipi -->
                                <div>
                                    <label for="tip" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                        Talep Tipi <span class="text-red-500 font-bold ml-1">*</span>
                                    </label>
                                    <select id="tip" name="tip"
                                            class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 transition-all duration-200 cursor-pointer hover:border-blue-400"
                                        ...
                                        <option value="Satılık" class="bg-white dark:bg-gray-900 text-gray-900 dark:text-white py-2 font-medium">Satılık</option>
                                        <option value="Kiralık" class="bg-white dark:bg-gray-900 text-gray-900 dark:text-white py-2 font-medium">Kiralık</option>
                                        <option value="Günlük Kiralık" class="bg-white dark:bg-gray-900 text-gray-900 dark:text-white py-2 font-medium">Günlük Kiralık</option>
                                        <option value="Devren" class="bg-white dark:bg-gray-900 text-gray-900 dark:text-white py-2 font-medium">Devren</option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <select id="kategori_id" name="kategori_id"
                                        ...
                                        @foreach ($kategoriler ?? [] as $kategori)
                                            <option value="{{ $kategori->id }}" class="bg-white dark:bg-gray-900 text-gray-900 dark:text-white py-2 font-medium">{{ $kategori->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <!-- Alt Kategori -->
                                <div>
                                    <label for="alt_kategori_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                        Alt Kategori
                                    </label>
                                    <select id="alt_kategori_id" name="alt_kategori_id"
                                            class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 transition-all duration-200 cursor-pointer hover:border-blue-400 disabled:bg-gray-100 dark:disabled:bg-gray-700 disabled:cursor-not-allowed"
                                            style="color-scheme: light dark;"
                                        ...
                                        <template x-for="alt in altKategoriler" :key="alt.id">
                                            <option :value="alt.id" x-text="alt.name" class="bg-white dark:bg-gray-900 text-gray-900 dark:text-white py-2 font-medium"></option>
                                        </template>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <select id="il_id" name="il_id"
                                            ...
                                            @foreach ($iller ?? [] as $il)
                                                <option value="{{ $il->id }}" class="bg-white dark:bg-gray-900 text-gray-900 dark:text-white py-2 font-medium">{{ $il->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('il_id')
                                            <div class="mt-2 px-3 py-2 text-sm font-medium
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <select id="ilce_id" name="ilce_id"
                                            ...
                                            <template x-for="ilce in ilceler" :key="ilce.id">
                                                <option :value="ilce.id" x-text="ilce.name" class="bg-white dark:bg-gray-900 text-gray-900 dark:text-white py-2 font-medium"></option>
                                            </template>
                                        </select>
                                        @error('ilce_id')
                                            <div class="mt-2 px-3 py-2 text-sm font-medium
                                        ...
                                        @enderror
                                        <div x-show="!form.il_id" class="mt-2 px-3 py-2 text-xs font-medium
                                ...
                                <div class="space-y-2">
                                    ...
                                    <select id="mahalle_id" name="mahalle_id"
                                        ...
                                        <template x-for="mahalle in mahalleler" :key="mahalle.id">
                                            <option :value="mahalle.id" x-text="mahalle.name" class="bg-white dark:bg-gray-900 text-gray-900 dark:text-white py-2 font-medium"></option>
                                        </template>
                                    </select>
                                    @error('mahalle_id')
                                        <div class="mt-2 px-3 py-2 text-sm font-medium
                                    ...
                                    @enderror
                                    <div x-show="!form.ilce_id" class="mt-2 px-3 py-2 text-xs font-medium
                                                text-gray-600 dark:text-gray-400
                                                bg-gray-100 dark:bg-gray-800
                                                border border-gray-200 dark:border-gray-700
                                                rounded-lg flex items-center gap-2">
                                    ...
                                    <div class="mt-2 px-3 py-2 text-xs font-medium
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div x-show="showNewKisiForm" 
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                    <div>
                                        <label for="kisi_ad" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                            Ad
                                        </label>
                                    ...
                                    <div>
                                        <label for="kisi_soyad" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                            Soyad
                                        </label>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label for="kisi_telefon" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                            Telefon
                                        </label>
                                    ...
                                    <div>
                                        <label for="kisi_email" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                            E-posta
                                        </label>
                            ...
                            <!-- Sorumlu Danışman -->
                            <div class="mb-6">
                                <label for="danisman_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    Sorumlu Danışman
                                </label>
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <div class="text-right">
                                                ...
                                                <div class="flex items-center gap-1 mt-1">
                                                    ...
                                                    <span class="text-xs font-medium text-gray-700 dark:text-gray-300" x-text="`${Math.round(match.score * 100)}%`"></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
