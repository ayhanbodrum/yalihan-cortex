                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="password" name="google_api_key" id="google_api_key"
                                        ...
                                        class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 {{ $errors->has('google_api_key') ? 'border-red-500' : 'border-gray-300 dark:border-gray-600' }}"
                                        placeholder="AIzaSy...">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="password" name="openai_api_key" id="openai_api_key"
                                        ...
                                        class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 {{ $errors->has('openai_api_key') ? 'border-red-500' : 'border-gray-300 dark:border-gray-600' }}"
                                        placeholder="sk-...">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="password" name="claude_api_key" id="claude_api_key"
                                        ...
                                        class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 {{ $errors->has('claude_api_key') ? 'border-red-500' : 'border-gray-300 dark:border-gray-600' }}"
                                        placeholder="sk-ant-...">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="password" name="deepseek_api_key" id="deepseek_api_key"
                                        ...
                                        class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 {{ $errors->has('deepseek_api_key') ? 'border-red-500' : 'border-gray-300 dark:border-gray-600' }}"
                                        placeholder="sk-...">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="url" name="ollama_url" id="ollama_url"
                                        ...
                                        class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 {{ $errors->has('ollama_url') ? 'border-red-500' : 'border-gray-300 dark:border-gray-600' }}"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="ai_default_tone" id="ai_default_tone"
                            class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 {{ $errors->has('ai_default_tone') ? 'border-red-500' : 'border-gray-300 dark:border-gray-600' }}">
                    ...
                    <div>
                        ...
                        <input type="number" name="ai_default_variant_count" id="ai_default_variant_count"
                            ...
                            class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 {{ $errors->has('ai_default_variant_count') ? 'border-red-500' : 'border-gray-300 dark:border-gray-600' }}"
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <select id="test_provider_select"
                                class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <button type="button" onclick="clearTestArea()"
                                class="bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 font-semibold py-3 px-6 rounded-lg transition-all duration-200 flex items-center gap-2">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <span id="test_status"
                                    class="px-3 py-1 bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-400 text-xs rounded-full">
                                    Bekliyor...
                                </span>
                            </div>
    ...
    <script>
        ...
        window.sendTestMessage = async function() {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    responseDiv.innerHTML =
                        `<div class="bg-white dark:bg-gray-800 rounded-lg p-4 border-l-4 border-purple-500"><p class="text-gray-900 dark:text-gray-100 whitespace-pre-wrap">${data.response || data.message}</p></div>`;
        ...
        window.clearTestArea = function() {
            ...
            document.getElementById("test_status").className =
                "px-3 py-1 bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-400 text-xs rounded-full";
