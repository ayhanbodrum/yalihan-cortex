    ...
    <div class="neo-container">
        ...
        <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 mb-8">
            <div class="flex items-start gap-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">Talep-Portföy Eşleştirme</h1>
        ...
        <div
            class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-200 mb-8">
            <div class="p-6">
                <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100">AI Servis Durumu</h3>
        ...
        <div
            class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-200">
            <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100">Aktif Talepler</h3>
                    ...
                    <div class="flex items-center gap-3">
                        <div class="flex items-center gap-2 px-3 py-2 bg-gray-100 dark:bg-gray-700 rounded-lg">
                            <input type="checkbox" id="selectAll" class="neo-checkbox" onchange="toggleSelectAll()">
                            <label for="selectAll" class="text-sm font-medium text-gray-700 dark:text-gray-300">Tümünü
                                Seç</label>
                        </div>
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-2">
                                            <button
                                                class="inline-flex items-center px-3 py-2 text-xs font-medium text-white bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg hover:from-blue-600 hover:to-purple-700 focus:ring-2 focus:ring-blue-500 transition-all duration-150 shadow-sm"
                                                onclick="talepAnaliz({{ $talep->id }})">
                                                <i class="neo-icon neo-icon-zap w-3 h-3 mr-1"></i>
                                                AI Analiz
                                            </button>
                                            <button
                                                class="inline-flex items-center px-3 py-2 text-xs font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600 focus:ring-2 focus:ring-gray-500 transition-all duration-150"
                                                onclick="portfoyOner({{ $talep->id }})">
                                                <i class="neo-icon neo-icon-lightbulb w-3 h-3 mr-1"></i>
                                                Öneriler
                                            </button>
                                            <a class="inline-flex items-center px-3 py-2 text-xs font-medium text-blue-700 bg-blue-50 rounded-lg hover:bg-blue-100 dark:bg-blue-900/30 dark:text-blue-300 dark:hover:bg-blue-900/50 focus:ring-2 focus:ring-blue-500 transition-all duration-150"
                                ...
                                <tr>
                                    <td colspan="6" class="px-6 py-12">
                                        <div class="text-center">
                                            ...
                                            <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Aktif
                                                talep bulunamadı</h3>
        ...
        <div class="modal fade" id="aiAnalizModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-xl">
                <div class="modal-content bg-white dark:bg-gray-800 border-0 shadow-2xl rounded-2xl overflow-hidden">
                ...
                <div class="modal-content bg-white dark:bg-gray-800 border-0 shadow-2xl rounded-2xl overflow-hidden">
                    ...
                    <div class="modal-body p-6">
                        <div class="text-center mb-6">
                            ...
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Toplu Analiz Onayı</h3>
...
@push('scripts')
    <script>
        function aiDurumKontrol() {
            fetch("{{ route('admin.talep-portfolyo.ai-status') }}")
                .then(r => r.json())
                .then(data => {
        ...
        function renderOneriler() {
            ...
            if (list.length === 0) {
                container.innerHTML = `
                    <div class="text-center py-12">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Hiç öneri bulunamadı</h3>
            ...
            const rows = list.map((o, index) => `
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors duration-150">
                    ...
                    <td class="px-4 py-3">
                        <div class="max-w-xs">
                            <div class="font-medium text-gray-900 dark:text-gray-100 mb-1">${escapeHtml(o.baslik ?? '-')}</div>
                    ...
                    <td class="px-4 py-3">
                        <div class="flex items-center gap-2">
                            ...
                            <div class="flex items-center gap-1">
                                ...
                                <span class="text-xs font-semibold text-gray-700 dark:text-gray-300">${o.score ?? 0}</span>
                            </div>
                        </div>
                    </td>
                    <td class="px-4 py-3">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <thead class="bg-gray-50 dark:bg-gray-900/50">
                                <tr>
                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Sıra</th>
                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Emlak Detayı</th>
                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Fiyat</th>
                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Konum</th>
                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">AI Uygunluğu</th>
                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">İşlemler</th>
                                </tr>
                            </thead>
        ...
        <div class="modal-content bg-white dark:bg-gray-800 border-0 shadow-2xl rounded-2xl overflow-hidden">
            ...
            <div class="modal-body p-0">
                ...
                <div class="p-6 bg-gray-50 dark:bg-gray-900/50 border-b border-gray-200 dark:border-gray-700">
                    <div class="mb-4">
                        <h6
                            class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2 flex items-center gap-2">
                        ...
                        <div
                            ...
                            <div class="p-3">
                                ...
                                <input id="minScore" type="number" min="0" max="100" value="0"
                                    class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
                            ...
                            <div class="p-3">
                                ...
                                <div class="mb-3">
                                    <label
                                        ...
                                        <input id="highOnly" type="checkbox" class="neo-checkbox"
                ...
                <div class="p-6">
                    <div id="onerilerContent" style="min-height: 400px;">
                        <div class="py-10 text-center">
                            ...
                            <h5 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-1">AI Analizi Yapılıyor
                            </h5>
