    ...
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-6" x-data="{ exportOpen: false, loading: false, refreshing: false }">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex items-center gap-3">
                <!-- Period Selector -->
                <select id="period-selector" class="neo-input w-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            <div class="neo-card p-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="text-xl font-semibold text-gray-900 dark:text-gray-100" id="total-submissions">
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-950">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="text-xl font-semibold text-gray-900 dark:text-gray-100" id="completion-rate">
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-950">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="text-xl font-semibold text-gray-900 dark:text-gray-100" id="avg-completion-time">
            ...
            <div class="neo-card p-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="text-xl font-semibold text-gray-900 dark:text-gray-100" id="map-interactions">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                <!-- Conversion Funnel -->
                <div class="neo-card p-4">
                    <h6 class="mb-3 font-semibold text-gray-900 dark:text-gray-100">
            ...
            <div class="mb-6">
                <div class="neo-card p-4">
                    <h5 class="mb-4 font-semibold text-gray-900 dark:text-gray-100">
        ...
        <div class="mb-6">
            <div class="neo-card p-4">
                <h6 class="mb-4 font-semibold text-gray-900 dark:text-gray-100">
                    <i class="fas fa-tachometer-alt mr-2 text-orange-500"></i>
                    Performance Metrics
                </h6>
                <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div class="text-center p-3 rounded-md bg-gray-50 dark:bg-gray-800">
    ...
    <div x-show="exportOpen" x-transition class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div class="relative neo-card w-full max-w-md">
            ...
            <div class="px-4 py-4 space-y-4">
                <div>
                    <label for="export-type" class="block text-xs font-medium text-gray-600 dark:text-gray-300 mb-1">Data
                        Type</label>
                    <select id="export-type" class="neo-input w-full">
                ...
                <div>
                    <label for="export-period"
                        class="block text-xs font-medium text-gray-600 dark:text-gray-300 mb-1">Time Period</label>
                    <select id="export-period" class="neo-input w-full">
            ...
            <div class="flex justify-end gap-2 border-t border-gray-200 dark:border-gray-800 px-4 py-3">
...
@push('styles')
    <style>
        /* --- Minimal ve tutarlı görünüm (Analytics yerel stilleri) --- */
        .performance-metric,
        .realtime-metric {
            padding: 1rem;
        }
        ...
        /* Kartlar: sade sınır ve hafif gölge */
        .card {
        ...
        /* Eski sol renkli şeritleri kapat (sadelik) */
        .border-left-primary,
        .border-left-success,
        .border-left-info,
        .border-left-warning,
        ...
        /* Context7 metrik alanlarını da sadeleştir */
        .neo-metric {
