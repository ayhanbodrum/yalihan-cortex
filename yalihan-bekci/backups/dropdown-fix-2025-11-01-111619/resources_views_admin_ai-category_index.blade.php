            ...
            <div class="neo-card-body">
                <form id="aiTeachForm" class="neo-form">
                    <div class="neo-form-group">
                        ...
                        <select name="category_slug" id="teachCategory" class="neo-select">
                            @foreach($categories as $category)
                    ...
                    <div class="neo-form-group">
                        ...
                        <div class="neo-grid grid-cols-2 gap-2">
                            <input type="text" name="examples[0][task]" class="neo-input" placeholder="Görev...">
                            <input type="text" name="examples[0][expected_output]" class="neo-input" placeholder="Beklenen çıkış...">
                        </div>
                    </div>
                    ...
                    <div class="neo-form-group">
                        ...
                        <div class="neo-grid grid-cols-2 gap-2">
                            <input type="text" name="examples[1][task]" class="neo-input" placeholder="Görev...">
                            <input type="text" name="examples[1][expected_output]" class="neo-input" placeholder="Beklenen çıkış...">
                        </div>
                    </div>
