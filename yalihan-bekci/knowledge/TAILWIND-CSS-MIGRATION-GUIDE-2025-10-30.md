...
```html
<select class="w-full px-4 py-3.5
               border-2 border-gray-300 dark:border-gray-600
               rounded-xl bg-white dark:bg-gray-800
               text-gray-900 dark:text-gray-100
               focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500
...
```html
<label class="relative flex items-center justify-center p-4 
...
<div class="context7-live-search relative" 
    ...
    <div class="context7-search-results absolute z-50 w-full mt-1 
...
<div x-data="locationManager()" class="relative">
    <div id="map" class="w-full h-[500px] rounded-2xl border-2 border-gray-300 dark:border-gray-600 shadow-xl"></div>
    
    <!-- Map Controls -->
    <div class="absolute top-4 right-4 flex flex-col gap-3 z-10">
        <!-- Satellite Toggle -->
        <div class="bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 p-1.5">
...
<div class="bg-gradient-to-r from-gray-100 via-gray-200 to-gray-100">
```
