...
Meilisearch (Ultra-Fast Search):
    Why: ✅ 10x faster than MySQL LIKE
        ✅ Typo-tolerant
        ✅ Faceted search
        ✅ Geo-search built-in
        ✅ Easy setup
...
Flutter (Cross-platform):
    Why: ✅ Single codebase (iOS + Android)
        ✅ Native performance
...
Scikit-learn + Flask API:
    Why: ✅ Accurate price predictions
...
Sentence Transformers (Semantic Search):
    Why: ✅ "Denize yakın, havuzlu villa" gibi doğal sorular
...
Plausible Analytics (Privacy-focused):
    Why: ✅ GDPR compliant (no cookie banner!)
        ✅ Lightweight (< 1KB)
        ✅ Real-time dashboard
...
Laravel Forge + DigitalOcean:
    Why: ✅ 1-click server provisioning
