...
document.addEventListener("alpine:init", () => {
    Alpine.data("portalManager", (ilanId) => ({
        ...
        async loadSyncStatus() {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    this.error =
                        data.message || "Senkronizasyon durumu alınamadı";
                }
            } catch (error) {
                this.error = "Ağ hatası: " + error.message;
        ...
        updatePortalState(data) {
            ...
            this.masterPublishStatus = data.master_publish_status;
        ...
        async syncToAllPortals() {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    this.error =
                        data.message || "Toplu senkronizasyon başarısız";
                }
            } catch (error) {
                this.error = "Ağ hatası: " + error.message;
        ...
        async updatePortalPricing() {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    this.showSuccessMessage(
                        "Portal fiyatlandırması güncellendi!"
                    );
                } else {
        ...
        async updatePublishSchedule() {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    this.showSuccessMessage(
                        "Portal yayın programı güncellendi!"
                    );
                } else {
        ...
        async toggleMasterStatus() {
            ...
            try {
                ...
                if (data.success) {
                    this.showSuccessMessage("Master yayın durumu güncellendi!");
                } else {
        ...
        isPortalPublished(portal) {
            return (
                this.portalIds.hasOwnProperty(portal) && this.portalIds[portal]
            );
        },
        ...
        get hasPortalPricing() {
            return Object.keys(this.portalPricing).some(
                (portal) =>
                    this.portalPricing[portal] &&
                    this.portalPricing[portal].price
            );
        },
    }));
});
