...
class MockAPI {
    ...
    setupFakeEndpoints() {
        ...
        const endpoints = [
            ...
            { pattern: /\/admin\/api\/danisman\/create/, handler: this.createDanisman, method: 'POST' },
    ...
    generateSites(query, limit) {
        const allSites = [
            { id: 1, name: 'Park Residence', location: 'Şişli, İstanbul', lat: '41.0660', lng: '28.9857' },
            { id: 2, name: 'Deniz Panorama Konutları', location: 'Beykoz, İstanbul', lat: '41.1277', lng: '29.1010' },
            { id: 3, name: 'Avcılar Garden', location: 'Avcılar, İstanbul', lat: '40.9782', lng: '28.7182' },
            { id: 4, name: 'Kadıköy Towers', location: 'Kadıköy, İstanbul', lat: '40.9981', lng: '29.0270' },
            { id: 5, name: 'Çankaya Prestige', location: 'Çankaya, Ankara', lat: '39.9027', lng: '32.8351' },
            { id: 6, name: 'Park Vadi Konutları', location: 'Keçiören, Ankara', lat: '39.9819', lng: '32.8548' },
            { id: 7, name: 'Kordon Residence', location: 'Karşıyaka, İzmir', lat: '38.4519', lng: '27.1752' },
            { id: 8, name: 'Bodrum Hills', location: 'Bitez, Bodrum', lat: '37.0266', lng: '27.3809' },
            { id: 9, name: 'Marina Garden', location: 'Turgutreis, Bodrum', lat: '37.0176', lng: '27.2557' },
            { id: 10, name: 'Nur Apartmanı', location: 'Mecidiyeköy, İstanbul', lat: '41.0674', lng: '28.9878' }
        ];
    ...
    generateDanismans(query, limit) {
        const allDanismans = [
            { id: 1, ad: 'Ahmet', soyad: 'Yılmaz', telefon: '0555 111 2233', email: 'ahmet.yilmaz@emlakpro.com' },
            { id: 2, ad: 'Ayşe', soyad: 'Kaya', telefon: '0555 222 3344', email: 'ayse.kaya@emlakpro.com' },
            { id: 3, ad: 'Mehmet', soyad: 'Demir', telefon: '0555 333 4455', email: 'mehmet.demir@emlakpro.com' },
            { id: 4, ad: 'Fatma', soyad: 'Çelik', telefon: '0555 444 5566', email: 'fatma.celik@emlakpro.com' },
            { id: 5, ad: 'Ali', soyad: 'Öztürk', telefon: '0555 555 6677', email: 'ali.ozturk@emlakpro.com' },
            { id: 6, ad: 'Zeynep', soyad: 'Yıldız', telefon: '0555 666 7788', email: 'zeynep.yildiz@emlakpro.com' },
            { id: 7, ad: 'Mustafa', soyad: 'Şahin', telefon: '0555 777 8899', email: 'mustafa.sahin@emlakpro.com' },
            { id: 8, ad: 'Elif', soyad: 'Arslan', telefon: '0555 888 9900', email: 'elif.arslan@emlakpro.com' }
        ];
    ...
    generateContacts(query, limit) {
        const allContacts = [
            { id: 1, ad: 'Hasan', soyad: 'Aydın', telefon: '0532 111 2233', email: 'hasan.aydin@example.com' },
            { id: 2, ad: 'Sevgi', soyad: 'Kılıç', telefon: '0532 222 3344', email: 'sevgi.kilic@example.com' },
            { id: 3, ad: 'Okan', soyad: 'Güler', telefon: '0532 333 4455', email: 'okan.guler@example.com' },
            { id: 4, ad: 'Deniz', soyad: 'Yaman', telefon: '0532 444 5566', email: 'deniz.yaman@example.com' },
            { id: 5, ad: 'Selin', soyad: 'Aksu', telefon: '0532 555 6677', email: 'selin.aksu@example.com' },
            { id: 6, ad: 'Burak', soyad: 'Koç', telefon: '0532 666 7788', email: 'burak.koc@example.com' },
            { id: 7, ad: 'Ali', soyad: 'Yılmaz', telefon: '0532 777 8899', email: 'ali.yilmaz@example.com' }
        ];
    ...
    generateOwners(query, limit) {
        const allOwners = [
            { id: 1, ad: 'Kemal', soyad: 'Sunal', telefon: '0533 111 2233', email: 'kemal.sunal@example.com', adres: 'Kadıköy, İstanbul' },
            { id: 2, ad: 'Filiz', soyad: 'Akın', telefon: '0533 222 3344', email: 'filiz.akin@example.com', adres: 'Çankaya, Ankara' },
            { id: 3, ad: 'Tarık', soyad: 'Akan', telefon: '0533 333 4455', email: 'tarik.akan@example.com', adres: 'Karşıyaka, İzmir' },
            { id: 4, ad: 'Türkan', soyad: 'Şoray', telefon: '0533 444 5566', email: 'turkan.soray@example.com', adres: 'Beşiktaş, İstanbul' },
            { id: 5, ad: 'Cüneyt', soyad: 'Arkın', telefon: '0533 555 6677', email: 'cuneyt.arkin@example.com', adres: 'Bodrum, Muğla' }
        ];
