...
class TKGMIntegration {
    ...
    async checkServiceStatus() {
        try {
            ...
            this.showServiceStatus(
                "TKGM servis durumu kontrol edilemedi",
                "error",
            );
        }
    }
    ...
    async sorgulaParsel() {
        ...
        tkgmButton.innerHTML =
            '<i class="fas fa-spinner fa-spin mr-2"></i>Sorgulanıyor...';
        ...
        try {
            ...
            tkgmButton.innerHTML =
                '<i class="fas fa-search mr-2"></i>TKGM\'den Sorgula';
        }
    }
        ...
        dataDiv.innerHTML = `
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="bg-blue-50 p-3 rounded-lg">
                    ...
                    <div class="text-blue-900">${formatValue(
                        parselData.alan,
                    )}</div>
                </div>
                ...
                <div class="bg-green-50 p-3 rounded-lg">
                    ...
                    <div class="text-green-900">${formatValue(
                        parselData.imar_durumu,
                    )}</div>
                </div>

                <div class="bg-purple-50 p-3 rounded-lg">
                    <div class="text-sm font-medium text-purple-800 mb-1">Tapu Durumu</div>
                    <div class="text-purple-900">${formatValue(
                        parselData.tapu_durumu,
                    )}</div>
                </div>

                <div class="bg-orange-50 p-3 rounded-lg">
                    <div class="text-sm font-medium text-orange-800 mb-1">Sahip Bilgileri</div>
                    <div class="text-orange-900">${formatValue(
                        parselData.sahip_bilgileri,
                    )}</div>
                </div>
            </div>
