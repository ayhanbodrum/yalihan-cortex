# Dead Code Analysis Report - 2025-11-11 14:14:46

## 📊 Özet

| Kategori | Toplam | Kullanılan | Kullanılmayan |
|----------|--------|------------|---------------|
| Class'lar | 425 | 395 | 113 |
| Trait'ler | 11 | 8 | 9 |
| Interface'ler | 0 | 10 | 0 |

**Temizlik Fırsatı:** 122 dosya

## 🗑️ Kullanılmayan Class'lar (İlk 50)

- **ExampleController** (`app/Traits/ValidatesApiRequests.php`)
...
- **varsa** (`app/Providers/AppServiceProvider.php`)
  - Sebep: Not referenced anywhere
...
- **AkilliCevreAnaliziController** (`app/Http/Controllers/Api/AkilliCevreAnaliziController.php`)
  - Sebep: Orphaned controller (no route)

- **AIFeatureSuggestionController** (`app/Http/Controllers/Api/AIFeatureSuggestionController.php`)
  - Sebep: Orphaned controller (no route)

- **PropertyFeatureSuggestionController** (`app/Http/Controllers/Api/PropertyFeatureSuggestionController.php`)
  - Sebep: Orphaned controller (no route)

- **ImageAIController** (`app/Http/Controllers/Api/ImageAIController.php`)
  - Sebep: Orphaned controller (no route)

- **ListingSearchController** (`app/Http/Controllers/Api/ListingSearchController.php`)
  - Sebep: Orphaned controller (no route)
...
- **Filterable** (`app/Traits/Filterable.php`)
  - Sebep: Not used in any class
...
- **kullan** (`app/Http/Controllers/VillaController.php`)
  - Sebep: Not used in any class

- **search** (`app/Http/Controllers/Admin/IlanController.php`)
  - Sebep: Not used in any class

- **sort** (`app/Http/Controllers/VillaController.php`)
  - Sebep: Not used in any class

- **with** (`app/Http/Controllers/Api/AIController.php`)
  - Sebep: Not used in any class
