# Dead Code Analysis Report - 2025-11-11 11:53:55

## 📊 Özet

| Kategori | Toplam | Kullanılan | Kullanılmayan |
|----------|--------|------------|---------------|
| Class'lar | 428 | 394 | 117 |
| Trait'ler | 8 | 8 | 6 |
| Interface'ler | 0 | 9 | 0 |

**Temizlik Fırsatı:** 123 dosya

## 🗑️ Kullanılmayan Class'lar (İlk 50)

- **MyController** (`app/Traits/ValidatesApiRequests.php`)
...
- **PriceRequest** (`app/Http/Requests/Admin/PriceRequest.php`)
  - Sebep: Not referenced anywhere
...
- **NeoSelect** (`app/View/Components/NeoSelect.php`)
  - Sebep: Not referenced anywhere

- **LocationSelector** (`app/View/Components/LocationSelector.php`)
  - Sebep: Not referenced anywhere

- **Label** (`app/View/Components/Label.php`)
  - Sebep: Not referenced anywhere
