    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="mb-6 flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('admin.property_types.field_dependencies', $kategori->id)); ?>"
        ...
        <div class="bg-gray-50 dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <button onclick="showAddYayinTipiModal()"
...
$yayinTipiAdi =
    is_object($yayinTipi) && property_exists($yayinTipi, 'yayin_tipi')
        ? $yayinTipi->yayin_tipi
        : (is_array($yayinTipi)
            ? $yayinTipi['yayin_tipi'] ?? null
                                        : null);
                        ...
                        ?>
                        <div
                            class="flex items-center justify-between p-4 bg-white dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600 hover:shadow-md transition-all duration-200">
                            <div class="flex items-center gap-3">
                                <span class="text-lg font-semibold text-gray-900 dark:text-white">
                                    <?php echo e($yayinTipiAdi ?? ($yayinTipi->yayin_tipi ?? 'N/A')); ?>

                                </span>
                                <?php if(isset($yayinTipi->status) && $yayinTipi->status): ?>
                                    <span
                                ...
                                <?php else: ?>
                                    <span
                                        class="px-2 py-1 text-xs font-medium bg-gray-100 dark:bg-gray-600 text-gray-800 dark:text-gray-200 rounded-full">
                                        Pasif
                                    </span>
                                <?php endif; ?>
                            </div>
                            <button onclick="deleteYayinTipi(<?php echo e($yayinTipi->id ?? 0); ?>, '<?php echo e($yayinTipiAdi ?? 'N/A'); ?>')"
                                ...
                                <?php if(config('app.debug')): ?>
                                    <div class="mt-3 p-3 bg-gray-100 dark:bg-gray-900 rounded text-xs font-mono">
                                        ...
                                        <div class="text-gray-600 dark:text-gray-400 space-y-1">
                                            ...
                                            <div>Parent ID: <span
                                                    class="font-bold"><?php echo e($kategori->parent_id ?? 'NULL'); ?></span></div>
            ...
            <?php $__currentLoopData = $altKategoriler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $altKategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="mb-6 last:mb-0 border-b dark:border-gray-700 pb-6 last:border-0 last:pb-0">
                    ...
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <button onclick="deleteAltKategori(<?php echo e($altKategori->id); ?>, '<?php echo e($altKategori->name); ?>')"
                            class="inline-flex items-center px-3 py-1.5 text-sm font-medium text-white bg-gradient-to-r from-red-600 to-red-700 rounded-lg hover:from-red-700 hover:to-red-800 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition-all duration-200 shadow-sm hover:shadow-md active:scale-95">
                            <i class="fas fa-trash mr-1.5"></i>
                            Sil
                        </button>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                        <?php $__currentLoopData = $allYayinTipleri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $yayinTipi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <label
                                class="flex items-center p-3 border rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer <?php echo e($active ? 'bg-green-50 dark:bg-green-900/20 border-green-300 dark:border-green-700' : 'bg-gray-50 dark:bg-gray-800 border-gray-300 dark:border-gray-600'); ?>">
                                <input type="checkbox" class="rounded mr-2 yayin-tipi-toggle"
                                    data-alt-kategori-id="<?php echo e($altKategori->id); ?>"
                                    data-yayin-tipi-id="<?php echo e($yayinTipi->id); ?>"
                                    data-yayin-tipi-name="<?php echo e($yayinTipi->yayin_tipi); ?>" <?php echo e($active ? 'checked' : ''); ?>

                                    onchange="toggleYayinTipiRelation(this)">
                                <span
                                    class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($yayinTipi->yayin_tipi); ?></span>
                            </label>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-900">
                                    ...
                                    <?php $__currentLoopData = $allYayinTipleri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $yayinTipi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            ...
                                            $status = $fieldData['yayin_tipleri'][$yayinTipi->id] ?? false;
            ...
            'yayin_tipi',
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <input type="checkbox" class="rounded field-dependency-toggle"
                                                ...
                                                <?php echo e($status ? 'checked' : ''); ?> onchange="toggleFieldDependency(this)">
                                        </td>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                        <?php $__currentLoopData = $category->features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label
                                ...
                                <input type="checkbox" class="rounded mr-2" data-feature-id="<?php echo e($feature->id); ?>"
        ...
        <div class="mt-6 flex justify-between items-center">
            ...
            <div class="flex gap-2">
                <button onclick="toggleAllYayinTipleri(true)"
                    class="inline-flex items-center px-4 py-2.5 bg-gray-600 text-white font-semibold rounded-lg shadow-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 text-sm dark:bg-gray-800 dark:hover:bg-gray-600">
                    ...
                    <?php if(($altKategoriler ?? collect())->isNotEmpty()): ?>
                        <div class="mb-4">
                            ...
                            <select id="modalAltKategori"
                                class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-black dark:text-white rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200">
    ...
    <?php $__env->startPush('scripts'); ?>
        <script data-timestamp="<?php echo e(time()); ?>">
            ...
            async function toggleYayinTipiRelation(checkbox) {
                ...
                const status = checkbox.checked; // Context7: enabled → status
                ...
                try {
                    const data = await PropertyTypeManager.request(
                        '<?php echo e(route('admin.property_types.toggle_yayin_tipi', $kategori->id)); ?>', {
                    ...
                    if (data.success) {
                        ...
                        PropertyTypeManager.showSuccess(
                            `${yayinTipiName} ${status ? 'etkinleştirildi' : 'devre dışı bırakıldı'}`);
            ...
            async function toggleFieldDependency(checkbox) {
                ...
                try {
                    ...
                    const data = await PropertyTypeManager.request(
                        '<?php echo e(route('admin.property_types.toggle_field_dependency')); ?>',
                        payload
                    );
            ...
            async function deleteYayinTipi(yayinTipiId, yayinTipiName) {
                ...
                try {
                    const url = '/admin/property-type-manager/<?php echo e($kategori->id); ?>/yayin-tipi/' + yayinTipiId;
            ...
            async function deleteAltKategori(altKategoriId, altKategoriName) {
                ...
                try {
                    const url = '/admin/property-type-manager/<?php echo e($kategori->id); ?>/alt-kategori/' + altKategoriId;
                    const data = await PropertyTypeManager.request(url, {}, 'DELETE');
            ...
            async function addYayinTipi(e) {
                ...
                try {
                    const data = await PropertyTypeManager.request(
                        "<?php echo e(route('admin.property_types.create_yayin_tipi', $kategori->id)); ?>", {
                            name
                        }
                    );
            ...
            async function saveChanges() {
                ...
                try {
                    ...
                    const data = await PropertyTypeManager.request(
                        '<?php echo e(route('admin.property_types.bulk_save', $kategori->id)); ?>',
                        changes
                    );
...
<?php echo $__env->make('admin.layouts.neo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Projects/yalihanai /resources/views/admin/property-type-manager/show.blade.php ENDPATH**/ ?>