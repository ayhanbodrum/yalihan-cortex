        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div class="mb-6">
                ...
                <select  name="anahtar_durumu" id="anahtar_durumu" required class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 transition-all duration-200">
                    ...
                    <option value="ofiste" <?php echo e(old('anahtar_durumu') == 'ofiste' ? 'selected' : ''); ?>>🏢 Ofiste</option>
                    <option value="sahibinde" <?php echo e(old('anahtar_durumu') == 'sahibinde' ? 'selected' : ''); ?>>👤 Sahibinde</option>
                    <option value="emniyette" <?php echo e(old('anahtar_durumu') == 'emniyette' ? 'selected' : ''); ?>>🔐 Emniyette</option>
                    <option value="noterde" <?php echo e(old('anahtar_durumu') == 'noterde' ? 'selected' : ''); ?>>⚖️ Noterde</option>
                    <option value="diger" <?php echo e(old('anahtar_durumu') == 'diger' ? 'selected' : ''); ?>>📦 Diğer</option>
                </select>
                <?php $__errorArgs = ['anahtar_durumu'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6">
                ...
                <input type="number" name="anahtar_sayisi" id="anahtar_sayisi" 
                    value="<?php echo e(old('anahtar_sayisi', 1)); ?>" min="0" max="20"
...
<?php /**PATH /Users/macbookpro/Projects/yalihanemlakwarp/resources/views/admin/ilanlar/components/key-management.blade.php ENDPATH**/ ?>