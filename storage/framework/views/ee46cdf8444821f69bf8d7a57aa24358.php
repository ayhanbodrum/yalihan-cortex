<?php $__env->startSection('title', 'İlanlarım'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div class="stat-card">
                <div class="stat-value text-blue-600"><?php echo e($stats['total_listings'] ?? 0); ?></div>
                <div class="stat-label">Toplam İlan</div>
            </div>
            <div class="stat-card">
                <div class="stat-value text-green-600"><?php echo e($stats['active_listings'] ?? 0); ?></div>
                <div class="stat-label">Aktif İlanlar</div>
            </div>
            <div class="stat-card">
                <div class="stat-value text-purple-600"><?php echo e($stats['pending_listings'] ?? 0); ?></div>
                <div class="stat-label">Bekleyen</div>
            </div>
            <div class="stat-card">
                <div class="stat-value text-orange-600"><?php echo e($stats['total_views'] ?? 0); ?></div>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    ...
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-12 w-12">
                                            <img class="h-12 w-12 rounded-lg object-cover"
                                                 src="<?php echo e($listing->featured_image ?? asset('images/default-property.jpg')); ?>"
                                                 alt="<?php echo e($listing->title ?? 'İlan'); ?>">
                                        </div>
                                        <div class="ml-4">
                                            <div class="text-sm font-medium text-gray-900">
                                                <?php echo e(Str::limit($listing->title ?? 'Başlık Yok', 40)); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                        <?php echo e(optional($listing->altKategori)->name ?? optional($listing->anaKategori)->name ?? 'Kategori Yok'); ?>

                                    </span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <?php if(($listing->status ?? 'draft') === 'active'): ?>
                                    ...
                                    <?php elseif(($listing->status ?? 'draft') === 'pending'): ?>
                                    ...
                                    <?php elseif(($listing->status ?? 'draft') === 'inactive'): ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <?php echo e(number_format($listing->price ?? 0)); ?> <?php echo e($listing->currency ?? 'TL'); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <?php echo e(number_format($listing->views ?? 0)); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <?php echo e($listing->created_at ? $listing->created_at->format('d.m.Y') : 'N/A'); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        <a href="<?php echo e(route('admin.ilanlar.edit', $listing->id)); ?>"
                                           class="text-blue-600 hover:text-blue-900 transition-colors duration-200">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                            </svg>
                                        </a>
                                        <a href="<?php echo e(route('admin.ilanlar.show', $listing->id)); ?>"
        ...
        <!-- Pagination -->
        <?php if(isset($listings) && $listings->hasPages()): ?>
            <div class="mt-8">
    ...
    <script>
        ...
        async function applyFilters() {
            ...
            try {
                ...
                const response = await fetch('<?php echo e(route("admin.my-listings.search")); ?>', {
                    method: 'POST',
                    headers: {
            ...
            row.innerHTML = `
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 h-12 w-12">
                            <img class="h-12 w-12 rounded-lg object-cover"
                                 src="${listing.featured_image || '<?php echo e(asset("images/default-property.jpg")); ?>'}"
...
<?php echo $__env->make('admin.layouts.neo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Projects/yalihanemlakwarp/resources/views/admin/ilanlar/my-listings.blade.php ENDPATH**/ ?>