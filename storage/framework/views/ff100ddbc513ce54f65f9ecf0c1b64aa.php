        ...
        <ul class="space-y-1" role="menu">
            <li x-show="!query || ($el.innerText||'').toLowerCase().includes(query.toLowerCase())">
                <a href="<?php echo e(route('admin.dashboard.index')); ?>"
                    class="flex items-center gap-3 h-11 px-3 rounded-lg text-slate-300 hover:text-white hover:bg-slate-800 transition-all duration-200 ease-in-out hover:scale-[1.01] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 <?php echo e(request()->routeIs('admin.dashboard.*') ? 'bg-blue-600 text-white hover:bg-blue-700' : ''); ?>"
                    role="menuitem">
            ...
            <li x-show="!query || ($el.innerText||'').toLowerCase().includes(query.toLowerCase())"
                x-data="{ open: <?php echo e(request()->routeIs('admin.ilanlar.*', 'admin.ilan-kategorileri.*', 'admin.ozellikler.*', 'admin.property_types.*') ? 'true' : 'false'); ?> }">
                <button type="button" @click="open = !open" @keydown.enter.prevent="open = !open"
                    x-bind:aria-expanded="open"
                    aria-controls="ilan-yonetimi-menu"
                    aria-haspopup="true"
                    class="flex items-center gap-3 h-11 px-3 rounded-lg text-slate-300 hover:text-white hover:bg-slate-800 w-full transition-all duration-200 ease-in-out hover:scale-[1.01] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 <?php echo e(request()->routeIs('admin.ilanlar.*', 'admin.ilan-kategorileri.*', 'admin.ozellikler.*', 'admin.property_types.*') ? 'bg-blue-600 text-white hover:bg-blue-700' : ''); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-200"
                    ...
                    <div class="pt-2 pb-1">
                        ...
                        <a href="<?php echo e(route('admin.ilanlar.index')); ?>"
                            class="flex items-center gap-2 h-9 px-3 rounded-lg text-slate-400 hover:text-white hover:bg-slate-700 text-sm transition-all duration-200 ease-in-out hover:scale-[1.01] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 <?php echo e(request()->routeIs('admin.ilanlar.index') ? 'bg-blue-500 text-white' : ''); ?>"
                            role="menuitem">
                        ...
                        <a href="<?php echo e(route('admin.ilanlar.create')); ?>"
                            ...
                            <span>Yeni İlan</span>
                            <span class="ml-auto text-xs bg-green-500/20 text-green-600 dark:text-green-200 px-1.5 py-0.5 rounded transition-colors">AI</span>
                        </a>
                    </div>
                    ...
                    <div class="pt-2 pb-1 border-t border-slate-700">
                        ...
                        <a href="<?php echo e(route('admin.property_types.index')); ?>"
                            class="flex items-center gap-2 h-9 px-3 rounded-lg text-slate-400 hover:text-white hover:bg-slate-700 text-sm transition-all duration-200 ease-in-out hover:scale-[1.01] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 <?php echo e(request()->routeIs('admin.property_types.*') ? 'bg-blue-500 text-white' : ''); ?>"
                            role="menuitem">
                            <span>Yayın Tipi Yöneticisi</span>
                            <span class="ml-auto text-xs bg-green-500/20 text-green-600 dark:text-green-200 px-1.5 py-0.5 rounded transition-colors">Yeni</span>
                        </a>
                    </div>
                    ...
                    <div class="pt-2 pb-1 border-t border-slate-700">
                        ...
                        <a href="<?php echo e(route('admin.ozellikler.kategoriler.show', 5)); ?>"
                            ...
                            role="menuitem"
                            title="Site Özellikleri (Polymorphic Sistem)">
            ...
            <!-- CRM Dropdown Menüsü -->
            <li x-show="!query || ($el.innerText||'').toLowerCase().includes(query.toLowerCase())"
                x-data="{ open: <?php echo e(request()->routeIs('admin.crm.*', 'admin.kisiler.*', 'admin.talepler.*', 'admin.eslesmeler.*', 'admin.talep-portfolyo.*') ? 'true' : 'false'); ?> }">
                <button type="button" @click="open = !open" @keydown.enter.prevent="open = !open"
                    x-bind:aria-expanded="open"
                    aria-controls="crm-yonetimi-menu"
                    aria-haspopup="true"
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-200"
                    ...
                    class="ml-6 mt-1 space-y-1">
                    <?php if(\Illuminate\Support\Facades\Route::has('admin.crm.dashboard')): ?>
                        <a href="<?php echo e(route('admin.crm.dashboard')); ?>"
                            class="flex items-center gap-2 h-9 px-3 rounded-lg text-slate-400 hover:text-white hover:bg-slate-700 text-sm transition-all duration-200 ease-in-out hover:scale-[1.01] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 <?php echo e(request()->routeIs('admin.crm.dashboard') ? 'bg-blue-500 text-white' : ''); ?>"
                            role="menuitem">
                    ...
                    <?php if(\Illuminate\Support\Facades\Route::has('admin.kisiler.index')): ?>
                        <a href="<?php echo e(route('admin.kisiler.index')); ?>"
                            class="flex items-center gap-2 h-9 px-3 rounded-lg text-slate-400 hover:text-white hover:bg-slate-700 text-sm transition-all duration-200 ease-in-out hover:scale-[1.01] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 <?php echo e(request()->routeIs('admin.kisiler.*') ? 'bg-blue-500 text-white' : ''); ?>"
                            role="menuitem">
                            <span>Kişiler</span>
                        </a>
                    <?php endif; ?>
                    <?php if(\Illuminate\Support\Facades\Route::has('admin.talepler.index')): ?>
                        <a href="<?php echo e(route('admin.talepler.index')); ?>"
                            class="flex items-center gap-2 h-9 px-3 rounded-lg text-slate-400 hover:text-white hover:bg-slate-700 text-sm transition-all duration-200 ease-in-out hover:scale-[1.01] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 <?php echo e(request()->routeIs('admin.talepler.*') ? 'bg-blue-500 text-white' : ''); ?>"
                            role="menuitem">
                            <span>Talepler</span>
                        </a>
                    <?php endif; ?>
                    <?php if(\Illuminate\Support\Facades\Route::has('admin.eslesmeler.index')): ?>
                        <a href="<?php echo e(route('admin.eslesmeler.index')); ?>"
                            class="flex items-center gap-2 h-9 px-3 rounded-lg text-slate-400 hover:text-white hover:bg-slate-700 text-sm transition-all duration-200 ease-in-out hover:scale-[1.01] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 <?php echo e(request()->routeIs('admin.eslesmeler.*') ? 'bg-blue-500 text-white' : ''); ?>"
                            role="menuitem">
            ...
            <li x-show="!query || ($el.innerText||'').toLowerCase().includes(query.toLowerCase())"
                x-data="{ open: <?php echo e(request()->routeIs('admin.yazlik-kiralama.*') ? 'true' : 'false'); ?> }">
                <button type="button" @click="open = !open" @keydown.enter.prevent="open = !open"
                    x-bind:aria-expanded="open"
                    aria-controls="yazlik-kiralama-menu"
                    aria-haspopup="true"
            ...
            <!-- AI Sistemi Dropdown -->
            <li x-show="!query || ($el.innerText||'').toLowerCase().includes(query.toLowerCase())"
                x-data="{ open: <?php echo e(request()->routeIs('admin.ai-settings.*', 'admin.ai-monitor.*') ? 'true' : 'false'); ?> }">
                <button type="button" @click="open = !open" @keydown.enter.prevent="open = !open"
                    x-bind:aria-expanded="open"
                    aria-controls="ai-sistemi-menu"
                    aria-haspopup="true"
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-200"
                    ...
                    <?php if(\Illuminate\Support\Facades\Route::has('admin.ai-monitor.index')): ?>
                        <a href="<?php echo e(route('admin.ai-monitor.index')); ?>"
                            class="flex items-center gap-2 h-9 px-3 rounded-lg text-slate-400 hover:text-white hover:bg-slate-700 text-sm transition-all duration-200 ease-in-out hover:scale-[1.01] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 <?php echo e(request()->routeIs('admin.ai-monitor.*') ? 'bg-blue-500 text-white' : ''); ?>"
                            role="menuitem">
            ...
            <li x-show="!query || ($el.innerText||'').toLowerCase().includes(query.toLowerCase())"
                x-data="{ open: <?php echo e(request()->routeIs('admin.takim-yonetimi.*') ? 'true' : 'false'); ?> }">
                <button type="button" @click="open = !open" @keydown.enter.prevent="open = !open"
                    x-bind:aria-expanded="open"
                    aria-controls="takim-yonetimi-menu"
                    aria-haspopup="true"
            ...
            <!-- Analytics Dropdown -->
            <li x-show="!query || ($el.innerText||'').toLowerCase().includes(query.toLowerCase())"
                x-data="{ open: <?php echo e(request()->routeIs('admin.analytics.*', 'admin.reports.*') ? 'true' : 'false'); ?> }">
                <button type="button" @click="open = !open" @keydown.enter.prevent="open = !open"
                    x-bind:aria-expanded="open"
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-200"
                    ...
                    <?php endif; ?>
                    <a href="<?php echo e(route('admin.reports.index')); ?>"
                        class="flex items-center gap-2 h-9 px-3 rounded-lg text-slate-400 hover:text-white hover:bg-slate-700 text-sm transition-all duration-200 ease-in-out hover:scale-[1.01] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 <?php echo e(request()->routeIs('admin.reports.*') ? 'bg-blue-500 text-white' : ''); ?>"
                        role="menuitem"
                        title="Raporlar">
                        <span>Raporlar</span>
                    </a>
            ...
            <li x-data="{ open: <?php echo e(request()->routeIs('admin.telegram.*', 'admin.telegram-bot.*') ? 'true' : 'false'); ?> }">
                <button type="button" @click="open = !open" @keydown.enter.prevent="open = !open"
                    x-bind:aria-expanded="open"
                    aria-controls="telegram-bot-menu"
                    aria-haspopup="true"
            ...
            <li x-show="!query || ($el.innerText||'').toLowerCase().includes(query.toLowerCase())"
                x-data="{ open: <?php echo e(request()->routeIs('admin.blog.*') ? 'true' : 'false'); ?> }">
                <button type="button" @click="open = !open" @keydown.enter.prevent="open = !open"
                    x-bind:aria-expanded="open"
                    aria-controls="blog-yonetimi-menu"
                    aria-haspopup="true"
                 ...
                 <div x-show="open" x-transition:enter="transition ease-out duration-200"
                     ...
                     <?php if(\Illuminate\Support\Facades\Route::has('admin.blog.posts.index')): ?>
                         <a href="<?php echo e(route('admin.blog.posts.index')); ?>"
                             class="flex items-center gap-2 h-9 px-3 rounded-lg text-slate-400 hover:text-white hover:bg-slate-700 text-sm transition-all duration-200 ease-in-out hover:scale-[1.01] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 <?php echo e(request()->routeIs('admin.blog.posts.*') ? 'bg-blue-500 text-white' : ''); ?>"
                             role="menuitem">
                             <span>Yazılar</span>
                         </a>
                     <?php endif; ?>
                     ...
                     <?php if(\Illuminate\Support\Facades\Route::has('admin.blog.comments.index')): ?>
                         <a href="<?php echo e(route('admin.blog.comments.index')); ?>"
                             class="flex items-center gap-2 h-9 px-3 rounded-lg text-slate-400 hover:text-white hover:bg-slate-700 text-sm transition-all duration-200 ease-in-out hover:scale-[1.01] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 <?php echo e(request()->routeIs('admin.blog.comments.*') ? 'bg-blue-500 text-white' : ''); ?>"
                             role="menuitem">
                             <span>Yorumlar</span>
                         </a>
                     <?php endif; ?>
            ...
            <li x-show="!query || ($el.innerText||'').toLowerCase().includes(query.toLowerCase())"
                x-data="{ open: <?php echo e(request()->routeIs('admin.adres-yonetimi.*', 'admin.wikimapia-search.*') ? 'true' : 'false'); ?> }">
                <button type="button" @click="open = !open" @keydown.enter.prevent="open = !open"
                    x-bind:aria-expanded="open"
                    aria-controls="adres-yonetimi-menu"
                    aria-haspopup="true"
            ...
            <li x-show="!query || ($el.innerText||'').toLowerCase().includes(query.toLowerCase())"
                ...
                <button type="button" @click="open = !open" @keydown.enter.prevent="open = !open"
                    x-bind:aria-expanded="open"
                    aria-controls="system-tools-menu"
                    aria-haspopup="true"
...
<?php /**PATH /Users/macbookpro/Projects/yalihanai /resources/views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>