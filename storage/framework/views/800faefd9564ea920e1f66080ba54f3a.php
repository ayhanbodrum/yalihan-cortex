<?php $__env->startSection('title', 'İlan Kategorileri'); ?>
    ...
    <div class="container mx-auto px-4 py-6" x-data="kategorilerManager()">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
            <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/30 rounded-lg p-3">
                ...
                <div class="text-xl font-bold text-blue-700 dark:text-blue-300"><?php echo e($istatistikler['toplam']); ?></div>
            </div>
            <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800/30 rounded-lg p-3">
                ...
                <div class="text-xl font-bold text-green-700 dark:text-green-300"><?php echo e($istatistikler['ana_kategoriler']); ?></div>
            </div>
            <div class="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800/30 rounded-lg p-3">
                ...
                <div class="text-xl font-bold text-amber-700 dark:text-amber-300"><?php echo e($istatistikler['alt_kategoriler']); ?></div>
            </div>
            <div class="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800/30 rounded-lg p-3">
                ...
                <div class="text-xl font-bold text-purple-700 dark:text-purple-300"><?php echo e($istatistikler['aktif']); ?></div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
            ...
            <div class="p-6">
                ...
                <?php $__env->startPush('scripts'); ?>
                    <script>
                        window._kategoriAdlari = [<?php $__currentLoopData = $kategoriler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if($kategori->name): ?>"<?php echo e(addslashes($kategori->name)); ?>",<?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>];
                            ...
                            <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                                <?php $__currentLoopData = $kategoriler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
                                        :class="{ 'bg-blue-50': selectedItems.includes(<?php echo e($kategori->id); ?>) }">
                                        <td class="px-6 py-4">
                                            <input type="checkbox" id="kategori-<?php echo e($kategori->id); ?>" value="<?php echo e($kategori->id); ?>" class="rounded" @change="toggleItemSelection(<?php echo e($kategori->id); ?>)">
                                        </td>
                                        <td class="px-6 py-4">
                                            <div class="flex items-center gap-2 flex-wrap">
                                                <span class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($kategori->name); ?></span>
                                                <span class="px-2 py-1 text-xs rounded-full <?php echo e($kategori->seviye == 0 ? 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300' : 'bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-gray-400'); ?>">
                                                    <?php echo e($kategori->seviye == 0 ? 'Ana' : 'Alt'); ?>

                                                </span>
                                                <?php if($kategori->ilanlar_count > 0): ?>
                                                    <span class="px-2 py-1 text-xs rounded-full bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300">
                                                        <?php echo e($kategori->ilanlar_count); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($kategori->parent?->name ?? '—'); ?></span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full <?php echo e($kategori->status ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300'); ?>">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                                            <div class="flex items-center justify-end space-x-2">
                                                <a href="<?php echo e(route('admin.ilan-kategorileri.edit', $kategori)); ?>"
                                                ...
                                                <form action="<?php echo e(route('admin.ilan-kategorileri.destroy', $kategori)); ?>"
                                                      method="POST"
                                                      onsubmit="return confirm('<?php echo e(addslashes($kategori->name)); ?> kategorisini silmek istediğinize emin misiniz?');"
                                                      class="inline-block">
                                                    <?php echo csrf_field(); ?>
        ...
        function kategorilerManager() {
            return {
                ...
                filters: {
                    ...
                    seviye: '<?php echo e(request('seviye')); ?>',
                    status: '<?php echo e(request('status')); ?>'
                },

                get isAllSelected() {
                    const totalItems = <?php echo e($kategoriler->count()); ?>;
                ...
                async applyFilters() {
                    ...
                    const url = `<?php echo e(route('admin.ilan-kategorileri.index')); ?>?${params.toString()}`;
                ...
                async bulkAction(action) {
                    ...
                    try {
                        ...
                        const response = await fetch('<?php echo e(route('admin.ilan-kategorileri.bulk-action')); ?>', {
                            method: 'POST',
                            body: formData
                        });
                        if (response.ok) {
...
<?php echo $__env->make('admin.layouts.neo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Projects/yalihanemlakwarp/resources/views/admin/ilan-kategorileri/index.blade.php ENDPATH**/ ?>