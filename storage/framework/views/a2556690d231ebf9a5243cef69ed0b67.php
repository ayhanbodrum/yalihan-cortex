<?php $__env->startSection('title', 'Danışmanlarımız'); ?>
                    ...
                    <div
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-gray-900 mb-1">
                                <?php echo e(['Ahmet Yılmaz', 'Mehmet Kaya', 'Ayşe Demir', 'Fatma Öztürk', 'Ali Başaran', 'Veli Çelik'][$i - 1]); ?>

                            </h3>
                            <p class="text-gray-600 mb-4">
                                <?php echo e(['Kıdemli Emlak Danışmanı', 'Emlak Uzmanı', 'Satış Danışmanı', 'Kiralama Uzmanı', 'Yatırım Danışmanı', 'Müşteri İlişkileri'][$i - 1]); ?>
                            ...
                            <div class="grid grid-cols-3 gap-2 mb-4 text-center">
                                <div class="bg-gray-50 rounded-lg p-2">
                                    <div class="text-lg font-bold text-blue-600"><?php echo e(30 + $i * 5); ?></div>
                                    <div class="text-xs text-gray-500">İlan</div>
                                </div>
                                <div class="bg-gray-50 rounded-lg p-2">
                                    <div class="text-lg font-bold text-green-600"><?php echo e(50 + $i * 10); ?></div>
                                    <div class="text-xs text-gray-500">Satış</div>
                                </div>
                                <div class="bg-gray-50 rounded-lg p-2">
                                    <div class="text-lg font-bold text-purple-600"><?php echo e(3 + $i); ?></div>
                            ...
                            <div class="flex items-center justify-center mb-4">
                                ...
                                <span class="ml-2 text-sm text-gray-600">(<?php echo e(4.5 + ($i % 5) * 0.1); ?>)</span>
                            </div>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Projects/yalihanemlakwarp/resources/views/pages/advisors.blade.php ENDPATH**/ ?>