...
<?php $__env->startSection('content'); ?>
    <script>
        ...
        window.fieldDependenciesManager = function fieldDependenciesManagerFactory() {
            return {
                propertyTypes: <?php echo json_encode($propertyTypesSummary); ?>,
                activeTab: <?php echo json_encode($defaultPropertyType['slug'] ?? ''); ?>,
                selectedPropertyTypeId: <?php echo json_encode($defaultPropertyType['id'] ?? null); ?>,
                selectedPropertyTypeName: <?php echo json_encode($defaultPropertyType['name'] ?? ''); ?>,
                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm">
                            <div
                                ...
                                <p class="mt-1 font-semibold text-blue-900 dark:text-blue-100"><?php echo e($kategori->name); ?></p>
                            </div>
            ...
            <div class="flex items-center justify-between mb-8">
                <div>
                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="<?php echo e(route('admin.property_types.show', $kategori->id)); ?>"
                    ...
                    <div class="mt-3 flex items-center gap-2 text-sm">
                        ...
                        <a href="<?php echo e(route('admin.ozellikler.features.index')); ?>"
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg mb-6">
                    <div class="border-b border-gray-200 dark:border-gray-700 px-6 overflow-x-auto">
                        <nav class="-mb-px flex space-x-8 min-w-max" aria-label="Tabs">
                            <?php $__currentLoopData = $yayinTipleri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $yayinTipi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <button @click="setPropertyType('<?php echo e($typeSlug); ?>')"
                                    :class="activeTab === '<?php echo e($typeSlug); ?>' ? 'active' : ''"
                                    ...
                                    <span class="ml-2 px-2 py-1 text-xs rounded-full"
                                        :class="activeTab === '<?php echo e($typeSlug); ?>' ?
                                            'bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200' :
                                            'bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300'">
                                        <?php echo e(isset($fieldDependencies[$typeSlug]) ? $fieldDependencies[$typeSlug]->count() : 0); ?>
                    ...
                    <?php $__currentLoopData = $yayinTipleri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $yayinTipi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $typeSlug = $yayinTipi->slug ?? $yayinTipi->yayin_tipi;
                        ?>
                        <div x-show="activeTab === '<?php echo e($typeSlug); ?>'" x-cloak
                            ...
                            <div class="flex justify-between items-center mb-6">
                                ...
                                <button @click="setPropertyType('<?php echo e($typeSlug); ?>'); showAddFeatureModal = true"
                            ...
                            <?php if($assignments && $assignments->count() > 0): ?>
                                    ...
                                    <?php $__currentLoopData = $assignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-start justify-between mb-4">
                                                ...
                                                <!-- Delete Button -->
                                                <button
                                                    @click="unassignFeature(<?php echo e($yayinTipi->id); ?>, <?php echo e($feature->id); ?>)"
                            ...
                            <?php else: ?>
                                ...
                                <div
                                    ...
                                    <div class="mt-6">
                                        <button
                                            @click="setPropertyType('<?php echo e($typeSlug); ?>'); showAddFeatureModal = true"
...
<?php echo $__env->make('admin.layouts.neo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Projects/yalihanai /resources/views/admin/property-type-manager/field-dependencies.blade.php ENDPATH**/ ?>