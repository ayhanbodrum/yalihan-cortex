        ...
        <div class="p-6">
            ...
            <div class="flex justify-between items-center mb-4">
                ...
                <div class="flex space-x-2">
                    <a href="<?php echo e(route('admin.ozellikler.kategoriler.index')); ?>" class="neo-btn neo-btn-secondary touch-target-optimized">
                        <i class="fas fa-arrow-left mr-2"></i> Kategorilere Dön
                    </a>
                    <a href="<?php echo e(route('admin.ozellikler.features.create')); ?>" class="neo-btn neo-btn-primary touch-target-optimized">
