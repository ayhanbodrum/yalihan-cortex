           ...
           class="group bg-gray-50 dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 border-l-4 border-blue-500 hover:border-blue-600 transform hover:-translate-y-1">
            ...
            <div class="flex items-center mb-4">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <?php if($kategori->yayinTipleri && $kategori->yayinTipleri->count() > 0): ?>
                            • <?php echo e($kategori->yayinTipleri->count()); ?> Yayın Tipi
                        <?php endif; ?>
                    </p>
                </div>
            </div>
            ...
            <div class="mb-3 pt-3 border-t border-gray-200 dark:border-gray-700">
                ...
                <div class="flex flex-wrap gap-2">
                    <?php $__currentLoopData = $kategori->yayinTipleri->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $yayinTipi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <span class="text-xs px-2.5 py-1 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/30 dark:to-emerald-900/30 border border-green-200 dark:border-green-800 rounded-full text-green-700 dark:text-green-300 font-medium flex items-center gap-1">
                            <?php if($yayinTipi->icon): ?>
                                <span><?php echo e($yayinTipi->icon); ?></span>
                            <?php endif; ?>
                            <span><?php echo e($yayinTipi->yayin_tipi); ?></span>
                        </span>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php if($kategori->yayinTipleri->count() > 3): ?>
                        <span class="text-xs px-2.5 py-1 bg-gray-100 dark:bg-gray-800 rounded-full text-gray-600 dark:text-gray-400 font-medium">
                            +<?php echo e($kategori->yayinTipleri->count() - 3); ?> daha
                        </span>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-700">
                <div class="flex items-center gap-3 text-xs text-gray-500 dark:text-gray-400">
                    ...
                    <span class="flex items-center gap-1">
                        ...
                        <?php echo e($kategori->yayinTipleri->count()); ?>
...
<?php echo $__env->make('admin.layouts.neo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Projects/yalihanai /resources/views/admin/property-type-manager/index.blade.php ENDPATH**/ ?>