<?php $__env->startSection('title', 'AI Önerileri - CRM Yönetimi'); ?>
    ...
    <div x-data="crmAI()" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow duration-200 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-2xl font-bold text-blue-800"><?php echo e($stats['toplam_kisi'] ?? 0); ?></h3>
            ...
            <div class="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow duration-200 p-6 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-2xl font-bold text-green-800"><?php echo e($stats['toplam_talep'] ?? 0); ?></h3>
            ...
            <div class="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow duration-200 p-6 bg-gradient-to-r from-purple-50 to-violet-50 border border-purple-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-2xl font-bold text-purple-800"><?php echo e($stats['toplam_eslesme'] ?? 0); ?></h3>
            ...
            <div class="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow duration-200 p-6 bg-gradient-to-r from-orange-50 to-red-50 border border-orange-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-2xl font-bold text-orange-800"><?php echo e($aiOnerileri['eksik_bilgiler'] ?? 0); ?></h3>
                ...
                <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="px-2 py-1 bg-red-100 text-red-800 text-xs font-medium rounded-full">
                            <?php echo e($aiOnerileri['mukerrer_kisiler']->count()); ?> adet
                        </span>
                    </div>
                </div>
                <div class="p-6">
                    <?php if($aiOnerileri['mukerrer_kisiler']->count() > 0): ?>
                        <div class="space-y-3">
                            <?php $__currentLoopData = $aiOnerileri['mukerrer_kisiler']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mukerrer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="p-3 bg-red-50 border border-red-200 rounded-lg">
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <p class="font-medium text-red-800"><?php echo e($mukerrer['email']); ?></p>
                                            <p class="text-sm text-red-600"><?php echo e($mukerrer['sayi']); ?> adet kayıt</p>
                                        </div>
                                        <button @click="fixDuplicate('<?php echo e($mukerrer['email']); ?>')"
                    ...
                    <?php else: ?>
                        <div class="text-center py-8">
                            ...
                            <h3 class="mt-2 text-sm font-medium text-gray-900">Mükerrer kayıt bulunamadı</h3>
                ...
                <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="px-2 py-1 bg-orange-100 text-orange-800 text-xs font-medium rounded-full">
                            <?php echo e($aiOnerileri['eksik_bilgiler']); ?> adet
                        </span>
                    </div>
                </div>
                <div class="p-6">
                ...
                <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="px-2 py-1 bg-yellow-100 text-yellow-800 text-xs font-medium rounded-full">
                            <?php echo e($aiOnerileri['eslesmeyen_talepler']); ?> adet
                        </span>
                    </div>
                </div>
                <div class="p-6">
                ...
                <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="px-2 py-1 bg-green-100 text-green-800 text-xs font-medium rounded-full">
                            <?php echo e($aiOnerileri['yuksek_skorlu_eslesmeler']); ?> adet
                        </span>
                    </div>
                </div>
                <div class="p-6">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow duration-200 p-6">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">AI Analiz Araçları</h3>
            </div>
...
<?php echo $__env->make('admin.layouts.neo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Projects/yalihanemlakwarp/resources/views/admin/crm/index.blade.php ENDPATH**/ ?>