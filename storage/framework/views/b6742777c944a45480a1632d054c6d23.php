    ...
    return {
        ...
        async loadSavedSites() {
            ...
            try {
                ...
                const response = await fetch('<?php echo e(route("admin.wikimapia-search.saved-sites")); ?>', {
                    headers: {
        ...
        async searchPlaces() {
            ...
            try {
                const response = await fetch('<?php echo e(route("admin.wikimapia-search.search")); ?>', {
                    method: 'POST',
                    headers: {
        ...
        async searchNearby() {
            ...
            try {
                const response = await fetch('<?php echo e(route("admin.wikimapia-search.nearby")); ?>', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]')?.content
        ...
        async saveSite(place) {
            ...
            try {
                ...
                const response = await fetch('<?php echo e(route("admin.wikimapia-search.save-site")); ?>', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': csrfToken,
...
<?php echo $__env->make('admin.layouts.neo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Projects/yalihanemlakwarp/resources/views/admin/wikimapia-search/index.blade.php ENDPATH**/ ?>