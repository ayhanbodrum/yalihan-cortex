...
<div x-data="bedroomLayoutManager(<?php echo e(json_encode($ilan->bedroom_layout ?? null)); ?>)" 
                        ...
                        <div class="flex flex-wrap gap-4">
                            ...
                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                <input 
                                    ...
                                    class="w-5 h-5 rounded text-blue-600 focus:ring-2 focus:ring-blue-500">
                                <span class="text-sm text-gray-700 dark:text-gray-300">❄️ Klimalı</span>
                            </label>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /Users/macbookpro/Projects/yalihanemlakwarp/resources/views/admin/ilanlar/components/bedroom-layout-manager.blade.php ENDPATH**/ ?>