<?php $__env->startSection('title', 'Takım Performans Raporu'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-gradient-to-r from-gray-50 to-slate-50 rounded-xl border border-gray-200 shadow-sm mb-8">
        <div class="p-6">
            ...
            <form method="GET" action="<?php echo e(route('admin.takim-yonetimi.takim.performans')); ?>"
                ...
                <div>
                    ...
                    <select style="color-scheme: light dark;"
                        ...
                        name="tarih_araligi">
                        <option value="7" <?php echo e(request('tarih_araligi') == '7' ? 'selected' : ''); ?>>Son 7 Gün</option>
                        <option value="30" <?php echo e(request('tarih_araligi') == '30' ? 'selected' : ''); ?>>Son 30 Gün</option>
                        <option value="90" <?php echo e(request('tarih_araligi') == '90' ? 'selected' : ''); ?>>Son 3 Ay</option>
                        <option value="365" <?php echo e(request('tarih_araligi') == '365' ? 'selected' : ''); ?>>Son 1 Yıl</option>
                        <option value="custom" <?php echo e(request('tarih_araligi') == 'custom' ? 'selected' : ''); ?>>Özel Aralık
                        </option>
                    </select>
                </div>
                <div class="custom-date-field"
                    style="display: <?php echo e(request('tarih_araligi') == 'custom' ? 'block' : 'none'); ?>">
                    ...
                    <input type="date"
                        ...
                        name="baslangic_tarihi" value="<?php echo e(request('baslangic_tarihi')); ?>">
                </div>
                <div class="custom-date-field"
                    style="display: <?php echo e(request('tarih_araligi') == 'custom' ? 'block' : 'none'); ?>">
                    ...
                    <input type="date"
                        class="w-full w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 transition-all duration-200 focus:border-transparent"
                        name="bitis_tarihi" value="<?php echo e(request('bitis_tarihi')); ?>">
                </div>
                <div>
        ...
        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200 shadow-sm p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-blue-900"><?php echo e($genelPerformans['toplam_gorev'] ?? 0); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200 shadow-sm p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-green-900"><?php echo e($genelPerformans['tamamlanan_gorev'] ?? 0); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl border border-orange-200 shadow-sm p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-orange-900"><?php echo e($genelPerformans['devam_eden_gorev'] ?? 0); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-r from-purple-50 to-violet-50 rounded-xl border border-purple-200 shadow-sm p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-purple-900"><?php echo e($genelPerformans['basari_orani'] ?? 0); ?>%</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 performance-table">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__currentLoopData = $rolPerformans ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        ...
                                        <?php echo e(ucfirst(str_replace('_', ' ', $rol['rol']))); ?>

                                    </span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($rol['uye_sayisi']); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($rol['toplam_gorev']); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <?php echo e($rol['tamamlanan_gorev']); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="w-16 bg-gray-200 rounded-full h-2 mr-2">
                                            <div class="bg-gradient-to-r from-green-500 to-emerald-600 h-2 rounded-full transition-all duration-1000"
                                                style="width: <?php echo e($rol['basari_orani']); ?>%"></div>
                                        </div>
                                        <span class="text-sm font-medium text-gray-900"><?php echo e($rol['basari_orani']); ?>%</span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <?php echo e($rol['ortalama_sure'] ?? 'N/A'); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                    <?php if($rol['performans_skoru'] >= 80): ?> bg-green-100 text-green-800 border border-green-200
                                    <?php elseif($rol['performans_skoru'] >= 60): ?> bg-yellow-100 text-yellow-800 border border-yellow-200
                                    <?php else: ?> bg-red-100 text-red-800 border border-red-200 <?php endif; ?>">
                                        <?php echo e($rol['performans_skoru']); ?>/100
                                    </span>
                                </td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        <div class="bg-gradient-to-r from-yellow-50 to-amber-50 rounded-xl border border-yellow-200 shadow-sm p-6">
            ...
            <?php if(isset($enIyiPerformans) && count($enIyiPerformans) > 0): ?>
                <?php $__currentLoopData = $enIyiPerformans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $uye): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div
                        ...
                        <div class="flex items-center">
                            <div class="flex-shrink-0 mr-4">
                                ...
                                <?php else: ?>
                                    <span
                                        class="inline-flex items-center justify-center w-10 h-10 bg-gradient-to-r from-blue-400 to-indigo-500 rounded-full text-white font-bold text-sm"><?php echo e($index + 1); ?></span>
                                <?php endif; ?>
                            </div>
                            <div>
                                <h6 class="font-semibold text-gray-900"><?php echo e($uye['user_name']); ?></h6>
                                <p class="text-sm text-gray-600"><?php echo e(ucfirst(str_replace('_', ' ', $uye['rol']))); ?></p>
                            </div>
                        </div>
                        <div class="text-right">
                            <div class="font-bold text-lg text-yellow-700"><?php echo e($uye['performans_skoru']); ?>/100</div>
                            <p class="text-sm text-gray-600"><?php echo e($uye['tamamlanan_gorev']); ?> görev</p>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php else: ?>
        ...
        <div class="bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl border border-orange-200 shadow-sm p-6">
            ...
            <?php if(isset($gorevTipiAnalizi) && count($gorevTipiAnalizi) > 0): ?>
                <?php $__currentLoopData = $gorevTipiAnalizi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="mb-4">
                        <div class="flex justify-between items-center mb-2">
                            <span
                                class="text-sm font-medium text-orange-700"><?php echo e(ucfirst(str_replace('_', ' ', $tip['tip']))); ?></span>
                            <span class="text-sm font-semibold text-orange-900"><?php echo e($tip['sayi']); ?></span>
                        </div>
                        <div class="w-full bg-orange-200 rounded-full h-3">
                            <div class="bg-gradient-to-r from-orange-500 to-amber-600 h-3 rounded-full transition-all duration-1000"
                                style="width: <?php echo e($tip['yuzde']); ?>%"></div>
                        </div>
                        <div class="text-right mt-1">
                            <span class="text-xs text-orange-600"><?php echo e($tip['yuzde']); ?>%</span>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php else: ?>
    ...
    <div class="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow duration-200">
        <div class="p-6">
            ...
            <?php if(isset($detayliPerformans) && count($detayliPerformans) > 0): ?>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 performance-table">
                        <thead class="bg-gray-50">
                            <tr>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__currentLoopData = $detayliPerformans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uye): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                <div class="text-sm font-medium text-gray-900"><?php echo e($uye['user_name']); ?>

                                                </div>
                                                <div class="text-sm text-gray-500"><?php echo e($uye['user_email']); ?></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php echo $uye['rol_etiketi']; ?>

                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        <?php echo e($uye['toplam_gorev']); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800 border border-green-200">
                                            <?php echo e($uye['tamamlanan_gorev']); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            ...
                                            <?php echo e($uye['devam_eden_gorev']); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="w-16 bg-gray-200 rounded-full h-2 mr-2">
                                                <div class="bg-gradient-to-r from-green-500 to-emerald-600 h-2 rounded-full transition-all duration-1000"
                                                    style="width: <?php echo e($uye['basari_orani']); ?>%"></div>
                                            </div>
                                            <span
                                                class="text-sm font-medium text-gray-900"><?php echo e($uye['basari_orani']); ?>%</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        <?php echo e($uye['ortalama_sure'] ?? 'N/A'); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                        <?php if($uye['performans_skoru'] >= 80): ?> bg-green-100 text-green-800 border border-green-200
                                        <?php elseif($uye['performans_skoru'] >= 60): ?> bg-yellow-100 text-yellow-800 border border-yellow-200
                                        <?php else: ?> bg-red-100 text-red-800 border border-red-200 <?php endif; ?>">
                                            <?php echo e($uye['performans_skoru']); ?>/100
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php if($uye['trend'] == 'up'): ?>
    ...
    <script>
        ...
        function generateContext7Analysis() {
            const performanceData = {
                totalTasks: <?php echo e($genelPerformans['toplam_gorev'] ?? 0); ?>,
                completedTasks: <?php echo e($genelPerformans['tamamlanan_gorev'] ?? 0); ?>,
                successRate: <?php echo e($genelPerformans['basari_orani'] ?? 0); ?>,
                period: '<?php echo e(request('tarih_araligi', '30')); ?>'
            };
        ...
        const trendChart = new Chart(trendCtx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: <?php echo json_encode($chartData['tamamlanan'] ?? []); ?>,
                    ...
                    data: <?php echo json_encode($chartData['toplam'] ?? []); ?>,
        ...
        const statusChart = new Chart(statusCtx, {
            type: 'doughnut',
            data: {
                labels: <?php echo json_encode($chartData['status_labels'] ?? []); ?>,
                datasets: [{
                    data: <?php echo json_encode($chartData['status_data'] ?? []); ?>,
                    backgroundColor: [
...
<?php echo $__env->make('admin.layouts.neo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Projects/yalihanemlakwarp/resources/views/admin/takim-yonetimi/takim/performans.blade.php ENDPATH**/ ?>