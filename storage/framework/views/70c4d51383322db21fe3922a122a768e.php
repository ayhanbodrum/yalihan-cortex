    ...
    <div class="p-6">
        ...
        <div class=" mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Takım Yönetimi</h1>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.context7.button','data' => ['variant' => 'secondary','onclick' => 'uyeEkleModal()']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'secondary','onclick' => 'uyeEkleModal()']); ?>
...
<?php endif; ?>
                    <?php if (isset($component)) { $__componentOriginala617200b50274ed6f8aea665be4d256e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala617200b50274ed6f8aea665be4d256e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.context7.button','data' => ['variant' => 'secondary','href' => ''.e(route('admin.takim-yonetimi.takim.performans')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('context7.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'secondary','href' => ''.e(route('admin.takim-yonetimi.takim.performans')).'']); ?>
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<?php endif; ?>
                    <?php if (isset($component)) { $__componentOriginala617200b50274ed6f8aea665be4d256e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala617200b50274ed6f8aea665be4d256e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.context7.button','data' => ['variant' => 'primary','href' => ''.e(route('admin.takim-yonetimi.takim.takim-performans')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('context7.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'primary','href' => ''.e(route('admin.takim-yonetimi.takim.takim-performans')).'']); ?>
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<?php endif; ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <?php if (isset($component)) { $__componentOriginaldde76bc1ac8e43530beb4a80f9cd1dfe = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldde76bc1ac8e43530beb4a80f9cd1dfe = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.context7.card','data' => ['variant' => 'gradient']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('context7.card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'gradient']); ?>
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="stat-card-value dark:text-gray-100">
                            <?php echo e($istatistikler['toplam_uye'] ?? 0); ?></p>
                    </div>
                </div>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginaldde76bc1ac8e43530beb4a80f9cd1dfe)): ?>
<?php $attributes = $__attributesOriginaldde76bc1ac8e43530beb4a80f9cd1dfe; ?>
<?php unset($__attributesOriginaldde76bc1ac8e43530beb4a80f9cd1dfe); ?>
<?php endif; ?>
<?php if (isset($__componentOriginaldde76bc1ac8e43530beb4a80f9cd1dfe)): ?>
<?php $component = $__componentOriginaldde76bc1ac8e43530beb4a80f9cd1dfe; ?>
<?php unset($__componentOriginaldde76bc1ac8e43530beb4a80f9cd1dfe); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['variant' => 'gradient']); ?>
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="stat-card-value dark:text-gray-100">
                            <?php echo e($istatistikler['status_uye'] ?? 0); ?></p>
                    </div>
                </div>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['variant' => 'gradient']); ?>
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-yellow-900"><?php echo e($istatistikler['toplam_gorev'] ?? 0); ?></p>
                    </div>
                </div>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <div class="bg-gradient-to-r from-purple-50 to-violet-50 rounded-xl border border-purple-200 shadow-sm p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-purple-900"><?php echo e($istatistikler['ortalama_performans'] ?? 0); ?>%</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-gradient-to-r from-gray-50 to-slate-50 rounded-xl border border-gray-200 shadow-sm p-6 mb-8">
        ...
        <form method="GET" action="<?php echo e(route('admin.takim-yonetimi.takim.index')); ?>"
            ...
            <div class="form-field">
                <select style="color-scheme: light dark;" class="admin-input transition-all duration-200" name="rol">
                    ...
                    <?php $__currentLoopData = ['admin', 'danisman', 'alt_kullanici', 'musteri_temsilcisi']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($rol); ?>" <?php echo e(request('rol') == $rol ? 'selected' : ''); ?>>
                            <?php echo e(ucfirst(str_replace('_', ' ', $rol))); ?>
            ...
            <div class="form-field">
                <select style="color-scheme: light dark;" class="admin-input transition-all duration-200" name="status">
                    ...
                    <?php $__currentLoopData = ['active', 'pasif', 'izinli', 'tatilde']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $statusOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="form-field">
                <select style="color-scheme: light dark;" class="admin-input transition-all duration-200" name="lokasyon">
                    ...
                    <?php $__currentLoopData = $lokasyonlar ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lokasyon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($lokasyon); ?>" <?php echo e(request('lokasyon') == $lokasyon ? 'selected' : ''); ?>>
                            <?php echo e($lokasyon); ?>
    ...
    <div class="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow duration-200">
        <div class="p-6 border-b border-gray-200">
            <div class="flex justify-between items-center">
                <h2 class="text-xl font-bold text-gray-800">Takım Üyeleri (<?php echo e($takimUyeleri->count()); ?>)</h2>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__currentLoopData = $takimUyeleri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uye): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <input type="checkbox" class="item-checkbox form-checkbox"
                                        value="<?php echo e($uye->id); ?>">
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div
                                            class="w-10 h-10 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-full flex items-center justify-center mr-3">
                                            <?php if($uye->user && $uye->user->profile_photo_url): ?>
                                                <img class="w-10 h-10 rounded-full object-cover"
                                                    src="<?php echo e($uye->user->profile_photo_url); ?>"
                                                    alt="<?php echo e($uye->user->name); ?>">
                                            <?php else: ?>
                                        ...
                                        <div>
                                            <div class="text-sm font-medium text-gray-900">
                                                <?php echo e($uye->user->name ?? 'Bilinmeyen Kullanıcı'); ?></div>
                                            <div class="text-sm text-gray-500"><?php echo e($uye->user->email ?? 'Email yok'); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        ...
                                        <?php if($uye->rol == 'admin'): ?> bg-red-100 text-red-800 border border-red-200
                                        <?php elseif($uye->rol == 'danisman'): ?> bg-blue-100 text-blue-800 border border-blue-200
                                        <?php elseif($uye->rol == 'musteri_temsilcisi'): ?> bg-green-100 text-green-800 border border-green-200
                                        <?php else: ?> bg-gray-100 text-gray-800 border border-gray-200 <?php endif; ?>">
                                        <?php echo e(ucfirst(str_replace('_', ' ', $uye->rol))); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                        <?php if($uye->status == 'active'): ?> bg-green-100 text-green-800 border border-green-200
                                        <?php elseif($uye->status == 'pasif'): ?> bg-red-100 text-red-800 border border-red-200
                                        <?php elseif($uye->status == 'izinli'): ?> bg-yellow-100 text-yellow-800 border border-yellow-200
                                        <?php else: ?> bg-gray-100 text-gray-800 border border-gray-200 <?php endif; ?>">
                                        <?php echo e(ucfirst($uye->status)); ?>

                                    </span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <?php echo e($uye->lokasyon ?? 'Belirtilmemiş'); ?>
                                    ...
                                    <div class="flex items-center">
                                        <div class="w-16 bg-gray-200 rounded-full h-2 mr-2">
                                            <div class="bg-gradient-to-r from-green-400 to-blue-500 h-2 rounded-full transition-all duration-1000"
                                                style="width: <?php echo e($uye->performans ?? 0); ?>%"></div>
                                        </div>
                                        <span class="text-sm text-gray-600"><?php echo e($uye->performans ?? 0); ?>%</span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <?php echo e($uye->son_aktivite ? $uye->son_aktivite->diffForHumans() : 'Hiç aktivite yok'); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center space-x-2">
                                        <a href="<?php echo e(route('admin.takim-yonetimi.takim.show', $uye->id)); ?>"
                                        ...
                                        <a href="<?php echo e(route('admin.takim-yonetimi.takim.edit', $uye->id)); ?>"
                                        ...
                                        <button type="button" class="text-red-600 hover:text-red-900"
                                            onclick="uyeCikar(<?php echo e($uye->id); ?>)">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div id="uyeEkleModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-lg bg-white">
            <div class="mt-3">
                <h3 class="text-lg font-medium text-gray-900 mb-4">Yeni Takım Üyesi Ekle</h3>
                <form id="uyeEkleForm" method="POST" action="<?php echo e(route('admin.takim-yonetimi.takim.uye-ekle')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="space-y-4">
                        <div class="form-field">
                            ...
                            <select style="color-scheme: light dark;" name="user_id" class="admin-input transition-all duration-200" required>
                                ...
                                <?php $__currentLoopData = $kullanicilar ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kullanici): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($kullanici->id); ?>"><?php echo e($kullanici->name); ?>

                                        (<?php echo e($kullanici->email); ?>)
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
    ...
    <script>
        ...
        function uyeCikar(uyeId) {
            if (confirm('Bu üyeyi takımdan çıkarmak istediğinizden emin misiniz?')) {
                fetch('<?php echo e(route('admin.takim-yonetimi.takim.uye-cikar')); ?>', {
                        method: 'POST',
                        headers: {
...
<?php echo $__env->make('admin.layouts.neo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Projects/yalihanemlakwarp/resources/views/admin/takim-yonetimi/takim/index.blade.php ENDPATH**/ ?>