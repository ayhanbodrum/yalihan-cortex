<?php $__env->startSection('title', 'Danışman Yönetimi'); ?>
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
            <a href="<?php echo e(route('admin.danisman.create')); ?>" class="neo-btn neo-btn-primary">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="neo-card p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <h3 class="text-2xl font-bold text-blue-600"><?php echo e($istatistikler['toplam_danisman'] ?? 0); ?></h3>
        ...
        <div class="neo-card p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <h3 class="text-2xl font-bold text-green-600"><?php echo e($istatistikler['status_danisman'] ?? 0); ?></h3>
        ...
        <div class="neo-card p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <h3 class="text-2xl font-bold text-purple-600"><?php echo e($istatistikler['online_danisman'] ?? 0); ?></h3>
        ...
        <div class="neo-card p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <h3 class="text-2xl font-bold text-orange-600">%<?php echo e(number_format($istatistikler['ortalama_performans'] ?? 0, 1)); ?></h3>
    ...
    <!-- Filtreler -->
    <div class="neo-card p-6">
        <form method="GET" action="<?php echo e(route('admin.danisman.index')); ?>">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div>
                    ...
                    <select style="color-scheme: light dark;" name="status" class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 transition-all duration-200">
                        ...
                        <option value="1" <?php echo e(($filters['status'] ?? '') == '1' ? 'selected' : ''); ?>>Aktif</option>
                        <option value="0" <?php echo e(($filters['status'] ?? '') == '0' ? 'selected' : ''); ?>>Pasif</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select style="color-scheme: light dark;" name="online" class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 transition-all duration-200">
                        <option value="">Tümü</option>
                        <option value="Online" <?php echo e(($filters['online'] ?? '') === 'Online' ? 'selected' : ''); ?>>Online</option>
                        <option value="Offline" <?php echo e(($filters['online'] ?? '') === 'Offline' ? 'selected' : ''); ?>>Offline</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select style="color-scheme: light dark;" name="sort" class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 transition-all duration-200">
                        <option value="created_desc" <?php echo e(($filters['sort'] ?? '') === 'created_desc' ? 'selected' : ''); ?>>En Yeni</option>
                        <option value="created_asc" <?php echo e(($filters['sort'] ?? '') === 'created_asc' ? 'selected' : ''); ?>>En Eski</option>
                        <option value="name_asc" <?php echo e(($filters['sort'] ?? '') === 'name_asc' ? 'selected' : ''); ?>>Ad (A-Z)</option>
                        <option value="name_desc" <?php echo e(($filters['sort'] ?? '') === 'name_desc' ? 'selected' : ''); ?>>Ad (Z-A)</option>
                    </select>
                </div>
            </div>

            <div class="flex justify-end gap-3 mt-4">
                <a href="<?php echo e(route('admin.danisman.index')); ?>" class="neo-btn neo-btn-secondary">Temizle</a>
    ...
    <div class="neo-card">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <span class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($danismanlar->total()); ?> danışman</span>
                <button type="button" onclick="exportDanismanCsv()" class="neo-btn neo-btn-sm neo-btn-secondary">CSV İndir</button>
            </div>
        </div>

        <div class="p-6">
            <?php if($danismanlar->count() > 0): ?>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10">
                                            <?php if($danisman->profile_photo && file_exists(storage_path('app/public/' . $danisman->profile_photo))): ?>
                                                <img class="h-10 w-10 rounded-full object-cover"
                                                     src="<?php echo e(asset('storage/' . $danisman->profile_photo)); ?>"
                                                     alt="<?php echo e($danisman->name); ?>">
                                            <?php else: ?>
                                                <div class="h-10 w-10 rounded-full bg-gradient-to-r from-purple-500 to-pink-600 flex items-center justify-center text-white font-semibold">
                                                    <?php echo e(strtoupper(substr($danisman->name, 0, 2))); ?>

                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        <div class="ml-4">
                                            <div class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($danisman->name); ?></div>
                                            <div class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($danisman->email); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-sm text-gray-900 dark:text-white">
                                    <?php echo e($danisman->phone_number ?? '-'); ?>

                                </td>
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-900 dark:text-white"><?php echo e($danisman->title ?? 'Danışman'); ?></div>
                                    <div class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($danisman->uzmanlik_alani ?? 'Genel'); ?></div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <div class="flex-1 bg-gray-200 dark:bg-gray-800 rounded-full h-2 mr-2">
                                            <div class="bg-gradient-to-r from-green-400 to-green-600 h-2 rounded-full"
                                                 style="width: <?php echo e($danisman->is_verified ? 100 : 50); ?>%"></div>
                                        </div>
                                        <span class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($danisman->is_verified ? '100' : '50'); ?>%</span>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.neo.status-badge','data' => ['value' => $danisman->status ? 'Aktif' : 'Pasif']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($danisman->status ? 'Aktif' : 'Pasif')]); ?>
...
<?php endif; ?>
                                        <?php if($danisman->last_activity_at && $danisman->last_activity_at->isAfter(now()->subMinutes(5))): ?>
                                            <?php if (isset($component)) { $__componentOriginal9e089bc5f8eac272c2c5ae05d84c4b58 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9e089bc5f8eac272c2c5ae05d84c4b58 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.neo.status-badge','data' => ['value' => 'Online','category' => 'info']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('neo.status-badge'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['value' => 'Online','category' => 'info']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal9e089bc5f8eac272c2c5ae05d84c4b58)): ?>
<?php $attributes = $__attributesOriginal9e089bc5f8eac272c2c5ae05d84c4b58; ?>
...
<?php endif; ?>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">
                                    <?php echo e($danisman->created_at?->format('d.m.Y') ?? '-'); ?>

                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <a href="<?php echo e(route('admin.danisman.show', $danisman)); ?>"
                                        ...
                                        <a href="<?php echo e(route('admin.danisman.edit', $danisman)); ?>"
                ...
                <div class="mt-6">
                    <?php echo e($danismanlar->appends(request()->query())->links()); ?>
...
<?php echo $__env->make('admin.layouts.neo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Projects/yalihanemlakwarp/resources/views/admin/danisman/index.blade.php ENDPATH**/ ?>