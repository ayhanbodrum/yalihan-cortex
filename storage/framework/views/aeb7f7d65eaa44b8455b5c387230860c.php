                ...
                <div class="relative">
                    <select name="il_id"
                        ...
                        <?php $__currentLoopData = $iller; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $il): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($il->id); ?>"><?php echo e($il->name ?? $il->il_adi); ?></option>
            ...
            <div class="relative">
                <textarea
                    ...
                    class="w-full px-4 py-2.5 pr-12
                           ...
                           hover:border-gray-400 dark:hover:border-gray-500
                           resize-y min-h-[80px]
                           shadow-sm hover:shadow-md focus:shadow-lg"><?php echo e(old('adres')); ?></textarea>
...
<?php /**PATH /Users/macbookpro/Projects/yalihanemlakwarp/resources/views/admin/ilanlar/components/location-map.blade.php ENDPATH**/ ?>