        ...
        <script>
            function addressManager() {
                return {
                    ...
                    async loadUlkeler() {
                        try {
                            const response = await fetch('<?php echo e(route('admin.adres-yonetimi.ulkeler')); ?>');
                    ...
                    async loadIller() {
                        try {
                            const response = await fetch('<?php echo e(route('admin.adres-yonetimi.iller')); ?>');
                            const data = await response.json();
                            if (data.success) {
            ...
            `).join('');
                    ...
                    async selectUlke(ulkeId) {
                        ...
                        try {
                            const response = await fetch(`<?php echo e(route('admin.adres-yonetimi.iller.by-ulke', '')); ?>/${ulkeId}`);
                            const data = await response.json();
                            if (data.success) {
                                this.iller = data.iller;
                                this.renderIller();
            ...
            `).join('');
                    ...
                    async selectIl(ilId) {
                        ...
                        try {
                            const response = await fetch(`<?php echo e(route('admin.adres-yonetimi.ilceler.by-il', '')); ?>/${ilId}`);
                            const data = await response.json();
                            if (data.success) {
                    ...
                    async selectIlce(ilceId) {
                        ...
                        try {
                            const response = await fetch(
                                `<?php echo e(route('admin.adres-yonetimi.mahalleler.by-ilce', '')); ?>/${ilceId}`);
                            const data = await response.json();
                            if (data.success) {
...
<?php echo $__env->make('admin.layouts.neo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Projects/yalihanemlakwarp/resources/views/admin/adres-yonetimi/index.blade.php ENDPATH**/ ?>