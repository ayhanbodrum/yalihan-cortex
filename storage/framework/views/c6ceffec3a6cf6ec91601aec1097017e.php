<?php $__env->startSection('title', 'AI Ayarları'); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/admin/ai-settings/core.js']); ?>
<?php $__env->stopPush(); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form method="POST" action="<?php echo e(route('admin.ai-settings.update')); ?>" class="space-y-8" x-data="{ loading: false }"
            @submit="loading = true">
            <?php echo csrf_field(); ?>
            ...
            <div class="neo-card border-l-4 border-blue-500 overflow-hidden hover:shadow-xl transition-all duration-300">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <?php $__currentLoopData = ['google' => ['name' => '🧠 Google Gemini', 'desc' => 'Hızlı ve güçlü', 'badge' => 'Önerilen'], 'openai' => ['name' => '🤖 OpenAI GPT', 'desc' => 'Yaratıcı ve akıllı', 'badge' => 'Popüler'], 'anthropic' => ['name' => '🎭 Anthropic Claude', 'desc' => 'Güvenli ve etik', 'badge' => 'Güvenli'], 'deepseek' => ['name' => '🔍 DeepSeek', 'desc' => 'Araştırma odaklı', 'badge' => 'Yeni'], 'ollama' => ['name' => '🏠 Ollama Local', 'desc' => 'Gizlilik odaklı, offline AI', 'badge' => 'Güvenli']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $provider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div
                                class="provider-option relative <?php echo e(($statistics['active_provider'] ?? '') === $key ? 'selected' : ''); ?>">
                                <input type="radio" name="ai_provider" id="provider_<?php echo e($key); ?>"
                                    value="<?php echo e($key); ?>"
                                    <?php echo e(($statistics['active_provider'] ?? '') === $key ? 'checked' : ''); ?>

                                    class="peer sr-only">
                                <label for="provider_<?php echo e($key); ?>"
                                    ...
                                    <div class="flex items-center justify-between mb-2">
                                        <div class="text-lg font-medium text-gray-900 dark:text-white">
                                            <?php echo e($provider['name']); ?></div>
                                        <span
                                            class="px-2 py-1 text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-200 rounded-full"><?php echo e($provider['badge']); ?></span>
                                    </div>
                                    <div class="text-sm text-gray-500 dark:text-gray-400 mb-3"><?php echo e($provider['desc']); ?>

                                    </div>
                                    <div class="flex items-center gap-2 text-sm" id="<?php echo e($key); ?>-status">
                                        ...
                                        <button type="button" data-provider="<?php echo e($key); ?>"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="password" name="google_api_key" id="google_api_key"
                                        value="<?php echo e(old('google_api_key', $settings['google_api_key'] ?? '')); ?>"
                                        class="w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white <?php echo e($errors->has('google_api_key') ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'); ?>"
                                        placeholder="AIzaSy...">
                                ...
                                <div>
                                    ...
                                    <select style="color-scheme: light dark;" name="google_model" id="google_model"
                                        ...
                                        <option value="gemini-pro"
                                            <?php echo e(($settings['google_model'] ?? 'gemini-pro') === 'gemini-pro' ? 'selected' : ''); ?>>
                                            Gemini Pro</option>
                                        <option value="gemini-pro-vision"
                                            <?php echo e(($settings['google_model'] ?? '') === 'gemini-pro-vision' ? 'selected' : ''); ?>>
                                            Gemini Pro Vision</option>
                                        <option value="gemini-1.5-pro"
                                            <?php echo e(($settings['google_model'] ?? '') === 'gemini-1.5-pro' ? 'selected' : ''); ?>>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="password" name="openai_api_key" id="openai_api_key"
                                        value="<?php echo e(old('openai_api_key', $settings['openai_api_key'] ?? '')); ?>"
                                        class="w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white <?php echo e($errors->has('openai_api_key') ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'); ?>"
                                        placeholder="sk-...">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <select style="color-scheme: light dark;" name="openai_model" id="openai_model"
                                        class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white transition-all duration-200">
                                        <option value="gpt-4"
                                            <?php echo e(($settings['openai_model'] ?? 'gpt-4') === 'gpt-4' ? 'selected' : ''); ?>>
                                            GPT-4</option>
                                        <option value="gpt-4-turbo"
                                            <?php echo e(($settings['openai_model'] ?? '') === 'gpt-4-turbo' ? 'selected' : ''); ?>>
                                            GPT-4 Turbo</option>
                                        <option value="gpt-3.5-turbo"
                                            <?php echo e(($settings['openai_model'] ?? '') === 'gpt-3.5-turbo' ? 'selected' : ''); ?>>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="password" name="claude_api_key" id="claude_api_key"
                                        value="<?php echo e(old('claude_api_key', $settings['claude_api_key'] ?? '')); ?>"
                                        class="w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white <?php echo e($errors->has('claude_api_key') ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'); ?>"
                                        placeholder="sk-ant-...">
                                    <?php $__errorArgs = ['claude_api_key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                ...
                                <div>
                                    ...
                                    <select style="color-scheme: light dark;" name="claude_model" id="claude_model"
                                        ...
                                        <option value="claude-3-opus-20240229"
                                            <?php echo e(($settings['claude_model'] ?? 'claude-3-opus-20240229') === 'claude-3-opus-20240229' ? 'selected' : ''); ?>>
                                            Claude 3 Opus</option>
                                        <option value="claude-3-sonnet-20240229"
                                            <?php echo e(($settings['claude_model'] ?? '') === 'claude-3-sonnet-20240229' ? 'selected' : ''); ?>>
                                            Claude 3 Sonnet</option>
                                        <option value="claude-3-haiku-20240307"
                                            <?php echo e(($settings['claude_model'] ?? '') === 'claude-3-haiku-20240307' ? 'selected' : ''); ?>>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="password" name="deepseek_api_key" id="deepseek_api_key"
                                        value="<?php echo e(old('deepseek_api_key', $settings['deepseek_api_key'] ?? '')); ?>"
                                        class="w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white <?php echo e($errors->has('deepseek_api_key') ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'); ?>"
                                        placeholder="sk-...">
                                    <?php $__errorArgs = ['deepseek_api_key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                ...
                                <div>
                                    ...
                                    <select style="color-scheme: light dark;" name="deepseek_model" id="deepseek_model"
                                        ...
                                        <option value="deepseek-chat"
                                            <?php echo e(($settings['deepseek_model'] ?? 'deepseek-chat') === 'deepseek-chat' ? 'selected' : ''); ?>>
                                            DeepSeek Chat</option>
                                        <option value="deepseek-coder"
                                            <?php echo e(($settings['deepseek_model'] ?? '') === 'deepseek-coder' ? 'selected' : ''); ?>>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="url" name="ollama_url" id="ollama_url"
                                        value="<?php echo e(old('ollama_url', $settings['ollama_url'] ?? 'http://localhost:11434')); ?>"
                                        class="w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white <?php echo e($errors->has('ollama_url') ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'); ?>"
                                        placeholder="http://localhost:11434">
                                    <?php $__errorArgs = ['ollama_url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                ...
                                <div>
                                    ...
                                    <select style="color-scheme: light dark;" name="ollama_model" id="ollama_model"
                                        ...
                                        <option value="qwen2.5:3b"
                                            <?php echo e(($settings['ollama_model'] ?? 'qwen2.5:3b') === 'qwen2.5:3b' ? 'selected' : ''); ?>>
                                            Qwen2.5 3B (Aktif)</option>
                                        <option value="qwen2.5:latest"
                                            <?php echo e(($settings['ollama_model'] ?? '') === 'qwen2.5:latest' ? 'selected' : ''); ?>>
                                            Qwen2.5 Latest</option>
                                        <option value="gemma2:2b"
                                            <?php echo e(($settings['ollama_model'] ?? '') === 'gemma2:2b' ? 'selected' : ''); ?>>
                                            Gemma2 2B</option>
                                        <option value="phi3:mini"
                                            <?php echo e(($settings['ollama_model'] ?? '') === 'phi3:mini' ? 'selected' : ''); ?>>
                                            Phi3 Mini</option>
                                        <option value="nomic-embed-text:latest"
                                            <?php echo e(($settings['ollama_model'] ?? '') === 'nomic-embed-text:latest' ? 'selected' : ''); ?>>
                                            Nomic Embed Text (Embedding)</option>
                                        <option value="llama2"
                                            <?php echo e(($settings['ollama_model'] ?? '') === 'llama2' ? 'selected' : ''); ?>>
                                            Llama 2</option>
                                        <option value="llama3"
                                            <?php echo e(($settings['ollama_model'] ?? '') === 'llama3' ? 'selected' : ''); ?>>Llama 3
                                        </option>
                                        <option value="mistral"
                                            <?php echo e(($settings['ollama_model'] ?? '') === 'mistral' ? 'selected' : ''); ?>>Mistral
                                        </option>
                                        <option value="codellama"
                                            <?php echo e(($settings['ollama_model'] ?? '') === 'codellama' ? 'selected' : ''); ?>>
                                            CodeLlama</option>
                                    </select>
                                </div>
                            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select class="transition-all duration-200" style="color-scheme: light dark;" name="ai_default_tone" id="ai_default_tone"
                            class="w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white <?php echo e($errors->has('ai_default_tone') ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'); ?>">
                            <option value="">Ton Seçiniz</option>
                            <option value="seo" <?php echo e(($settings['ai_default_tone'] ?? '') === 'seo' ? 'selected' : ''); ?>>
                                📊 SEO Odaklı</option>
                            <option value="kurumsal"
                                <?php echo e(($settings['ai_default_tone'] ?? '') === 'kurumsal' ? 'selected' : ''); ?>>🏢 Kurumsal
                            </option>
                            <option value="hizli_satis"
                                <?php echo e(($settings['ai_default_tone'] ?? '') === 'hizli_satis' ? 'selected' : ''); ?>>⚡ Hızlı
                                Satış
                            </option>
                            <option value="luks"
                                <?php echo e(($settings['ai_default_tone'] ?? '') === 'luks' ? 'selected' : ''); ?>>
                                💎 Lüks</option>
                        </select>
                        <?php $__errorArgs = ['ai_default_tone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" name="ai_default_variant_count" id="ai_default_variant_count"
                            min="1" max="5"
                            value="<?php echo e(old('ai_default_variant_count', $settings['ai_default_variant_count'] ?? 3)); ?>"
                            class="w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white <?php echo e($errors->has('ai_default_variant_count') ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'); ?>"
                            placeholder="1-5 arası">
                        <?php $__errorArgs = ['ai_default_variant_count'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="checkbox" name="ai_default_ab_test" value="1"
                            <?php echo e($settings['ai_default_ab_test'] ?? false ? 'checked' : ''); ?>
        ...
        <div class="neo-card border-l-4 border-purple-500 mt-8">
            ...
            <div class="p-6">
                ...
                <div class="space-y-3">
                    ...
                    <?php $__currentLoopData = ['google' => 'Google Gemini', 'openai' => 'OpenAI GPT', 'anthropic' => 'Claude', 'deepseek' => 'DeepSeek']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-3 h-3 bg-<?php echo e($key === 'google' ? 'blue' : ($key === 'openai' ? 'green' : ($key === 'anthropic' ? 'purple' : 'red'))); ?>-500 rounded-full">
                                </div>
                                <span class="font-medium text-gray-900 dark:text-white"><?php echo e($name); ?></span>
                            </div>
                            <div class="flex items-center gap-4">
                                <div class="text-sm text-gray-600 dark:text-gray-400">
                                    <span id="<?php echo e($key); ?>-usage-count">-</span> istek
                                </div>
                                <div class="w-24 bg-gray-200 dark:bg-gray-600 rounded-full h-2">
                                    <div id="<?php echo e($key); ?>-usage-bar"
                                        class="bg-<?php echo e($key === 'google' ? 'blue' : ($key === 'openai' ? 'green' : ($key === 'anthropic' ? 'purple' : 'red'))); ?>-500 h-2 rounded-full"
                                        style="width: 0%"></div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('admin.layouts.neo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Projects/yalihanemlakwarp/resources/views/admin/ai-settings/index.blade.php ENDPATH**/ ?>