<?php $__env->startSection('title', 'Portföy - Yalıhan Emlak'); ?>
...
<div class="container-fluid py-5">
    ...
    <div class="row mb-5">
        <div class="col-md-3 mb-4">
            <div class="stats-card">
                <div class="stats-number"><?php echo e($stats['total_properties'] ?? 0); ?></div>
                <div class="stats-label">Toplam İlan</div>
            </div>
        </div>
        <div class="col-md-3 mb-4">
            <div class="stats-card">
                <div class="stats-number"><?php echo e($stats['active_properties'] ?? 0); ?></div>
                <div class="stats-label">Aktif İlan</div>
            </div>
        </div>
        <div class="col-md-3 mb-4">
            <div class="stats-card">
                <div class="stats-number"><?php echo e($stats['total_value'] ?? 0); ?></div>
                <div class="stats-label">Toplam Değer (M₺)</div>
            </div>
        </div>
        <div class="col-md-3 mb-4">
            <div class="stats-card">
                <div class="stats-number"><?php echo e($stats['locations'] ?? 0); ?></div>
    ...
    <div class="row" id="portfolio-grid">
        ...
        <div class="col-lg-4 col-md-6 mb-4 portfolio-item" 
             data-type="<?php echo e($property->ilan_turu ?? 'satilik'); ?>" 
             data-category="<?php echo e($property->emlak_turu ?? 'daire'); ?>"
             data-location="<?php echo e(strtolower($property->il_adi ?? '')); ?>">
            <div class="portfolio-card">
                <!-- Property Image -->
                <div class="portfolio-image" 
                     style="background-image: url('<?php echo e($property->featured_image ?? '/images/default-property.jpg'); ?>')">
                    <div class="portfolio-badge bg-success">
                        <?php echo e(ucfirst($property->ilan_turu ?? 'Satılık')); ?>
                ...
                <div class="p-4">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <div>
                            <h5 class="fw-bold mb-1"><?php echo e($property->baslik ?? 'Başlık Yok'); ?></h5>
                            <p class="text-muted mb-0">
                                <i class="fas fa-map-marker-alt me-1"></i>
                                <?php echo e($property->il_adi ?? ''); ?>, <?php echo e($property->ilce_adi ?? ''); ?>

                            </p>
                        </div>
                        <div class="price-tag">
                            <?php echo e(number_format($property->fiyat ?? 0, 0, ',', '.')); ?> ₺
                        </div>
                    </div>
                    ...
                    <div class="row text-center mb-3">
                        <div class="col-4">
                            <div class="border-end">
                                <div class="fw-bold"><?php echo e($property->brut_metrekare ?? '-'); ?></div>
                                <small class="text-muted">m²</small>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="border-end">
                                <div class="fw-bold"><?php echo e($property->oda_sayisi ?? '-'); ?></div>
                                <small class="text-muted">Oda</small>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="fw-bold"><?php echo e($property->banyo_sayisi ?? '-'); ?></div>
                    ...
                    <div class="d-grid gap-2">
                        <a href="<?php echo e(route('frontend.property.detail', $property->id)); ?>" 
                           class="btn neo-btn neo-btn-primary">
                            <i class="fas fa-eye me-2"></i>Detayları Gör
                        </a>
                        <button class="btn btn-outline-primary" onclick="shareProperty(<?php echo e($property->id); ?>)">
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Projects/yalihanemlakwarp/resources/views/frontend/portfolio/index.blade.php ENDPATH**/ ?>