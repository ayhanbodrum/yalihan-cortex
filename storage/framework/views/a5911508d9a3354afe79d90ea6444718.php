...
<header class="absolute top-0 inset-x-0 z-30">
    <div class="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-3">
            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Yalıhan Emlak" class="h-10 w-auto dark:hidden">
            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Yalıhan Emlak" class="h-10 w-auto hidden dark:block">
        ...
        <nav class="hidden md:flex items-center gap-6 text-white font-medium text-sm">
            ...
            <a href="<?php echo e(route('frontend.portfolio.index')); ?>" class="px-4 py-2 rounded-full bg-amber-500 text-slate-900 font-semibold shadow-md hover:bg-amber-400 transition">Portföy</a>
        </nav>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                <?php $__empty_1 = true; $__currentLoopData = $properties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php if (isset($component)) { $__componentOriginalbc73dc37bee7edf69d54fe0ab5f7788e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbc73dc37bee7edf69d54fe0ab5f7788e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.yaliihan.property-card','data' => ['property' => $property]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('yaliihan.property-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalbc73dc37bee7edf69d54fe0ab5f7788e)): ?>
<?php $attributes = $__attributesOriginalbc73dc37bee7edf69d54fe0ab5f7788e; ?>
<?php unset($__attributesOriginalbc73dc37bee7edf69d54fe0ab5f7788e); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalbc73dc37bee7edf69d54fe0ab5f7788e)): ?>
<?php $component = $__componentOriginalbc73dc37bee7edf69d54fe0ab5f7788e; ?>
<?php unset($__componentOriginalbc73dc37bee7edf69d54fe0ab5f7788e); ?>
<?php endif; ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="text-center p-8 bg-gray-50 dark:bg-gray-900/40 rounded-3xl border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                    <div class="text-4xl font-black text-blue-600 dark:text-blue-400 mb-3">
                        <?php echo e(number_format($stats['active_listings'] ?? 0)); ?>+
                    </div>
                ...
                <div class="text-center p-8 bg-gray-50 dark:bg-gray-900/40 rounded-3xl border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                    <div class="text-4xl font-black text-blue-600 dark:text-blue-400 mb-3">
                        <?php echo e($stats['experience_years'] ?? 0); ?>+
                    </div>
                ...
                <div class="text-center p-8 bg-gray-50 dark:bg-gray-900/40 rounded-3xl border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                    <div class="text-4xl font-black text-blue-600 dark:text-blue-400 mb-3">
                        <?php echo e(number_format($stats['happy_customers'] ?? 0)); ?>+
                    </div>
    ...
    <section class="py-16 bg-blue-600 dark:bg-blue-700 text-white transition-colors duration-300">
        <div class="container mx-auto px-4 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="<?php echo e(url('/iletisim')); ?>"
    ...
    <div id="propertyDetail" class="fixed inset-0 hidden items-center justify-center z-50" role="dialog" aria-modal="true" aria-labelledby="propertyDetailTitle">
        ...
        <div class="relative bg-white dark:bg-gray-900 rounded-3xl shadow-2xl max-w-4xl w-full mx-4 p-6 sm:p-8 overflow-y-auto max-h-[90vh]">
            ...
            <div class="space-y-6 text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                ...
                <a data-role="detail-link" href="<?php echo e(url('/portfolio')); ?>" class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-all duration-200" target="_blank" rel="noopener">
                    Detay Sayfasına Git
        ...
        (function () {
            ...
            const resetPropertyDetailModal = (modal) => {
                ...
                if (link) {
                    ...
                    link.setAttribute('href', '<?php echo e(url('/portfolio')); ?>');
                }
            };
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Projects/yalihanai /resources/views/yaliihan-home-clean.blade.php ENDPATH**/ ?>