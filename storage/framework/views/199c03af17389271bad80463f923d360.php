<?php $__env->startSection('title', 'Kiralama Takvimi - ' . $ilan->baslik); ?>
        ...
        <div class="neo-page-header mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-2"><?php echo e($ilan->baslik); ?> - Rezervasyon yönetimi</p>
                </div>
                ...
                <div class="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-400 mt-2">
                            <?php echo e($ilan->baslik); ?> - <?php echo e($ilan->emlak_turu); ?>
            ...
            <div class="flex items-center justify-center min-h-screen">
                <div class="bg-gray-50 dark:bg-gray-800 rounded-lg shadow-xl max-w-lg w-full mx-4">
                    <div class="p-6">
                        ...
                        <div class="flex justify-end space-x-3 mt-6">
                            <button onclick="rezervasyonEkleModalKapat()" class="neo-btn neo-btn neo-btn-secondary touch-target-optimized touch-target-optimized">
                                İptal
                            </button>
                            <button onclick="rezervasyonEkleKaydet()" class="neo-btn neo-btn neo-btn-primary touch-target-optimized touch-target-optimized">
                                Kaydet
                            </button>
                        </div>
                    </div>
    ...
    <?php $__env->startSection('scripts'); ?>
        ...
        <script>
            ...
            async function loadCalendarData() {
                try {
                    const response = await fetch(`/admin/ilanlar/${<?php echo json_encode($ilan->id, 15, 512) ?>}/takvim/api`);
            ...
            async function topluGuncelleUygula() {
                ...
                try {
                    const response = await fetch(`/admin/ilanlar/${<?php echo json_encode($ilan->id, 15, 512) ?>}/takvim/toplu-guncelle`, {
                        method: 'POST',
                        headers: {
            ...
            async function rezervasyonEkleKaydet() {
                ...
                try {
                    const response = await fetch(`/admin/ilanlar/${<?php echo json_encode($ilan->id, 15, 512) ?>}/takvim/rezervasyon`, {
                        method: 'POST',
                        headers: {
                            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute(
                                'content')
...
<?php echo $__env->make('admin.layouts.neo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Projects/yalihanemlakwarp/resources/views/admin/takvim/index.blade.php ENDPATH**/ ?>