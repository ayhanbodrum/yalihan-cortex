<?php $__env->startSection('title', 'Yeni İlan Kategorisi'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="container mx-auto px-4 py-6" x-data="kategoriForm()">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
            <div class="p-6">
                <form method="POST" action="<?php echo e(route('admin.ilan-kategorileri.store')); ?>" @submit.prevent="submitForm">
                    <?php echo csrf_field(); ?>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Kategori Adı *</label>
                            <input type="text" id="name" name="name" class="w-full px-4 py-2.5 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg text-black dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent transition-all duration-200" value="<?php echo e(old('name')); ?>" required placeholder="Örn: Daire, Villa">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="space-y-2">
                            ...
                            <select style="color-scheme: light dark;" id="seviye" name="seviye" class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-black dark:text-white focus:ring-2 focus:ring-blue-500 transition-all duration-200" required @change="updateParentOptions()">
                                ...
                                <option value="0" <?php echo e(old('seviye') == 0 ? 'selected' : ''); ?>>Ana Kategori</option>
                                <option value="1" <?php echo e(old('seviye') == 1 ? 'selected' : ''); ?>>Alt Kategori</option>
                                <option value="2" <?php echo e(old('seviye') == 2 ? 'selected' : ''); ?>>Yayın Tipi</option>
                            </select>
                        ...
                        <div class="space-y-2 md:col-span-2" id="parent-field" x-show="parentRequired" x-cloak>
                            ...
                            <select style="color-scheme: light dark;" id="parent_id" name="parent_id" class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-black dark:text-white focus:ring-2 focus:ring-blue-500 transition-all duration-200">
                                ...
                                <?php $__currentLoopData = $anaKategoriler ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($kategori->id); ?>" <?php echo e(old('parent_id') == $kategori->id ? 'selected' : ''); ?>>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center space-x-4">
                            <label class="flex items-center">
                                <input type="radio" name="status" value="1" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" <?php echo e(old('status', 1) == 1 ? 'checked' : ''); ?>>
                                <span class="ml-2 text-gray-900 dark:text-white">Active</span>
                            </label>
                            <label class="flex items-center">
                                <input type="radio" name="status" value="0" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" <?php echo e(old('status') == 0 ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.neo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Projects/yalihanemlakwarp/resources/views/admin/ilan-kategorileri/create.blade.php ENDPATH**/ ?>