                                    ...
                                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                        <?php $__currentLoopData = $ozellikler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ozellik): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                                ...
                                                <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-300">
                                                    <?php echo e($ozellik->type ?? ($ozellik->field_type ?? 'text')); ?>
                                                ...
                                                <td class="px-6 py-4">
                                                    ...
                                                    <?php echo e($ozellik->status ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200' : 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200'); ?>">
                                                        <?php echo e($ozellik->status ? 'Yayında' : 'Taslak'); ?>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <?php if($isFontAwesome): ?>
                                                <i
                                                    class="<?php echo e($iconClass); ?> text-5xl text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform duration-300"></i>
                                            <?php else: ?>
                                                <span
                                                    class="text-5xl group-hover:scale-110 transition-transform duration-300"><?php echo e($kategori->icon ?? '📦'); ?></span>
                                            <?php endif; ?>
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div class="flex-1">
                                                ...
                                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                                    Tip: <?php echo e($ozellik->type ?? ($ozellik->field_type ?? 'text')); ?>
...
<?php echo $__env->make('admin.layouts.neo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Projects/yalihanai /resources/views/admin/ozellikler/index.blade.php ENDPATH**/ ?>