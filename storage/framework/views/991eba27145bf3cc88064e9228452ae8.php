                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">
                                    <?php echo e(number_format($ilan->fiyat ?? 0, 0, ',', '.')); ?> <?php echo e($ilan->para_birimi ?? 'TL'); ?>
                                        ...
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-8 w-8 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center">
                                                <span class="text-xs font-semibold text-blue-600 dark:text-blue-400">
                                                    <?php echo e(substr($ilan->ilanSahibi->ad, 0, 1)); ?><?php echo e(substr($ilan->ilanSahibi->soyad, 0, 1)); ?>

                                                </span>
                                            </div>
                                            <div class="ml-2">
                                                <div class="text-sm font-medium"><?php echo e($ilan->ilanSahibi->ad); ?> <?php echo e($ilan->ilanSahibi->soyad); ?></div>
                                                <div class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($ilan->ilanSahibi->telefon); ?></div>
                                            </div>
                                        </div>
                                    <?php else: ?>
...
<?php echo $__env->make('admin.layouts.neo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Projects/yalihanemlakwarp/resources/views/admin/ilanlar/index.blade.php ENDPATH**/ ?>