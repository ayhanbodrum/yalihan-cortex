<?php $__env->startSection('title', 'Eşleştirme Yönetimi'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content-header mb-8">
        ...
        <div class="flex items-center space-x-3 mt-4">
            <a href="<?php echo e(route('admin.eslesmeler.create')); ?>" class="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg transition-all duration-200 focus:ring-2 focus:ring-offset-2 inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 hover:scale-105 active:scale-95 focus:ring-2 focus:ring-blue-500 transition-all duration-200 shadow-md hover:shadow-lg touch-target-optimized touch-target-optimized">
    ...
    <div class="px-6">
            ...
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200 shadow-sm p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-blue-900"><?php echo e($eslesmeler->total() ?? 0); ?></p>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-green-900">
                            <?php echo e($eslesmeler->where('status', 'active')->count() ?? 0); ?></p>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-purple-900">
                            <?php echo e($eslesmeler->where('skor', '>=', 80)->count() ?? 0); ?></p>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-orange-900">
                            <?php echo e($eslesmeler->where('status', 'beklemede')->count() ?? 0); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="rounded-xl border border-gray-200 bg-white shadow-sm hover:shadow-md transition-all duration-200 dark:border-gray-700 dark:bg-gray-800 mb-8">
            <div class="p-6">
                ...
                <form method="GET" action="<?php echo e(route('admin.eslesmeler.index')); ?>" class="mt-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div class="form-field">
                            ...
                            <select style="color-scheme: light dark;" id="status" name="status" class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 transition-all duration-200">
                                ...
                                <option value="active" <?php echo e(($filters['status'] ?? '') === 'active' ? 'selected' : ''); ?>>Aktif
                                </option>
                                <option value="beklemede"
                                    <?php echo e(($filters['status'] ?? '') === 'beklemede' ? 'selected' : ''); ?>>Beklemede</option>
                                <option value="tamamlandi"
                                    <?php echo e(($filters['status'] ?? '') === 'tamamlandi' ? 'selected' : ''); ?>>Tamamlandı</option>
                                <option value="iptal" <?php echo e(($filters['status'] ?? '') === 'iptal' ? 'selected' : ''); ?>>İptal
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="form-field">
                            ...
                            <select style="color-scheme: light dark;" id="oncelik" name="oncelik" class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 transition-all duration-200">
                                <option value="">Tümü</option>
                                <option value="yuksek" <?php echo e(($filters['oncelik'] ?? '') === 'yuksek' ? 'selected' : ''); ?>>
                                    Yüksek</option>
                                <option value="orta" <?php echo e(($filters['oncelik'] ?? '') === 'orta' ? 'selected' : ''); ?>>Orta
                                </option>
                                <option value="dusuk" <?php echo e(($filters['oncelik'] ?? '') === 'dusuk' ? 'selected' : ''); ?>>
                                    Düşük</option>
                            </select>
                        </div>
                            ...
                            <select style="color-scheme: light dark;" id="kategori_id" name="kategori_id" class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 transition-all duration-200">
                                ...
                                <?php $__currentLoopData = $kategoriler ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($kategori->id); ?>"
                                        <?php echo e(($filters['kategori_id'] ?? '') == $kategori->id ? 'selected' : ''); ?>>
                        ...
                        <div class="form-field">
                            ...
                            <select style="color-scheme: light dark;" id="sort" name="sort" class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 transition-all duration-200">
                                <option value="created_desc"
                                    <?php echo e(($filters['sort'] ?? '') === 'created_desc' ? 'selected' : ''); ?>>En Yeni</option>
                                <option value="skor_desc"
                                    <?php echo e(($filters['sort'] ?? '') === 'skor_desc' ? 'selected' : ''); ?>>Yüksek Skor</option>
                                <option value="skor_asc" <?php echo e(($filters['sort'] ?? '') === 'skor_asc' ? 'selected' : ''); ?>>
                                    Düşük Skor</option>
                                <option value="oncelik_desc"
                                    <?php echo e(($filters['sort'] ?? '') === 'oncelik_desc' ? 'selected' : ''); ?>>Yüksek Öncelik
                                </option>
                            </select>
                        </div>
                    </div>
            ...
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-800">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center space-x-3">
                        <span class="text-sm text-gray-500"><?php echo e($eslesmeler->total() ?? 0); ?> eşleştirme bulundu</span>
                    </div>
                </div>
            </div>

            <div class="p-6">
                <?php if(isset($eslesmeler) && $eslesmeler->count() > 0): ?>
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <?php $__currentLoopData = $eslesmeler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eslesme): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 h-10 w-10">
                                                    <div
                                                        ...
                                                        <?php echo e(strtoupper(substr($eslesme->kisi->ad ?? 'M', 0, 1))); ?><?php echo e(strtoupper(substr($eslesme->kisi->soyad ?? 'S', 0, 1))); ?>

                                                    </div>
                                                </div>
                                                <div class="ml-4">
                                                    <div class="text-sm font-medium text-gray-900">
                                                        <?php echo e($eslesme->kisi->ad ?? 'N/A'); ?>

                                                        <?php echo e($eslesme->kisi->soyad ?? ''); ?></div>
                                                    <div class="text-sm text-gray-500">
                                                        <?php echo e($eslesme->kisi->telefon ?? 'Telefon yok'); ?></div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">#<?php echo e($eslesme->talep->id ?? 'N/A'); ?></div>
                                            <div class="text-sm text-gray-500">
                                                <?php echo e($eslesme->talep->kategori->name ?? 'Kategori yok'); ?></div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">#<?php echo e($eslesme->ilan->id ?? 'N/A'); ?></div>
                                            <div class="text-sm text-gray-500">
                                                <?php echo e($eslesme->ilan->baslik ?? 'Başlık yok'); ?></div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="flex-1 bg-gray-200 rounded-full h-2 mr-2">
                                                    <div class="bg-gradient-to-r from-green-400 to-green-600 h-2 rounded-full"
                                                        style="width: <?php echo e($eslesme->skor ?? 0); ?>%"></div>
                                                </div>
                                                <span
                                                    class="text-sm font-medium text-gray-900"><?php echo e($eslesme->skor ?? 0); ?>%</span>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.neo.status-badge','data' => ['value' => ucfirst($eslesme->status ?? 'Bilinmiyor')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(ucfirst($eslesme->status ?? 'Bilinmiyor'))]); ?>
...
<?php endif; ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <?php if (isset($component)) { $__componentOriginal9e089bc5f8eac272c2c5ae05d84c4b58 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9e089bc5f8eac272c2c5ae05d84c4b58 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.neo.status-badge','data' => ['value' => ucfirst($eslesme->oncelik ?? 'Düşük'),'category' => 'priority']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('neo.status-badge'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(ucfirst($eslesme->oncelik ?? 'Düşük')),'category' => 'priority']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal9e089bc5f8eac272c2c5ae05d84c4b58)): ?>
<?php $attributes = $__attributesOriginal9e089bc5f8eac272c2c5ae05d84c4b58; ?>
...
<?php endif; ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <?php echo e($eslesme->created_at ? $eslesme->created_at->format('d.m.Y H:i') : '-'); ?>
                    ...
                    <!-- Sayfalama -->
                    <div class="mt-6">
                        <?php echo e($eslesmeler->appends(request()->query())->links()); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.neo.empty-state','data' => ['title' => 'Henüz eşleştirme bulunmuyor','description' => 'İlk eşleştirmenizi oluşturarak başlayın.','actionHref' => route('admin.eslesmeler.create'),'actionText' => 'İlk Eşleştirmeyi Oluştur']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Henüz eşleştirme bulunmuyor','description' => 'İlk eşleştirmenizi oluşturarak başlayın.','actionHref' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.eslesmeler.create')),'actionText' => 'İlk Eşleştirmeyi Oluştur']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('admin.layouts.neo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Projects/yalihanemlakwarp/resources/views/admin/eslesmeler/index.blade.php ENDPATH**/ ?>