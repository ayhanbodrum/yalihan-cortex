<?php $__env->startSection('title', 'Yeni Talep Oluştur'); ?>
<?php $__env->startSection('meta_description', 'Yeni müşteri talebi oluşturun - Emlak talebi formu, kişi bilgileri, lokasyon seçimi ve
    talep detayları'); ?>
<?php $__env->startSection('meta_keywords', 'yeni talep, müşteri talebi, emlak talebi, talep formu, yalıhan emlak'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" x-data="talepForm()">
            ...
            <div class="flex items-center justify-between mb-4">
                <div>
                    <nav class="flex items-center space-x-2 text-sm mb-3">
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 transition-colors">
                        ...
                        <a href="<?php echo e(route('admin.talepler.index')); ?>" class="text-gray-500 hover:text-orange-600 dark:text-gray-400 dark:hover:text-orange-400 transition-colors font-medium">Talepler</a>
                        <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                        </svg>
        ...
        <form method="POST" action="<?php echo e(route('admin.talepler.store')); ?>" class="space-y-6" x-ref="form">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-6">
                                ...
                                <textarea id="aciklama" name="aciklama"
                                          class="w-full px-4 py-2.5 
                                                 border <?php $__errorArgs = ['aciklama'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php else: ?> border-gray-300 dark:border-gray-600 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                          ...
                                          x-model="form.aciklama"><?php echo e(old('aciklama')); ?></textarea>
                                ...
                                <div>
                                    ...
                                    <select id="kategori_id" name="kategori_id"
                                        ...
                                        <?php $__currentLoopData = $kategoriler ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($kategori->id); ?>" class="bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white py-2 font-medium"><?php echo e($kategori->name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <option value="Beklemede" <?php echo e(old('status') == 'Beklemede' ? 'selected' : ''); ?>>Beklemede</option>
                                        <option value="İptal" <?php echo e(old('status') == 'İptal' ? 'selected' : ''); ?>>İptal</option>
                                    </select>
                                    ...
                                    <div class="flex items-center h-11">
                                        ...
                                        <input type="checkbox" id="one_cikan" name="one_cikan" value="1"
                                               class="w-5 h-5 
                                                      ...
                                                      cursor-pointer
                                                      hover:scale-110"
                                               <?php echo e(old('one_cikan') ? 'checked' : ''); ?>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <select id="il_id" name="il_id"
                                                class="w-full px-4 py-2.5
                                                       border-2 <?php $__errorArgs = ['il_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 dark:border-red-400 <?php else: ?> border-gray-300 dark:border-gray-500 <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                                                       rounded-lg 
                                            ...
                                            <?php $__currentLoopData = $iller ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $il): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($il->id); ?>" class="bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white py-2 font-medium"><?php echo e($il->il_adi); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="kisi_soyad" name="kisi_soyad"
                                               class="w-full px-4 py-2.5 
                                                      ...
                                                      focus:ring-2 focus:ring-purple-500 focus:border-transparent
                                                      transition-all duration-200"
                                               value="<?php echo e(old('kisi_soyad')); ?>" 
                                               placeholder="Soyad"
                                    ...
                                    <div>
                                        ...
                                        <input type="tel" id="kisi_telefon" name="kisi_telefon"
                                               class="w-full px-4 py-2.5 
                                                      ...
                                                      focus:ring-2 focus:ring-purple-500 focus:border-transparent
                                                      transition-all duration-200"
                                               value="<?php echo e(old('kisi_telefon')); ?>" 
                                    ...
                                    <div>
                                        ...
                                        <input type="email" id="kisi_email" name="kisi_email"
                                               class="w-full px-4 py-2.5 
                                                      ...
                                                      focus:ring-2 focus:ring-purple-500 focus:border-transparent
                                                      transition-all duration-200"
                                               value="<?php echo e(old('kisi_email')); ?>" 
                            ...
                            <div class="mb-6">
                                ...
                                <select style="color-scheme: light dark;" id="danisman_id" name="danisman_id"
                                    ...
                                    <?php $__currentLoopData = $danismanlar ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $danisman): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($danisman->id); ?>"><?php echo e($danisman->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
...
unset($__errorArgs, $__bag); ?>
    ...
    <script src="<?php echo e(asset('js/context7-live-search.js')); ?>" defer></script>
    <script src="<?php echo e(asset('js/context7-location-system.js')); ?>" defer></script>
    ...
    <script>
        function talepForm() {
            return {
                ...
                ilceler: [],
                mahalleler: [],
                iller: <?php echo json_encode($iller ?? [], 15, 512) ?>,
                form: {
                    baslik: '',
                    aciklama: '',
                    tip: '',
...
<?php echo $__env->make('admin.layouts.neo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Projects/yalihanemlakwarp/resources/views/admin/talepler/create.blade.php ENDPATH**/ ?>