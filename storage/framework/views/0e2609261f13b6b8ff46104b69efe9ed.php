    ...
    <div x-data="photoManager()" class="space-y-6">
        ...
        <div
            ...
            <div id="photo-drop-zone"
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <p class="text-lg font-medium text-gray-900 dark:text-white">Fotoğrafları sürükleyip
                            bırakın</p>
        ...
        <div x-show="editingPhoto !== null" x-cloak
            ...
            <div class="bg-gray-50 dark:bg-gray-800 rounded-lg max-w-2xl w-full mx-4 max-h-90vh overflow-y-auto">
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Fotoğraf Düzenle</h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <template x-if="editingPhoto !== null">
                            <div class="space-y-4">
                                <div>
                                    <label class="block text-sm font-medium text-gray-900 dark:text-white mb-2">Fotoğraf Başlığı</label>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <label for="edit-is-cover" class="text-sm text-gray-900 dark:text-white">Kapak fotoğrafı yap</label>
                                </div>
                            </div>
                        </template>
                    </div>
...
<?php /**PATH /Users/macbookpro/Projects/yalihanemlakwarp/resources/views/admin/ilanlar/components/listing-photos.blade.php ENDPATH**/ ?>