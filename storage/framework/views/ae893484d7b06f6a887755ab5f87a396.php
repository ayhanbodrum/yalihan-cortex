<?php $__env->startSection('content'); ?>
    <div class="space-y-4">
        ...
        <!-- Main Form -->
        <form id="ilan-create-form" method="POST" action="<?php echo e(route('admin.ilanlar.store')); ?>" enctype="multipart/form-data"
            ...
            <div class="space-y-4">
                ...
                <div class="kategori-specific-section" data-show-for-categories="yazlik" style="display: none;">
                    <?php echo $__env->make('admin.ilanlar.components.bedroom-layout-manager', [
                ...
                <div
                    class="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow duration-200">
                    <?php echo $__env->make('admin.ilanlar.components.photo-upload-manager', [
                        'ilan' => new \App\Models\Ilan(),
                    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
                ...
                <div class="kategori-specific-section" data-show-for-categories="yazlik" style="display: none;">
                    <?php echo $__env->make('admin.ilanlar.components.event-booking-manager', [
                        'ilan' => new \App\Models\Ilan(),
                    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
                ...
                <div class="kategori-specific-section" data-show-for-categories="yazlik" style="display: none;">
                    <?php echo $__env->make('admin.ilanlar.components.season-pricing-manager', [
                        'ilan' => new \App\Models\Ilan(),
                    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                <select name="status" id="status" required
                                    ...
                                    <option value="Taslak" <?php echo e(old('status') == 'Taslak' ? 'selected' : ''); ?>>📝 Taslak
                                    </option>
                                    <option value="Aktif" <?php echo e(old('status', 'Aktif') == 'Aktif' ? 'selected' : ''); ?>>✅ Aktif
                                    </option>
                                    <option value="Pasif" <?php echo e(old('status') == 'Pasif' ? 'selected' : ''); ?>>⏸️ Pasif
                                    </option>
                                    <option value="Beklemede" <?php echo e(old('status') == 'Beklemede' ? 'selected' : ''); ?>>⏳
                                        Beklemede</option>
                                </select>
                            ...
                            <div class="relative">
                                <select name="oncelik" id="oncelik"
                                    class="w-full px-4 py-2.5 text-base
                                       ...
                                       focus:shadow-md
                                       appearance-none">
                                    <option value="normal" <?php echo e(old('oncelik', 'normal') == 'normal' ? 'selected' : ''); ?>>📋
                                        Normal</option>
                                    <option value="yuksek" <?php echo e(old('oncelik') == 'yuksek' ? 'selected' : ''); ?>>⭐ Yüksek
                                    </option>
                                    <option value="acil" <?php echo e(old('oncelik') == 'acil' ? 'selected' : ''); ?>>🚨 Acil
                                    </option>
                                </select>
                                <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                                    <svg class="w-5 h-5 text-gray-400 group-focus-within:text-green-500 transition-colors"
...
<?php $__env->startPush('scripts'); ?>
    ...
    <?php if(config('app.debug')): ?>
        <script src="<?php echo e(asset('js/test-form-selections.js')); ?>"></script>
    <?php endif; ?>
...
<?php echo $__env->make('admin.layouts.neo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Projects/yalihanai /resources/views/admin/ilanlar/create.blade.php ENDPATH**/ ?>