                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full
                                    <?php if($ilan->status === true || $ilan->status === 'Aktif' || $ilan->status === 1): ?> bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200
                                    <?php else: ?> bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-gray-400 <?php endif; ?>">
                                    <?php echo e(is_bool($ilan->status) ? ($ilan->status ? 'Aktif' : 'Pasif') : $ilan->status); ?>
...
<?php echo $__env->make('admin.layouts.neo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Projects/yalihanai /resources/views/admin/dashboard/index.blade.php ENDPATH**/ ?>