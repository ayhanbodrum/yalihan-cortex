...
```yaml
Neden:
  ✅ @tailwindcss/vite henüz Vite 7'yi desteklemiyor
  ✅ Laravel ecosystem Vite 7'ye geçti
  ✅ Yakında güncellenecek (1-2 ay?)

Yapılacak:
  ⏳ @tailwindcss/vite@next güncelleme bekle
...
```yaml
Komut:
  npm install -D @tailwindcss/vite@next --legacy-peer-deps
